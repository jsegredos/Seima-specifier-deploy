...
`).filter(i=>i.trim()!==""),n=s.length>0?s[s.length-1]:"Unknown",r=n.split(" - ")[0]||n;o.innerText=r,o.innerText.trim()||(o.innerText="v2.1.0")}}else throw new Error("Version file not found")}catch{const t=document.getElementById("version-number");if(t){const o=R.get("app.version")||"v2.1.0";t.innerText=o}else setTimeout(()=>{const o=document.getElementById("version-number");if(o&&!o.innerText.trim()){const s=R.get("app.version")||"v2.1.0";o.innerText=s}},1e3);console.info("Version loaded from config (GitHub Pages mode)")}}async showProductLookupScreen(){try{const t=await(await fetch("./screens/product-grid.html")).text();document.body.innerHTML=t,this.currentScreen="product-grid";const o=document.createElement("script");o.type="module",o.src="js/app.js",document.body.appendChild(o),setTimeout(()=>{document.querySelectorAll(".back-btn").forEach(s=>s.remove())},100),window.productGridManager&&window.productGridManager.init(),await this.loadVersion(),setTimeout(()=>this.loadVersion(),1e3)}catch(e){console.error("Failed to load product grid screen:",e)}}setupSplitInterface(){const e=document.getElementById("back-to-home");e&&(e.onclick=()=>location.reload());const t=document.getElementById("download-btn"),o=document.getElementById("clear-all-btn");t&&(t.onclick=()=>this.showDownloadFormModal()),o&&(o.onclick=()=>this.showClearConfirmModal()),this.setupSplitProductSearch(),this.setupReviewTable(),this.renderReviewTable(),this.loadInitialSearchResults()}setupSplitProductSearch(){const e=document.getElementById("product-search-input"),t=document.getElementById("search-results-list"),o=document.getElementById("search-loading"),s=document.getElementById("search-no-results");if(!e||!t)return;const n=[],r=S.debounce(i=>{this.performSplitProductSearch(i,t,n,o,s)},200);e.addEventListener("input",()=>{const i=e.value.trim();i?r(i):this.loadInitialSearchResults()}),t.addEventListener("click",i=>{const a=i.target.closest(".result-item");if(!a)return;const c=parseInt(a.getAttribute("data-idx"),10),l=n.length>0?n:this.currentSearchResults||[];!isNaN(c)&&l[c]&&this.showSplitProductDetails(l[c])})}performSplitProductSearch(e,t,o,s,n){if(!N.isLoaded){s.style.display="flex",n.style.display="none",t.innerHTML="";return}o.length=0,o.push(...N.searchProducts(e)),s.style.display="none",o.length===0?(n.style.display="flex",t.innerHTML=""):(n.style.display="none",t.innerHTML=o.map((r,i)=>`
        ...
        `).join(""))}async loadInitialSearchResults(){const e=document.getElementById("search-results-list"),t=document.getElementById("search-loading"),o=document.getElementById("search-no-results");if(!e)return;if(!N.isLoaded){t.style.display="flex",o.style.display="none",e.innerHTML="",setTimeout(()=>this.loadInitialSearchResults(),500);return}const s=N.getAllProducts().slice(0,50);t.style.display="none",o.style.display="none",e.innerHTML=s.map((n,r)=>`
    ...
    `,document.body.appendChild(o),_e("./assets/seima-logo.png",(n,r,i)=>{const a=JSON.parse(localStorage.getItem("selection")||"[]"),c=JSON.parse(localStorage.getItem(U.STORAGE_KEYS.SELECTED_PRODUCTS)||"[]");let l=[];c.length>0?l=c.map(m=>({...m.product,Room:m.room,Notes:m.notes,Quantity:m.quantity,Timestamp:new Date(m.timestamp).toISOString()})):l=a;const d=document.getElementById("sort-by"),p=d?d.value:"room";switch(p){case"code":l.sort((m,v)=>{const P=m.OrderCode||m.Code||"",I=v.OrderCode||v.Code||"";return P.localeCompare(I)});break;case"product":l.sort((m,v)=>{const P=m.Description||m.ProductName||"",I=v.Description||v.ProductName||"";return P.localeCompare(I)});break;case"room":default:l.sort((m,v)=>{const P=m.Room||"Blank",I=v.Room||"Blank";return P.localeCompare(I)});break}if(!l.length){alert("No products selected."),t&&(t.style.display="none");return}if(et()>0)console.log(`📷 Using ${et()} pre-cached images (skipping duplicate preload)`);else{const m=document.getElementById("pdf-processing-notification");if(m){const v=document.createElement("span");v.id="preload-progress",v.style.cssText="display: block; font-size: 12px; margin-top: 8px; color: #1e40af;",v.textContent="Loading images: 0%",m.appendChild(v)}console.log("📷 Starting image preload for",l.length,"products"),ut(l).then(v=>{const P=document.getElementById("preload-progress");P&&(P.textContent=`✓ ${v} images ready`,P.style.color="#059669")}).catch(v=>{console.warn("Image preloading error:",v)})}const f={};p==="room"?l.forEach(m=>{const v=m.Room||"Blank";f[v]||(f[v]=[]),f[v].push(m)}):f.__all__=l;const{jsPDF:y}=window.jspdf,w=new y({orientation:"landscape",unit:"pt",format:"a4",compress:!0,putOnlyUsedFonts:!0,precision:16,userUnit:1,floatPrecision:16}),g=w.internal.pageSize.getWidth(),x=w.internal.pageSize.getHeight();_e("./assets/seima-logo.png",(m,v,P)=>{const I=J.getCurrentUser(),H=b.getUserSettings(),M=I?{name:I.name,email:I.email,phone:I.phone,position:I.position}:H,A=localStorage.getItem("customerLogo");Pt(w,{pageWidth:g,pageHeight:x,seimaLogoDataUrl:m,seimaLogoNaturalW:v,seimaLogoNaturalH:P,customerLogoDataUrl:A,userDetails:u,staffContact:M,footerHeight:tt.footerHeight}),w.addPage(),_e("./assets/seima-logo-white.png",(se,ue,pe)=>{const wt=u.showRrp&&!u.excludePrice,Je=!u.excludePrice,Xe=!u.excludeQty,vt=Ct(g,{leftMargin:32,rightMargin:32,showRrp:wt,showPrice:Je,showQty:Xe,showTotal:Je&&Xe}),{colX:me,colW:Se,headers:Ae}=vt,Ce=tt.footerHeight;nt();const Qe=(k,C,G,Q,F,z,T)=>{if(!C||typeof C!="string"||C.length<10||!C.startsWith("http://")&&!C.startsWith("https://")&&!C.startsWith("data:")){T&&T();return}if((L=>{if(!L||L.length<25||/\/images\/\d+$/.test(L)||L.endsWith("/0"))return!0;const D=/\.(jpg|jpeg|png|gif|webp|svg)(\?.*)?$/i.test(L),$=L.startsWith("data:");return!D&&!$})(C)){console.warn("Skipping malformed image URL:",(C==null?void 0:C.substring(0,50))+"..."),T&&T();return}if(Y.totalImages++,u.emailCompatible){Y.failedImages++,T&&T();return}const K=Dt(C);if(K&&K.dataUrl)try{const L=K.width/K.height;let D=F,$=F/L;$>z&&($=z,D=z*L),k.addImage(K.dataUrl,K.format,G,Q,D,$,void 0,"FAST"),Y.optimizedImages++,T&&T();return}catch{console.warn("Failed to use cached image, falling back to direct load")}let ne=!1;const ge=["https://wsrv.nl/?url=","https://images.weserv.nl/?url=","https://api.codetabs.com/v1/proxy?quest="];let Z=0;function ee(){if(ne)return;const L=new Image;L.crossOrigin="Anonymous";let D=null;L.onload=function(){if(!ne){ne=!0,D&&clearTimeout(D);try{const re=ht(0),Le=re.imageMaxWidth,ve=F,te=z;try{const j=document.createElement("canvas"),q=j.getContext("2d"),{width:V,height:Ze}=to(L.width,L.height,Le);j.width=V,j.height=Ze,q.imageSmoothingEnabled=!0,q.imageSmoothingQuality="high",q.drawImage(L,0,0,V,Ze);let Fe,Oe="JPEG";const bt=eo(j,q),St=Zt(L);bt||St?(Fe=j.toDataURL("image/png",re.imageQuality),Oe="PNG"):(Fe=j.toDataURL("image/jpeg",re.imageQuality),Oe="JPEG");const xt=`img_${lo(C)}`;k.addImage(Fe,Oe,G,Q,ve,te,xt,"FAST"),Y.optimizedImages++,T&&T()}catch(j){console.warn(`Failed to optimize image: ${C}`,j),console.warn("Error details:",j.message,j.stack);try{k.addImage(L,"JPEG",G,Q,ve,te),Y.optimizedImages++,T&&T()}catch(q){console.error(`Fallback also failed for: ${C}`,q),Y.failedImages++,T&&T()}}}catch(re){console.warn("Failed to add image to PDF:",re),Y.failedImages++,T&&T()}}},L.onerror=function(){ne||(D&&clearTimeout(D),console.warn(`Failed to load image with proxy ${Z}: ${C}`),console.warn(`Error details for: ${C} - Proxy: ${ge[Z]}`),Z++,Z<ge.length?setTimeout(()=>{ee()},200):(ne=!0,console.warn("All proxies failed, skipping image"),Y.failedImages++,T&&T()))},D=setTimeout(()=>{ne||(console.warn(`⏰ Timeout with proxy ${Z}: ${C}`),L.src="",L.onload=null,L.onerror=null,Z++,Z<ge.length?setTimeout(()=>{ee()},200):(ne=!0,console.warn("All proxies timed out, skipping image"),Y.failedImages++,T&&T()))},3e3);let $=C;Z<ge.length&&($=ge[Z]+encodeURIComponent(C)),L.src=$}ee()},W=[];Object.keys(f).forEach((k,C)=>{const G=f[k];if(!G||!Array.isArray(G)){console.warn("⚠️ Skipping invalid room items:",k,G);return}G.forEach((Q,F)=>{if(!Q){console.warn("⚠️ Skipping null item in room:",k,"at index:",F);return}W.push({item:Q,room:k,rIdx:C,iIdx:F,isFirstInRoom:F===0,roomCount:G.length})})}),W.reduce((k,C)=>{if(!C||!C.item)return console.warn("⚠️ Skipping null row in data analysis:",C),k;const G=String(C.item.Description||""),Q=String(C.item.LongDescription||""),F=String(C.item.Notes||""),z=String(C.item.OrderCode||"");return k+G.length+Q.length+F.length+z.length},0);let xe=0,Ie=0;const Re=4,ke=8,Ne=Math.floor((x-80)/Re);let Ke=Ce+8;function $e(){if(!W||!Array.isArray(W)){console.error("❌ Critical error: rowsToDraw is not a valid array:",W),st(new Error("Invalid product data structure"),"generating PDF","unknown.pdf");return}if(xe>=W.length){const F=w.internal.getNumberOfPages()-1;for(let D=2;D<=F+1;D++){w.setPage(D);const re=(D-2)*Re,Le=Math.min(re+Re,W.length);let ve=!1;for(let te=re;te<Le;te++)if(W[te]&&W[te].item&&It(W[te].item)){ve=!0;break}Rt(w,{pageWidth:g,colX:me,colW:Se,leftMargin:32,footerHeight:Ce,logoDataUrl:se,logoNaturalW:ue,logoNaturalH:pe,headers:Ae,userDetails:u,skipWelsHeader:!ve}),kt(w,{pageWidth:g,pageHeight:x,leftMargin:32,footerHeight:Ce,pageNumber:D-1,totalPages:F})}const z=new Date,T=String(z.getDate()).padStart(2,"0"),he=String(z.getMonth()+1).padStart(2,"0"),K=String(z.getFullYear()).slice(-2),ne=String(z.getHours()).padStart(2,"0"),ge=String(z.getMinutes()).padStart(2,"0"),ee=`${u.project.replace(/[^a-zA-Z0-9\s]/g,"")}-${T}${he}${K}.${ne}${ge}.pdf`,L=document.getElementById("pdf-processing-notification");L&&L.remove(),uo(u.emailCompatible);try{const D=w.output("blob"),$=w.output("string"),re=$?$.match(/\/Type\s*\/XObject/g):null,Le=$?$.match(/Tj\s/g):null,ve=$?$.match(/\/A\s*<</g):null;u.pdfSize=D.size;const te=so(D,ee);if(u.sendEmail&&D.size>15*1024*1024){console.warn(`❌ PDF too large for email (${(D.size/1024/1024).toFixed(1)}MB), offering email-compatible version`),po(u,ee);return}const j=oo(D,te.settings);if(u.sendEmail&&u.email)if(u.exportCsv){const q=ee.replace(/\.pdf$/,".csv");ot(u,q).then(V=>{window.dispatchEvent(new CustomEvent("sendEmail",{detail:{userDetails:u,pdfBlob:j,csvBlob:V}}))}).catch(V=>{console.error("Async CSV generation for email failed:",V),window.dispatchEvent(new CustomEvent("sendEmail",{detail:{userDetails:u,pdfBlob:j,csvBlob:null}}))})}else window.dispatchEvent(new CustomEvent("sendEmail",{detail:{userDetails:u,pdfBlob:j,csvBlob:null}}));else if((async()=>{const q=await ho(j);qe(q,ee,"PDF")})(),u.exportCsv){const q=ee.replace(/\.pdf$/,".csv");setTimeout(()=>{ot(u,q).then(V=>{V&&qe(V,q,"CSV")}).catch(V=>{console.error("CSV generation failed:",V)})},1e3)}}catch(D){console.error("PDF generation failed:",D),st(D,"generating PDF",ee);const $=document.getElementById("pdf-processing-notification");$&&$.remove()}t&&(t.style.display="none");return}Ie>=Re&&(w.addPage(),Ke=Ce+8,Ie=0);const k=W[xe];if(!k||!k.item){console.warn(`⚠️  Skipping invalid row at index ${xe}:`,k),xe++,$e();return}const C=Ke+Ne*Ie;k.isFirstInRoom&&p==="room"&&k.room!=="__all__"&&Lt(w,k.room,k.roomCount,32,C);const G=me[0],Q=G+90+12;Qe(w,k.item.Image_URL||"",G,C+ke+16,90,Ne-ke*2,()=>{Qe(w,k.item.Diagram_URL||"",Q,C+ke+16,90,Ne-ke*2,()=>{const F=C+28,z=me[1]+Se[1]/2;w.setFontSize(10),w.setTextColor("#222"),w.text(String(k.item.OrderCode||""),z,F+10,{align:"center"}),Tt(w,k.item,z,F+35);const T=Se[2]-10;Bt(w,k.item,me[2],F+10,T,u.excludeLongDescription);const he=Ae.indexOf("WELS")+1;if(he>0&&me[he]){const K=me[he]+Se[he]/2;At(w,k.item,K,F+10)}Nt(w,k.item,me,Se,Ae,F+10,{excludePrice:u.excludePrice,includeGst:u.includeGst}),xe++,Ie++,$e()})})}$e()})})})}function _e(u,e){const t=new window.Image;t.crossOrigin="Anonymous",t.onload=function(){const o=document.createElement("canvas"),s=o.getContext("2d"),n=400,r=150;let i=t.width,a=t.height;if(i>n||a>r){const l=n/i,d=r/a,p=Math.min(l,d);i=Math.round(i*p),a=Math.round(a*p)}o.width=i,o.height=a,s.imageSmoothingEnabled=!0,s.imageSmoothingQuality="high",s.drawImage(t,0,0,i,a);const c=o.toDataURL("image/png",.9);e(c,i,a)},t.src=u}function Yt(){if(!document.getElementById("pdf-spinner")){const u=document.createElement("div");if(u.id="pdf-spinner",u.style.display="none",u.style.position="fixed",u.style.top="0",u.style.left="0",u.style.width="100vw",u.style.height="100vh",u.style.zIndex="9999",u.style.background="rgba(255,255,255,0.7)",u.style.alignItems="center",u.style.justifyContent="center",u.innerHTML='<div style="border:6px solid #e0e0e0;border-top:6px solid #2563eb;border-radius:50%;width:54px;height:54px;animation:spin 1s linear infinite;"></div>',document.body.appendChild(u),!document.getElementById("pdf-spinner-style")){const e=document.createElement("style");e.id="pdf-spinner-style",e.innerHTML="@keyframes spin { 0% { transform: rotate(0deg);} 100% { transform: rotate(360deg);} }",document.head.appendChild(e)}}}async function ot(u,e){return new Promise(async t=>{if(!window.Papa)try{await S.loadScript("https://cdn.jsdelivr.net/npm/papaparse@5.4.1/papaparse.min.js")}catch(r){console.error("Failed to load PapaParse:",r),t(null);return}const o=JSON.parse(localStorage.getItem("selection")||"[]"),s=JSON.parse(localStorage.getItem(U.STORAGE_KEYS.SELECTED_PRODUCTS)||"[]");let n=[];if(s.length>0?n=s.map(r=>({...r.product,Room:r.room,Notes:r.notes,Quantity:r.quantity,Timestamp:new Date(r.timestamp).toISOString()})):n=o,!n.length){t(null);return}setTimeout(()=>{const r=n.map(i=>{let a,c,l,d;const p=u.excludePrice;let h=0;if(i.UserEditedPrice!==void 0&&i.UserEditedPrice!==null&&i.UserEditedPrice!=="")h=parseFloat(i.UserEditedPrice.toString().replace(/,/g,""));else{const g=i.RRP_EX||i["RRP EX GST"]||i.RRP_EX||i.RRP_EXGST||"";h=parseFloat((g||"0").toString().replace(/,/g,""))}a=h,l="Price ea ex GST",d="Price Total ex GST",c=!isNaN(a)&&a>=0?(a*(i.Quantity||1)).toFixed(2):"";const f=i["WELS STAR"]||i.WELS_STAR||i.WELS_STAR||i.WelsStar||"",y=f&&f.toString().trim()?f.toString().replace(/[^\d.]/g,"").trim():"",w={Code:ie(i.OrderCode||""),Description:ie(i.Description||""),"WELS Star":ie(y),Quantity:i.Quantity||1,Notes:ie(i.Notes||""),Room:ie(i.Room||""),"Image URL":ie(i.Image_URL||""),"Diagram URL":ie(i.Diagram_URL||""),"Datasheet URL":ie(i.Datasheet_URL||""),"Website URL":ie(i.Website_URL||"")};return w[l]=p?"0.00":a>=0?a.toFixed(2):"",w[d]=p?"0.00":c,w});setTimeout(()=>{const i=window.Papa.unparse(r,{quotes:!0,quoteChar:'"',delimiter:",",header:!0,newline:`\r
...
This can be restored later.`))try{const t=await le.deleteSelections([e.id]);t.success?(this.showToast("Selection deleted"),this.fetchAndRenderSelections()):this.showError(t.error||"Failed to delete")}catch(t){this.showError(t.message)}}async restoreSelection(e){try{const t=await le.restoreSelections([e.id]);t.success?(this.showToast("Selection restored"),this.fetchAndRenderSelections()):this.showError(t.error||"Failed to restore")}catch(t){this.showError(t.message)}}showToast(e){const t=document.createElement("div");t.style.cssText=`
    ...
    `;const a=r.querySelector(".toast-close");if(a.onclick=()=>this.dismiss(n),s&&s.callback){const c=r.querySelector(".toast-action");c.onclick=()=>{s.callback(),this.dismiss(n)}}return this.container.appendChild(r),this.toasts.set(n,r),requestAnimationFrame(()=>{r.classList.add("toast-enter")}),o>0&&setTimeout(()=>this.dismiss(n),o),n}dismiss(e){const t=this.toasts.get(e);t&&(t.classList.add("toast-exit"),t.addEventListener("animationend",()=>{t.remove(),this.toasts.delete(e)}))}dismissAll(){this.toasts.forEach((e,t)=>this.dismiss(t))}success(e,t={}){return this.show({message:e,type:"success",...t})}error(e,t={}){return this.show({message:e,type:"error",duration:6e3,...t})}warning(e,t={}){return this.show({message:e,type:"warning",...t})}info(e,t={}){return this.show({message:e,type:"info",...t})}withUndo(e,t,o=5e3){return this.show({message:e,type:"info",duration:o,action:{label:"Undo",callback:t}})}}const ae=new Po;window.toast=ae;class Co{constructor(){this.activeDropdown=null,this.updatePositionHandler=null,document.addEventListener("click",e=>{e.target.closest(".global-search-dropdown")||this.hideDropdown()})}showDropdown(e,t,o,s=!1){this.hideDropdown();const n=document.createElement("ul");n.className="global-search-dropdown";const r=300,i=e.getBoundingClientRect(),a=window.innerWidth,c=window.innerHeight,l=i.width,d=c-i.bottom,p=i.top;let h=!1;d<r&&p>d&&(h=!0);let f;h?f=Math.max(8,i.top-r-8):f=Math.min(c-r-8,i.bottom+8);let y=i.left;y+l>a-8&&(y=a-l-8),y<8&&(y=8);const w={position:"fixed",top:`${f}px`,left:`${y}px`,width:`${l}px`,minWidth:`${l}px`,maxWidth:`${l}px`,background:"#fff",border:"1px solid #d1d5db",borderRadius:"8px",boxShadow:"0 10px 25px -5px rgba(0, 0, 0, 0.15), 0 8px 10px -6px rgba(0, 0, 0, 0.10)",maxHeight:`${r}px`,overflowY:"auto",overflowX:"hidden",zIndex:"10010",listStyle:"none",margin:"0",padding:"4px 0",whiteSpace:"normal",wordWrap:"break-word",display:"block",pointerEvents:"auto",transform:"none",contain:"none",isolation:"isolate"};Object.keys(w).forEach(g=>{n.style.setProperty(g,w[g],"important")}),n.dropdownHeight=r,t.length===0?n.innerHTML='<li style="padding: 12px 16px; color: #6b7280; font-style: italic; background: #fff;">No products found</li>':n.innerHTML=t.map(g=>{if(g._crosshairValidate){const A=g._crosshairValidate,se=A.imageUrl?`<img src="${S.sanitizeInput(A.imageUrl)}" alt="" style="width:32px; height:32px; object-fit:contain; border-radius:4px; margin-right:10px; vertical-align:middle; flex-shrink:0;">`:"";return`<li data-validate-competitor="${S.sanitizeInput(A.competitor)}" data-validate-code="${S.sanitizeInput(A.productCode)}"
          ...
          </li>`}const x=g.OrderCode||g.Code||"",m=g.Description||g.ProductName||g["Product Name"]||"",v=g.Image_URL||g.image_url||"",P=g._crosshairMatch,I=P?`<span style="display: inline-block; background: ${P.status==="Verified"?"#e8f5e9":"#e3f2fd"}; color: ${P.status==="Verified"?"#2e7d32":"#1565c0"}; font-size: 10px; font-weight: 600; padding: 1px 6px; border-radius: 8px; margin-left: 8px;">↔ ${S.sanitizeInput(P.competitorLabel||P.competitor)}</span>`:"",H=v?`<img src="${S.sanitizeInput(v)}" alt="" style="width:36px; height:36px; object-fit:contain; border-radius:4px; margin-right:10px; flex-shrink:0;" onerror="this.style.display='none'">`:"",M=P?Object.fromEntries(Object.entries(g).filter(([A])=>A!=="_crosshairMatch")):g;return`<li data-product='${JSON.stringify(M).replace(/'/g,"&apos;")}'
...
`);if(e.length>0){const o=e[0].split(" - ")[0].trim(),s=document.getElementById("app-version");s&&(s.textContent=`Ver: ${o}`,s.style.cursor="pointer",s.addEventListener("click",No))}}),Do(),To()});function Do(){const u=document.getElementById("help-btn");u&&u.addEventListener("click",()=>{Bo()});const e=document.getElementById("crosshair-btn");e&&e.addEventListener("click",()=>{window.location.href="screens/validator.html"});const t=document.getElementById("admin-btn");t&&t.addEventListener("click",()=>{window.location.href="screens/admin.html"});const o=document.getElementById("quick-start-btn");o&&o.addEventListener("click",()=>{yt.showForced()})}function To(){const u=document.getElementById("user-menu-container"),e=document.getElementById("user-menu-trigger"),t=document.getElementById("user-menu-dropdown"),o=document.getElementById("sign-in-btn"),s=document.getElementById("user-avatar"),n=document.getElementById("user-name-display");function r(c){var l,d,p,h,f,y;if(c){(l=U.CROSSHAIR)!=null&&l.ENABLED&&(_.configure(U.CROSSHAIR,c.email||""),_.preload().catch(m=>{console.warn("Crosshair preload after login failed:",m)})),u&&(u.style.display="block"),o&&(o.style.display="none");const w=document.getElementById("crosshair-btn");w&&(w.style.display=(d=U.CROSSHAIR)!=null&&d.ENABLED&&J.isStaffMode()?"":"none");const g=document.getElementById("admin-btn");g&&(g.style.display=J.isAdmin()?"":"none");const x=i(c.name);s&&(s.textContent=x),n&&(n.textContent=((p=c.name)==null?void 0:p.split(" ")[0])||"User"),t&&(t.innerHTML=`
        ...
        `,(h=document.getElementById("menu-profile"))==null||h.addEventListener("click",()=>{t.style.display="none",X.showEditProfile(m=>{b.clearUserSettings(),r(m)})}),(f=document.getElementById("menu-password"))==null||f.addEventListener("click",()=>{t.style.display="none",X.showChangePassword()}),(y=document.getElementById("menu-logout"))==null||y.addEventListener("click",()=>{t.style.display="none",b.clearUserSettings(),J.logout(),r(null)}))}else u&&(u.style.display="none"),o&&(o.style.display="block")}function i(c){if(!c)return"?";const l=c.trim().split(" ");return l.length>=2?(l[0][0]+l[l.length-1][0]).toUpperCase():c.substring(0,2).toUpperCase()}function a(c){const l=document.createElement("div");return l.textContent=c||"",l.innerHTML}e&&t&&(e.addEventListener("click",c=>{c.stopPropagation();const l=t.style.display!=="none";t.style.display=l?"none":"block"}),document.addEventListener("click",c=>{u!=null&&u.contains(c.target)||(t.style.display="none")})),o&&o.addEventListener("click",()=>{X.showLogin(c=>{r(c)})}),J.onAuthChange=r,r(J.getCurrentUser())}function Bo(){const u=document.getElementById("user-guide-modal"),e=document.getElementById("user-guide-content");if(!u||!e)return;e.innerHTML=Ao(),u.style.display="flex";const t=document.getElementById("user-guide-close");t&&(t.onclick=()=>{u.style.display="none"}),u.onclick=s=>{s.target===u&&(u.style.display="none")};const o=s=>{s.key==="Escape"&&(u.style.display="none",document.removeEventListener("keydown",o))};document.addEventListener("keydown",o)}function Ao(){return`
