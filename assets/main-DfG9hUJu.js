...
`),i=new Blob([s],{type:"text/csv;charset=utf-8"});return console.log("✅ CSV generated successfully"),i}catch(t){throw console.error("❌ CSV generation failed:",t),t}}async generateBothFiles(e){try{const[t,o]=await Promise.all([this.generatePDF(e),this.generateCSV(e)]);return{pdfBlob:t,csvBlob:o}}catch(t){throw console.error("❌ File generation failed:",t),t}}getSelectedProducts(){const e=JSON.parse(localStorage.getItem("selection")||"[]"),t=JSON.parse(localStorage.getItem(U.STORAGE_KEYS.SELECTED_PRODUCTS)||"[]");return t.length>0?t:e.map(o=>({product:o,room:o.Room||"",notes:o.Notes||"",quantity:o.Quantity||1}))}calculateTotalPrice(e,t){const s=(parseFloat(e.toString().replace(/[^0-9.]/g,""))||0)*(t||1);return s>0?s.toFixed(2):""}cleanForCSV(e){return e?e.toString().replace(/"/g,'""').replace(/[\r\n]/g," "):""}async generateQuotePDF(e){return await this.generatePDF(e)}async generateReportPDF(e){return await this.generatePDF(e)}generateFileName(e,t){const o=new Date,s=String(o.getDate()).padStart(2,"0"),i=String(o.getMonth()+1).padStart(2,"0"),n=String(o.getFullYear()).slice(-2),r=String(o.getHours()).padStart(2,"0"),a=String(o.getMinutes()).padStart(2,"0");return`${(e.project||"seima-selection").replace(/[^a-zA-Z0-9\s]/g,"")}-${s}${i}${n}.${r}${a}.${t}`}downloadFile(e,t){const o=URL.createObjectURL(e),s=document.createElement("a");s.href=o,s.download=t,document.body.appendChild(s),s.click(),document.body.removeChild(s),URL.revokeObjectURL(o)}getSelectionSummary(){const e=this.getSelectedProducts(),t=e.length,s=new Set(e.map(n=>n.room).filter(Boolean)).size||1;let i=0;return e.forEach(n=>{var c,l;const r=parseFloat((((c=n.product)==null?void 0:c.UserEditedPrice)||((l=n.product)==null?void 0:l.RRP_EX)||"0").toString().replace(/[^0-9.]/g,""))||0,a=n.quantity||1;i+=r*a}),{totalProducts:t,totalRooms:s,totalValue:i,hasProducts:t>0}}}const qt=new Gt,Wt={Utils:x},Vt=M;class Xt{constructor(){this.modules={dataLayer:T,pdfGenerator:qt,pdfCore:Ze,pdfLayouts:ft,StorageManager:E,utils:Wt},this.isInitialized=!1,this.initStatus={}}async init(){try{console.log("🚀 Initializing modular components...");const e=await this.initModule("dataLayer",this.modules.dataLayer);return this.initStatus.dataLayer=e,this.initStatus.pdfGenerator="deferred",this.isInitialized=!0,console.log("✅ Module initialization complete:",this.initStatus),this.initStatus}catch(e){return console.error("❌ Module coordinator initialization failed:",e),!1}}async initModule(e,t){try{if(t&&typeof t.init=="function"){const o=await t.init();return console.log(`✅ ${e} initialized:`,o),o}else return console.log(`ℹ️ ${e} does not require initialization`),!0}catch(o){throw console.error(`❌ Failed to initialize ${e}:`,o),o}}async searchProducts(e,t=10){return this.modules.dataLayer.isLoaded||await this.modules.dataLayer.init(),this.modules.dataLayer.searchProducts(e,t)}async findProductByCode(e){return this.modules.dataLayer.isLoaded||await this.modules.dataLayer.init(),this.modules.dataLayer.findProductByCode(e)}async addProductToSelection(e,{room:t="",notes:o="",quantity:s=1}={}){return this.modules.dataLayer.addProductToSelection(e,{room:t,notes:o,quantity:s})}getSelectedProducts(){return this.modules.dataLayer.getSelectedProducts()}getSelectionSummary(){return this.modules.dataLayer.getSelectionSummary()}async generatePDF(e){return await this.modules.pdfGenerator.generatePDF(e)}async generateCSV(e){return await this.modules.pdfGenerator.generateCSV(e)}async generateBothFiles(e){return await this.modules.pdfGenerator.generateBothFiles(e)}async sendEmail(e,t){return await this.modules.emailService.sendEmailWithPDF(e,t)}clearSelection(){return this.modules.dataLayer.clearSelection()}getModuleStatus(){return{initialized:this.isInitialized,moduleStatus:this.initStatus,dataLayer:{loaded:this.modules.dataLayer.isLoaded,productCount:this.modules.dataLayer.products.length},selection:{count:this.getSelectedProducts().length,summary:this.getSelectionSummary()}}}async reinitializeModule(e){if(this.modules[e])try{return this.initStatus[e]=await this.initModule(e,this.modules[e]),this.initStatus[e]}catch(t){return console.error(`❌ Failed to reinitialize ${e}:`,t),!1}return!1}async batchAddProducts(e){const t=[];for(const{product:o,room:s,notes:i,quantity:n}of e)try{const r=await this.addProductToSelection(o,{room:s,notes:i,quantity:n});t.push({success:!0,result:r})}catch(r){t.push({success:!1,error:r.message,product:o})}return t}exportState(){return{moduleStatus:this.getModuleStatus(),config:Vt,timestamp:new Date().toISOString()}}}const Yt=new Xt;Yt.init().catch(g=>{console.error("❌ Auto-initialization failed:",g)});class Jt{constructor(){this.currentScreen="welcome",this.currentSearchResults=[]}async init(){if(!T.isLoaded)try{await T.init()}catch(e){console.error("Failed to load product catalog:",e)}this.updateSelectionCount(),this.setVersion()}setVersion(){const e=document.getElementById("version-number");e&&(e.innerText=U.VERSION)}async showProductLookupScreen(){try{const t=await(await fetch("./screens/product-grid.html")).text();document.body.innerHTML=t,this.currentScreen="product-grid";const o=document.createElement("script");o.type="module",o.src="js/app.js",document.body.appendChild(o),setTimeout(()=>{document.querySelectorAll(".back-btn").forEach(s=>s.remove())},100),window.productGridManager&&window.productGridManager.init(),await this.loadVersion(),setTimeout(()=>this.loadVersion(),1e3)}catch(e){console.error("Failed to load product grid screen:",e)}}setupSplitInterface(){const e=document.getElementById("back-to-home");e&&(e.onclick=()=>location.reload());const t=document.getElementById("download-btn"),o=document.getElementById("clear-all-btn");t&&(t.onclick=()=>this.showDownloadFormModal()),o&&(o.onclick=()=>this.showClearConfirmModal()),this.setupSplitProductSearch(),this.setupReviewTable(),this.renderReviewTable(),this.loadInitialSearchResults()}setupSplitProductSearch(){const e=document.getElementById("product-search-input"),t=document.getElementById("search-results-list"),o=document.getElementById("search-loading"),s=document.getElementById("search-no-results");if(!e||!t)return;const i=[],n=x.debounce(r=>{this.performSplitProductSearch(r,t,i,o,s)},200);e.addEventListener("input",()=>{const r=e.value.trim();r?n(r):this.loadInitialSearchResults()}),t.addEventListener("click",r=>{const a=r.target.closest(".result-item");if(!a)return;const c=parseInt(a.getAttribute("data-idx"),10),l=i.length>0?i:this.currentSearchResults||[];!isNaN(c)&&l[c]&&this.showSplitProductDetails(l[c])})}performSplitProductSearch(e,t,o,s,i){if(!T.isLoaded){s.style.display="flex",i.style.display="none",t.innerHTML="";return}o.length=0,o.push(...T.searchProducts(e)),s.style.display="none",o.length===0?(i.style.display="flex",t.innerHTML=""):(i.style.display="none",t.innerHTML=o.map((n,r)=>`
    ...
    `,document.body.appendChild(o);const i=_t();Ge("./assets/seima-logo.png",async(n,r,a)=>{const c=JSON.parse(localStorage.getItem("selection")||"[]"),l=JSON.parse(localStorage.getItem(U.STORAGE_KEYS.SELECTED_PRODUCTS)||"[]");let d=[];l.length>0?d=l.map(v=>({...v.product,Room:v.room,Notes:v.notes,Quantity:v.quantity,Timestamp:new Date(v.timestamp).toISOString()})):d=c;const u=document.getElementById("sort-by"),m=u?u.value:"room";switch(m){case"code":d.sort((v,S)=>{const k=v.OrderCode||v.Code||"",P=S.OrderCode||S.Code||"";return k.localeCompare(P)});break;case"product":d.sort((v,S)=>{const k=v.Description||v.ProductName||"",P=S.Description||S.ProductName||"";return k.localeCompare(P)});break;case"room":default:{let v=[];try{const S=localStorage.getItem("customRoomOrder");v=S?JSON.parse(S):[]}catch{v=[]}d.sort((S,k)=>{const P=S.Room||"Blank",C=k.Room||"Blank";if(P===C)return 0;if(P==="Blank")return 1;if(C==="Blank")return-1;const D=v.indexOf(P),F=v.indexOf(C);return D!==-1&&F!==-1?D-F:D!==-1?-1:F!==-1?1:P.localeCompare(C)});break}}if(!d.length){alert("No products selected."),t&&(t.style.display="none");return}if(it()>0)console.log(`📷 Using ${it()} pre-cached images (skipping duplicate preload)`);else{const v=document.getElementById("pdf-processing-notification");if(v){const S=document.createElement("span");S.id="preload-progress",S.style.cssText="display: block; font-size: 12px; margin-top: 8px; color: #1e40af;",S.textContent="Loading images: 0%",v.appendChild(S)}console.log("📷 Starting image preload for",d.length,"products"),gt(d).then(S=>{const k=document.getElementById("preload-progress");k&&(k.textContent=`✓ ${S} images ready`,k.style.color="#059669")}).catch(S=>{console.warn("Image preloading error:",S)})}const p={};m==="room"?d.forEach(v=>{const S=v.Room||"Blank";p[S]||(p[S]=[]),p[S].push(v)}):p.__all__=d,await i;const{jsPDF:y}=window.jspdf,f=new y({orientation:"landscape",unit:"pt",format:"a4",compress:!0,putOnlyUsedFonts:!0,precision:16,userUnit:1,floatPrecision:16}),b=f.internal.pageSize.getWidth(),w=f.internal.pageSize.getHeight();Ge("./assets/seima-logo.png",async(v,S,k)=>{const P=R.getCurrentUser(),C=E.getUserSettings(),D=P?{name:P.name,email:P.email,phone:P.phone,position:P.position}:C;let F=null;try{const{get:O}=await H(async()=>{const{get:L}=await import("./vendor-idb-DwnyWBFG.js");return{get:L}},[]);F=await O("customerLogo")}catch{}Rt(f,{pageWidth:b,pageHeight:w,seimaLogoDataUrl:v,seimaLogoNaturalW:S,seimaLogoNaturalH:k,customerLogoDataUrl:F,userDetails:g,staffContact:D,footerHeight:nt.footerHeight}),f.addPage(),Ge("./assets/seima-logo-white.png",(O,L,X)=>{const Me=g.showRrp&&!g.excludePrice,se=!g.excludePrice,Re=!g.excludeQty,Et=It(b,{leftMargin:32,rightMargin:32,showRrp:Me,showPrice:se,showQty:Re,showTotal:se&&Re}),{colX:ye,colW:Pe,headers:Ue}=Et,Ie=nt.footerHeight;ct();const ot=($,I,Y,ie,G,q,N)=>{if(!I||typeof I!="string"||I.length<10||!I.startsWith("http://")&&!I.startsWith("https://")&&!I.startsWith("data:")){N&&N();return}if((B=>{if(!B||B.length<25||/\/images\/\d+$/.test(B)||B.endsWith("/0"))return!0;const A=/\.(jpg|jpeg|png|gif|webp|svg)(\?.*)?$/i.test(B),j=B.startsWith("data:");return!A&&!j})(I)){console.warn("Skipping malformed image URL:",(I==null?void 0:I.substring(0,50))+"..."),N&&N();return}if(te.totalImages++,g.emailCompatible){te.failedImages++,N&&N();return}const ne=Bt(I);if(ne&&ne.dataUrl)try{const B=ne.width/ne.height;let A=G,j=G/B;j>q&&(j=q,A=q*B),$.addImage(ne.dataUrl,ne.format,Y,ie,A,j,void 0,"FAST"),te.optimizedImages++,N&&N();return}catch{console.warn("Failed to use cached image, falling back to direct load")}let de=!1;const we=["https://wsrv.nl/?url=","https://images.weserv.nl/?url=","https://api.codetabs.com/v1/proxy?quest="];let re=0;function ae(){if(de)return;const B=new Image;B.crossOrigin="Anonymous";let A=null;B.onload=function(){if(!de){de=!0,A&&clearTimeout(A);try{const ue=vt(0),$e=ue.imageMaxWidth,Se=G,ce=q;try{const W=document.createElement("canvas"),le=W.getContext("2d"),{width:me,height:be}=io(B.width,B.height,$e);W.width=me,W.height=be,le.imageSmoothingEnabled=!0,le.imageSmoothingQuality="high",le.drawImage(B,0,0,me,be);let He,je="JPEG";const Pt=so(W,le),Ct=oo(B);Pt||Ct?(He=W.toDataURL("image/png",ue.imageQuality),je="PNG"):(He=W.toDataURL("image/jpeg",ue.imageQuality),je="JPEG");const kt=`img_${po(I)}`;$.addImage(He,je,Y,ie,Se,ce,kt,"FAST"),te.optimizedImages++,N&&N()}catch(W){console.warn(`Failed to optimize image: ${I}`,W),console.warn("Error details:",W.message,W.stack);try{$.addImage(B,"JPEG",Y,ie,Se,ce),te.optimizedImages++,N&&N()}catch(le){console.error(`Fallback also failed for: ${I}`,le),te.failedImages++,N&&N()}}}catch(ue){console.warn("Failed to add image to PDF:",ue),te.failedImages++,N&&N()}}},B.onerror=function(){de||(A&&clearTimeout(A),console.warn(`Failed to load image with proxy ${re}: ${I}`),console.warn(`Error details for: ${I} - Proxy: ${we[re]}`),re++,re<we.length?setTimeout(()=>{ae()},200):(de=!0,console.warn("All proxies failed, skipping image"),te.failedImages++,N&&N()))},A=setTimeout(()=>{de||(console.warn(`⏰ Timeout with proxy ${re}: ${I}`),B.src="",B.onload=null,B.onerror=null,re++,re<we.length?setTimeout(()=>{ae()},200):(de=!0,console.warn("All proxies timed out, skipping image"),te.failedImages++,N&&N()))},3e3);let j=I;re<we.length&&(j=we[re]+encodeURIComponent(I)),B.src=j}ae()},ee=[];Object.keys(p).forEach(($,I)=>{const Y=p[$];if(!Y||!Array.isArray(Y)){console.warn("⚠️ Skipping invalid room items:",$,Y);return}Y.forEach((ie,G)=>{if(!ie){console.warn("⚠️ Skipping null item in room:",$,"at index:",G);return}ee.push({item:ie,room:$,rIdx:I,iIdx:G,isFirstInRoom:G===0,roomCount:Y.length})})}),ee.reduce(($,I)=>{if(!I||!I.item)return console.warn("⚠️ Skipping null row in data analysis:",I),$;const Y=String(I.item.Description||""),ie=String(I.item.LongDescription||""),G=String(I.item.Notes||""),q=String(I.item.OrderCode||"");return $+Y.length+ie.length+G.length+q.length},0);let Ce=0,Le=0;const Te=4,De=8,Oe=Math.floor((w-80)/Te);let st=Ie+8;function ze(){if(!ee||!Array.isArray(ee)){console.error("❌ Critical error: rowsToDraw is not a valid array:",ee),at(new Error("Invalid product data structure"),"generating PDF","unknown.pdf");return}if(Ce>=ee.length){const G=f.internal.getNumberOfPages()-1;for(let A=2;A<=G+1;A++){f.setPage(A);const ue=(A-2)*Te,$e=Math.min(ue+Te,ee.length);let Se=!1;for(let ce=ue;ce<$e;ce++)if(ee[ce]&&ee[ce].item&&Lt(ee[ce].item)){Se=!0;break}Tt(f,{pageWidth:b,colX:ye,colW:Pe,leftMargin:32,footerHeight:Ie,logoDataUrl:O,logoNaturalW:L,logoNaturalH:X,headers:Ue,userDetails:g,skipWelsHeader:!Se}),Dt(f,{pageWidth:b,pageHeight:w,leftMargin:32,footerHeight:Ie,pageNumber:A-1,totalPages:G})}const q=new Date,N=String(q.getDate()).padStart(2,"0"),ve=String(q.getMonth()+1).padStart(2,"0"),ne=String(q.getFullYear()).slice(-2),de=String(q.getHours()).padStart(2,"0"),we=String(q.getMinutes()).padStart(2,"0"),ae=`${g.project.replace(/[^a-zA-Z0-9\s]/g,"")}-${N}${ve}${ne}.${de}${we}.pdf`,B=document.getElementById("pdf-processing-notification");B&&B.remove(),ho(g.emailCompatible);try{const A=f.output("blob"),j=f.output("string"),ue=j?j.match(/\/Type\s*\/XObject/g):null,$e=j?j.match(/Tj\s/g):null,Se=j?j.match(/\/A\s*<</g):null;g.pdfSize=A.size;const ce=ro(A,ae);if(g.sendEmail&&A.size>15*1024*1024){console.warn(`❌ PDF too large for email (${(A.size/1024/1024).toFixed(1)}MB), offering email-compatible version`),go(g,ae);return}const W=no(A,ce.settings);if(g.sendEmail&&g.email)if(g.exportCsv){const le=ae.replace(/\.pdf$/,".csv");rt(g,le).then(me=>{window.dispatchEvent(new CustomEvent("sendEmail",{detail:{userDetails:g,pdfBlob:W,csvBlob:me}}))}).catch(me=>{console.error("Async CSV generation for email failed:",me),window.dispatchEvent(new CustomEvent("sendEmail",{detail:{userDetails:g,pdfBlob:W,csvBlob:null}}))})}else window.dispatchEvent(new CustomEvent("sendEmail",{detail:{userDetails:g,pdfBlob:W,csvBlob:null}}));else(async()=>{const le=await yo(W);if(await Qe(le,ae,"PDF"),g.exportCsv){const me=ae.replace(/\.pdf$/,".csv");try{const be=await rt(g,me);be&&await Qe(be,me,"CSV")}catch(be){console.error("CSV generation failed:",be)}}})()}catch(A){console.error("PDF generation failed:",A),at(A,"generating PDF",ae);const j=document.getElementById("pdf-processing-notification");j&&j.remove()}t&&(t.style.display="none");return}Le>=Te&&(f.addPage(),st=Ie+8,Le=0);const $=ee[Ce];if(!$||!$.item){console.warn(`⚠️  Skipping invalid row at index ${Ce}:`,$),Ce++,ze();return}const I=st+Oe*Le;$.isFirstInRoom&&m==="room"&&$.room!=="__all__"&&$t(f,$.room,$.roomCount,32,I);const Y=ye[0],ie=Y+90+12;ot(f,$.item.Image_URL||"",Y,I+De+16,90,Oe-De*2,()=>{ot(f,$.item.Diagram_URL||"",ie,I+De+16,90,Oe-De*2,()=>{const G=I+28,q=ye[1]+Pe[1]/2;f.setFontSize(10),f.setTextColor("#222"),f.text(String($.item.OrderCode||""),q,G+10,{align:"center"}),At(f,$.item,q,G+35);const N=Pe[2]-10;Ft(f,$.item,ye[2],G+10,N,g.excludeLongDescription);const ve=Ue.indexOf("WELS")+1;if(ve>0&&ye[ve]){const ne=ye[ve]+Pe[ve]/2;Nt(f,$.item,ne,G+10)}Mt(f,$.item,ye,Pe,Ue,G+10,{excludePrice:g.excludePrice,includeGst:g.includeGst}),Ce++,Le++,ze()})})}ze()})})})}function Ge(g,e){const t=new window.Image;t.crossOrigin="Anonymous",t.onload=function(){const o=document.createElement("canvas"),s=o.getContext("2d"),i=400,n=150;let r=t.width,a=t.height;if(r>i||a>n){const l=i/r,d=n/a,u=Math.min(l,d);r=Math.round(r*u),a=Math.round(a*u)}o.width=r,o.height=a,s.imageSmoothingEnabled=!0,s.imageSmoothingQuality="high",s.drawImage(t,0,0,r,a);const c=o.toDataURL("image/png",.9);e(c,r,a)},t.src=g}function Qt(){if(!document.getElementById("pdf-spinner")){const g=document.createElement("div");if(g.id="pdf-spinner",g.style.display="none",g.style.position="fixed",g.style.top="0",g.style.left="0",g.style.width="100vw",g.style.height="100vh",g.style.zIndex="9999",g.style.background="rgba(255,255,255,0.7)",g.style.alignItems="center",g.style.justifyContent="center",g.innerHTML='<div style="border:6px solid #e0e0e0;border-top:6px solid #2563eb;border-radius:50%;width:54px;height:54px;animation:spin 1s linear infinite;"></div>',document.body.appendChild(g),!document.getElementById("pdf-spinner-style")){const e=document.createElement("style");e.id="pdf-spinner-style",e.innerHTML="@keyframes spin { 0% { transform: rotate(0deg);} 100% { transform: rotate(360deg);} }",document.head.appendChild(e)}}}async function rt(g,e){return new Promise(async t=>{if(!window.Papa)try{await x.loadScript("https://cdn.jsdelivr.net/npm/papaparse@5.4.1/papaparse.min.js")}catch(n){console.error("Failed to load PapaParse:",n),t(null);return}const o=JSON.parse(localStorage.getItem("selection")||"[]"),s=JSON.parse(localStorage.getItem(U.STORAGE_KEYS.SELECTED_PRODUCTS)||"[]");let i=[];if(s.length>0?i=s.map(n=>({...n.product,Room:n.room,Notes:n.notes,Quantity:n.quantity,Timestamp:new Date(n.timestamp).toISOString()})):i=o,!i.length){t(null);return}setTimeout(()=>{const n=i.map(r=>{let a,c,l,d;const u=g.excludePrice;let m=0;if(r.UserEditedPrice!==void 0&&r.UserEditedPrice!==null&&r.UserEditedPrice!=="")m=parseFloat(r.UserEditedPrice.toString().replace(/,/g,""));else{const f=r.RRP_EX||r["RRP EX GST"]||r.RRP_EX||r.RRP_EXGST||"";m=parseFloat((f||"0").toString().replace(/,/g,""))}a=m,l="Price ea ex GST",d="Price Total ex GST",c=!isNaN(a)&&a>=0?(a*(r.Quantity||1)).toFixed(2):"";const h=r["WELS STAR"]||r.WELS_STAR||r.WELS_STAR||r.WelsStar||"",p=h&&h.toString().trim()?h.toString().replace(/[^\d.]/g,"").trim():"",y={Code:pe(r.OrderCode||""),Description:pe(r.Description||""),"WELS Star":pe(p),Quantity:r.Quantity||1,Notes:pe(r.Notes||""),Room:pe(r.Room||""),"Image URL":pe(r.Image_URL||""),"Diagram URL":pe(r.Diagram_URL||""),"Datasheet URL":pe(r.Datasheet_URL||""),"Website URL":pe(r.Website_URL||"")};return y[l]=u?"0.00":a>=0?a.toFixed(2):"",y[d]=u?"0.00":c,y});setTimeout(()=>{const r=window.Papa.unparse(n,{quotes:!0,quoteChar:'"',delimiter:",",header:!0,newline:`\r
`,skipEmptyLines:!1,escapeChar:'"',transform:{value(a,c){return typeof a=="string"?a.replace(/\0/g,"").replace(/[\x00-\x08\x0B\x0C\x0E-\x1F]/g,""):a}}});g.sendEmail?setTimeout(()=>{try{const a=btoa(unescape(encodeURIComponent(r)));t({name:e,data:a,contentType:"text/csv",originalSize:r.length,base64Size:a.length})}catch(a){console.error("CSV base64 encoding failed:",a),t(new Blob([r],{type:"text/csv"}))}},0):t(new Blob([r],{type:"text/csv"}))},0)},0)})}function pe(g){return typeof g!="string"&&(g=String(g)),g=g.replace(/\0/g,"").replace(/[\x00-\x08\x0B\x0C\x0E-\x1F]/g,"").replace(/\r?\n|\r/g," ").trim(),g}async function Kt(g,e,t="file"){try{if("showSaveFilePicker"in window){const s=await(await window.showSaveFilePicker({suggestedName:e,types:[{description:`${t} files`,accept:{[g.type]:[`.${e.split(".").pop()}`]}}]})).createWritable();return await s.write(g),await s.close(),!0}}catch(o){console.warn("File System Access API failed:",o)}return!1}function Zt(g,e,t="file"){try{if(g.size>2*1024*1024)return console.warn("File too large for data URI method"),!1;const o=new FileReader;return o.onload=function(s){try{const i=document.createElement("a");i.href=s.target.result,i.download=e,i.style.display="none",document.body.appendChild(i),i.click(),document.body.removeChild(i)}catch(i){console.error("Data URI download failed:",i)}},o.readAsDataURL(g),!0}catch(o){return console.warn("Data URI method failed:",o),!1}}function eo(g,e,t="file"){const o=URL.createObjectURL(g),s=document.createElement("div");s.style.cssText=`
...
========================
  `.trim();try{navigator.clipboard.writeText(e)}catch(t){console.error("Failed to copy error report:",t)}}let te={totalImages:0,optimizedImages:0,failedImages:0,totalSavings:0};function po(g){let e=0;if(g.length===0)return e.toString();for(let t=0;t<g.length;t++){const o=g.charCodeAt(t);e=(e<<5)-e+o,e=e&e}return Math.abs(e).toString(36)}function ct(){te={totalImages:0,optimizedImages:0,failedImages:0,totalSavings:0}}function ho(g=!1){te.totalImages>0}function go(g,e){const t=document.createElement("div");t.style.cssText=`
    position: fixed; top: 0; left: 0; width: 100%; height: 100%; 
    background: rgba(0,0,0,0.8); z-index: 10001; display: flex; 
    align-items: center; justify-content: center; padding: 20px;
  ...
  `,document.body.appendChild(t),setTimeout(()=>{t.parentElement&&t.remove()},8e3)}const We="fredChatHistory",Ne="fredChatMessages",ke="fredFeedback",Ee="fredQuestionLog",Ve=16,V={PROXY_URL:"https://seima-ai-proxy.seima.workers.dev",MODEL:"gpt-4o",MAX_TOKENS:2e3,TEMPERATURE:.2,MAX_CATALOG_RESULTS:60};function Xe(){return{"Content-Type":"application/json",...R.getAuthHeaders()}}const vo=`You are a product specification parser for building/construction projects. Extract ALL product references from the provided text.
...
Return format: [{"code":"...","name":"...","brand":"...","category":"...","quantity":1,"finish":"...","section":"...","specCode":"...","style":"..."}]`;class wo{constructor(){this.conversationHistory=[],this._historyReady=this._loadHistory(),this.isProcessing=!1,this._catalogChecked=!1,this._syncing=!1,this.lastCompetitorProducts=new Map}async chat(e,t,o=null,s=null,i=null){var n,r;if(this.isProcessing)throw new Error("A request is already in progress");this.isProcessing=!0,await this._historyReady,this._catalogChecked||(this._catalogChecked=!0,this._checkCatalogFreshness());try{const a=typeof e=="string"?e:((r=(n=e.find)==null?void 0:n.call(e,l=>l.type==="text"))==null?void 0:r.text)||"";let c;try{c=await this._agentChatStream(a,o,i,s)}catch(l){console.warn("Agent chat failed, falling back to legacy flow:",l.message),c=null}if(c||(c=await this._legacyChat(e,a,t,o,s)),!c)throw new Error("No response from AI");return this.conversationHistory.push({role:"user",content:a||e},{role:"assistant",content:c}),this.conversationHistory.length>Ve&&(this.conversationHistory=this.conversationHistory.slice(-Ve)),await this._saveHistory(),{content:c,usage:null}}finally{this.isProcessing=!1}}async _agentChatStream(e,t,o,s){var r;const i=new AbortController,n=setTimeout(()=>i.abort(),6e4);try{const a=await fetch(`${V.PROXY_URL}/v1/agent-chat`,{method:"POST",headers:Xe(),body:JSON.stringify({message:e,history:this.conversationHistory.slice(-12),model:V.MODEL,staffMode:R.isStaffMode(),powerUser:R.isPowerUser(),userEmail:((r=R.getCurrentUser())==null?void 0:r.email)||"",selectedProducts:(t==null?void 0:t.length)>0?t.map(p=>({OrderCode:p.OrderCode,ProductName:p.ProductName||p.Description,room:p.room})):void 0}),signal:i.signal});if(!a.ok){const p=await a.json().catch(()=>({}));throw new Error(p.details||p.error||`Request failed (${a.status})`)}if((a.headers.get("content-type")||"").includes("application/json")){const p=await a.json();return p.needsSync?(this._ensureCatalogSync(),null):p.content||null}const l=a.body.getReader(),d=new TextDecoder;let u="",m="",h="";for(this.lastCompetitorProducts.clear();;){const{done:p,value:y}=await l.read();if(p)break;m+=d.decode(y,{stream:!0});const f=m.split(`
`);m=f.pop();for(const b of f)if(b.startsWith("event: "))h=b.slice(7).trim();else if(b.startsWith("data: ")){try{const w=JSON.parse(b.slice(6));if(h==="status"&&o)o(w.text);else if(h==="token")u+=w.text,s&&s(w.text);else if(h==="comp_products")for(const v of w.products||[])v.code&&this.lastCompetitorProducts.set(v.code,v);else if(h==="error")throw new Error(w.message||"Agent chat failed")}catch(w){if(w instanceof SyntaxError)continue;throw w}h=""}}return u||null}catch(a){throw a.name==="AbortError"?new Error("Request timed out."):a}finally{clearTimeout(n)}}async _legacyChat(e,t,o,s,i){var l,d,u;const n=[],r=await this._findRelevantProductsAI(t,o);if(r?n.push({role:"system",content:`SEIMA PRODUCT DATA (${r.count} products):
${r.text}
...
`);return console.log(`PDF text extraction: ${o.numPages} pages, ${s.length} with text, ${i.length} chars total`),i}catch(t){return console.warn("PDF text extraction failed, will use vision API:",t),null}}_fileToBase64(e){return new Promise((t,o)=>{const s=new FileReader;s.onload=()=>t(s.result.split(",")[1]),s.onerror=()=>o(new Error("Failed to read file")),s.readAsDataURL(e)})}async _compressPdf(e,t){if(!window.pdfjsLib)throw new Error("PDF.js must be loaded before compression");if(!window.jspdf){const u=document.createElement("script");u.src="https://cdn.jsdelivr.net/npm/jspdf@2.5.2/dist/jspdf.umd.min.js",document.head.appendChild(u),await new Promise((m,h)=>{u.onload=m,u.onerror=()=>h(new Error("Failed to load jsPDF")),setTimeout(()=>h(new Error("jsPDF load timeout")),1e4)})}const o=await e.arrayBuffer(),s=await window.pdfjsLib.getDocument({data:o}).promise,{jsPDF:i}=window.jspdf,n=1.5,r=.65;let a=null;for(let u=1;u<=s.numPages;u++){t&&t(u,s.numPages);const m=await s.getPage(u),h=m.getViewport({scale:n}),p=document.createElement("canvas");p.width=h.width,p.height=h.height;const y=p.getContext("2d");await m.render({canvasContext:y,viewport:h}).promise;const f=p.toDataURL("image/jpeg",r),b=h.width>h.height?"landscape":"portrait";u===1?a=new i({orientation:b,unit:"px",format:[h.width,h.height]}):a.addPage([h.width,h.height],b),a.addImage(f,"JPEG",0,0,h.width,h.height),p.width=0,p.height=0}const c=a.output("blob"),l=new File([c],e.name,{type:"application/pdf"}),d=Math.round((1-l.size/e.size)*100);return console.log(`PDF compressed: ${(e.size/(1024*1024)).toFixed(1)}MB → ${(l.size/(1024*1024)).toFixed(1)}MB (${d}% reduction)`),l.size<e.size*.9?l:(console.log("Compression did not significantly reduce size, using original"),e)}_showSpecResults(e){const t=e.filter(u=>["verified","seima-own","alternative","catalog-suggestion"].includes(u.status)),o=e.filter(u=>u.status==="unmatched"||u.status==="ai-suggested"),s=[...new Set(e.map(u=>u.section).filter(Boolean))],i=document.getElementById("spec-results-content");if(!i)return;let n="";if(this._projectMeta){const u=this._projectMeta;[u.name,u.architect,u.builder,u.location].filter(Boolean).length>0&&(n=`<div class="spec-project-meta" style="margin-bottom:12px;padding:8px 12px;background:#f0f9ff;border-radius:6px;border:1px solid #bae6fd;">
    ...
    `}_updateImportCount(){const e=document.querySelectorAll(".spec-row-check:checked").length,t=document.getElementById("spec-add-all-btn");t&&(t.textContent=`Import Selected to Grid (${e})`,t.disabled=e===0)}_importSelectedToGrid(){var c,l;if(!this._specResults)return;const e=document.querySelectorAll(".spec-row-check:checked");this.importMode==="override"&&(E.clearAllSelections(),console.log("Cleared all existing data for override mode (spec import)"));const t=new Set;e.forEach(d=>{const u=parseInt(d.dataset.index),m=this._specResults[u];m!=null&&m.section&&t.add(m.section)}),t.forEach(d=>E.addCustomRoom(d));const o=[];e.forEach(d=>{var f,b;const u=parseInt(d.dataset.index),m=this._specResults[u];if(!m)return;const h=this._buildSpecNote(m),p=m.section||"Imported";if((m.status==="seima-own"||m.status==="verified")&&m.seimaProduct){const w=m.seimaProduct.OrderCode||m.seimaProduct["Order Code"]||((b=(f=m.seimaMatches)==null?void 0:f[0])==null?void 0:b.SeimaSKU),v=T.findProductByCode(w);if(v){o.push({product:v,notes:h,room:p,quantity:m.quantity||1});return}}let y=h;if(m.seimaProduct&&m.status!=="seima-own"&&m.status!=="verified"){const w=m.seimaProduct.OrderCode||"",v=m.seimaProduct.ProductName||m.seimaProduct.Description||"";y+=` | SEIMA SUGGESTION: ${w} ${v}`}o.push({product:{OrderCode:"",Description:h,_placeholder:!0},notes:y,room:p,quantity:m.quantity||1})});const s=E.addProductsBatch(o),i=s?o.length:0;s||alert(`Could not save all products — browser storage is full.
...
This can be restored later.`))try{const t=await ge.deleteSelections([e.id]);t.success?(this.showToast("Selection deleted"),this.fetchAndRenderSelections()):this.showError(t.error||"Failed to delete")}catch(t){this.showError(t.message)}}async restoreSelection(e){try{const t=await ge.restoreSelections([e.id]);t.success?(this.showToast("Selection restored"),this.fetchAndRenderSelections()):this.showError(t.error||"Failed to restore")}catch(t){this.showError(t.message)}}showToast(e){const t=document.createElement("div");t.style.cssText=`
    ...
    `,n.querySelector(".uv-confirm-cancel").addEventListener("click",()=>n.remove()),n.querySelector(".uv-confirm-done").addEventListener("click",()=>{this._submitAndClose(e)}),n.addEventListener("click",a=>{a.target===n&&n.remove()}),t.appendChild(n)}async _submitAndClose(e){if(!this._currentCompetitor||!this._currentCompetitorProduct)return;const t=R.getCurrentUser();if(!(t!=null&&t.email)){this._showToast("Please sign in to submit.","error");return}if(Ae>=ut){this._showToast("Session limit reached. Thank you for your contributions!","error");return}const o=this._currentCompetitor,s=String(this._currentCompetitorProduct.product_code||""),i=this._seimaByCode[e],n=this._onProductSelected;i&&n&&n(i),this.close(),this._showToast("Thanks! Your suggestion has been submitted for review.");try{await _.submitUserVerification(o,s,e,t.email,""),Ae++}catch(r){console.error("UserVerify: submit failed",r),this._showToast("Submission failed — please try again later.","error")}}async _submitNoEquivalent(){if(!this._currentCompetitor||!this._currentCompetitorProduct)return;const e=R.getCurrentUser();if(!(e!=null&&e.email)){this._showToast("Please sign in to submit.","error");return}if(Ae>=ut){this._showToast("Session limit reached. Thank you for your contributions!","error");return}const t=String(this._currentCompetitorProduct.product_code||"");try{await _.submitUserVerification(this._currentCompetitor,t,"NO_EQUIVALENT",e.email,"User indicated no Seima equivalent exists"),Ae++,this.close(),this._showToast("Thanks! We've noted that this product has no Seima equivalent.")}catch(o){console.error("UserVerify: no-equivalent submit failed",o),this._showToast("Failed to submit. Please try again.","error")}}_quickMatch(e,t=6){if(!this._seimaFormatted||this._seimaFormatted.length===0)return[];const o=(e.product_type||e.subcategory||"").toLowerCase(),s=this._normalizeFinish(e.finish||e.colour||""),i=parseFloat(e.rrp_ex_gst||e.rrp||e.price)||0,n=(e.material||"").toLowerCase(),r=this._tokenize(`${e.product_name||""} ${e.product_type||""} ${e.collection||""} ${e.finish||""} ${e.material||""}`),a=[Ut(e.product_name),o].filter(Boolean);let c;for(const m of a)if(c=Ot[m.toLowerCase()],c)break;const l=[];for(const m of this._seimaFormatted){if(c){const C=`${m.subGroup} ${m.group} ${m.range} ${m.name}`.toUpperCase();if(!c.some(D=>C.includes(D)))continue}const h=[m.subGroup,m.group,m.range,m.name,m.longDescription].filter(Boolean).join(" ").toLowerCase(),p=this._tokenize(h);let y=0;for(const C of r)p.includes(C)&&y++;const f=r.length>0?y/r.length*100:0,b=this._normalizeFinish(`${m.group||""} ${m.name||""}`),w=s&&b&&s===b?100:s&&b&&(s.includes(b)||b.includes(s))?60:0;let v=50;if(n){const C=(m.longDescription||"").toLowerCase();C.includes(n)?v=100:n.split(/\s+/).some(D=>D.length>=4&&C.includes(D))?v=60:v=0}const S=parseFloat(m.rrpExGst)||0;let k=50;if(i>0&&S>0){const C=Math.min(i,S)/Math.max(i,S);k=C>=.8?100:C>=.6?70:C>=.4?40:10}const P=Math.round(f*.35+w*.25+v*.2+k*.2);P<15||l.push({seima:m,score:P,textScore:Math.round(f),finishScore:w,materialScore:v,priceScore:k})}l.sort((m,h)=>h.score-m.score);const d=new Set,u=[];for(const m of l)if(!d.has(m.seima.orderCode)&&(d.add(m.seima.orderCode),u.push(m),u.length>=t))break;return u}_normalizeFinish(e){const t=(e||"").toLowerCase(),o={chrome:["chrome"," cr",",cr","cp","polished chrome"],"matte black":["matte black","matt black"," mb",",mb","mblk","black"],"brushed nickel":["brushed nickel"," bn",",bn","satin nickel","nickel"],"brushed brass":["brushed brass"," bb",",bb","brass","warm brass"],"brushed gold":["brushed gold"," bg",",bg","gold","light gold"],"gun metal":["gun metal","gunmetal"," gm",",gm"],white:["white"," wh",",wh","gloss white"],"stainless steel":["stainless steel"," ss",",ss","stainless"]};for(const[s,i]of Object.entries(o))if(i.some(n=>t.includes(n)))return s;return t.trim()}_tokenize(e){return(e||"").toLowerCase().replace(/[^a-z0-9\s]/g," ").split(/\s+/).filter(t=>t.length>=2)}_showToast(e,t="success"){const o=document.querySelector(".uv-toast");o&&o.remove();const s=document.createElement("div");s.className=`uv-toast uv-toast-${t}`,s.textContent=e,document.body.appendChild(s),setTimeout(()=>s.classList.add("uv-toast-visible"),10),setTimeout(()=>{s.classList.remove("uv-toast-visible"),setTimeout(()=>s.remove(),300)},3500)}_extractCompetitorDimensions(e){if(!e)return"";if(e.dimensions_mm)return e.dimensions_mm;let t=0,o=0,s=0;for(const i of Object.keys(e)){const n=i.toLowerCase();n.includes("width")&&!t&&(t=parseFloat(e[i])||0),n.includes("depth")&&!o&&(o=parseFloat(e[i])||0),n.includes("height")&&!s&&(s=parseFloat(e[i])||0)}if(t>0||o>0||s>0){const i=[];return t&&i.push(t),o&&i.push(o),s&&i.push(s),i.join(" × ")+"mm"}return""}_esc(e){const t=document.createElement("div");return t.textContent=e||"",t.innerHTML}}const St=new _o;class Ro{constructor(){this.activeDropdown=null,this.updatePositionHandler=null,document.addEventListener("click",e=>{e.target.closest(".global-search-dropdown")||this.hideDropdown()})}showDropdown(e,t,o,s=!1){this.hideDropdown();const i=document.createElement("ul");i.className="global-search-dropdown";const n=300,r=e.getBoundingClientRect(),a=window.innerWidth,c=r.width;let l=r.left;l+c>a-8&&(l=a-c-8),l<8&&(l=8);const d={position:"fixed",top:"0px",left:`${l}px`,width:`${c}px`,minWidth:`${c}px`,maxWidth:`${c}px`,background:"#fff",border:"1px solid #d1d5db",borderRadius:"8px",boxShadow:"0 10px 25px -5px rgba(0, 0, 0, 0.15), 0 8px 10px -6px rgba(0, 0, 0, 0.10)",maxHeight:`${n}px`,overflowY:"auto",overflowX:"hidden",zIndex:"10010",listStyle:"none",margin:"0",padding:"4px 0",whiteSpace:"normal",wordWrap:"break-word",display:"block",pointerEvents:"auto",transform:"none",contain:"none",isolation:"isolate",visibility:"hidden"};if(Object.keys(d).forEach(u=>{i.style.setProperty(u,d[u],"important")}),i.maxDropdownHeight=n,t.length===0?i.innerHTML='<li style="padding: 12px 16px; color: #6b7280; font-style: italic; background: #fff;">No products found</li>':i.innerHTML=t.map(u=>{if(u._crosshairValidate){const v=u._crosshairValidate,S=v.imageUrl?`<img src="${x.sanitizeInput(v.imageUrl)}" alt="" style="width:32px; height:32px; object-fit:contain; border-radius:4px; margin-right:10px; vertical-align:middle; flex-shrink:0;">`:"";return`<li data-validate-competitor="${x.sanitizeInput(v.competitor)}" data-validate-code="${x.sanitizeInput(v.productCode)}"
      ...
      `,s.style.display="flex"),!_.isEnabled())try{await _.preload()}catch{}if(e===this._matchSuggestionsRunId){if(!_.isEnabled()){s&&(s.innerHTML=`
        ...
        `,setTimeout(()=>{s&&(s.style.display="none")},8e3));return}for(const l of t){if(e!==this._matchSuggestionsRunId)return;const d=l.dataset.rowId,u=this.gridRows.find(P=>P.id===d);if(!((n=u==null?void 0:u.product)!=null&&n._placeholder))continue;const m=u.product.Description||"",h=this.extractCandidateCodes(m);if(h.length===0)continue;const p=l.closest(".grid-product-cell"),y=p==null?void 0:p.querySelector(".grid-placeholder-hint"),f=[];for(const P of h)try{const C=await _.findCompetitorEntryByCode(P);if(e!==this._matchSuggestionsRunId)return;if(C){const D=C.matchedCode??((r=C.competitorProduct)==null?void 0:r.product_code)??P;f.push({code:P,competitor:C.competitor,searchCode:D})}else console.log(`Crosshair: no competitor match for code "${P}" (row ${d})`)}catch{}if(y&&f.length>0&&(y.innerHTML=this.buildPlaceholderHintHtml(m,f)),!T.isLoaded)continue;let b=null,w="";for(const P of h)try{const C=await _.findSeimaMatches(P);if(e!==this._matchSuggestionsRunId)return;if(((a=C==null?void 0:C.matches)==null?void 0:a.length)>0){const D=String(C.matches[0].SeimaSKU).trim(),F=T.findProductByCode(D);if(F){b=F;const L=(C.competitorProduct||{}).product_name||F.Description||"";w=`${C.competitor}: ${P} → ${D}${L?" – "+L:""}`;break}}}catch{}if((c=u==null?void 0:u.product)!=null&&c._placeholder&&s){i++;const P=Math.round(i/o.length*100),C=s.querySelector("span");C&&(C.textContent=`Cross-referencing ${i}/${o.length} products (${P}%)...`)}if(!b||l.querySelector(".grid-seima-match-btn"))continue;const v=document.createElement("button");v.type="button",v.className="grid-seima-match-btn";const S=(b.Description||"").trim(),k=S.length>45?S.slice(0,45)+"…":S;v.textContent=`Use Seima match: ${b.OrderCode||""} – ${k}`,v.title=w,v.addEventListener("click",()=>{const P=l.closest(".grid-row"),C=P==null?void 0:P.querySelector(".grid-search-input");C&&this.selectProduct(C,b)}),l.appendChild(v)}if(e===this._matchSuggestionsRunId&&s){const l=document.querySelectorAll(".grid-seima-match-btn").length;s.innerHTML=`
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="flex-shrink:0">
    ...
    `,document.body.appendChild(s),document.body.appendChild(i);const n=()=>this.closeValidatorModal(o);i.querySelector(".gvm-close").addEventListener("click",n),s.addEventListener("click",n);const r=a=>{a.key==="Escape"&&n()};document.addEventListener("keydown",r),this._validatorModal={overlay:s,modal:i,escHandler:r,competitor:e,productCode:t};try{await _._ensureIndex();const a=await _.getMatches(e),l=(await _.getProducts(e)).find(p=>String(p.product_code)===String(t));if(!l){i.querySelector(".gvm-body").innerHTML=`<div class="gvm-no-matches">Product ${x.sanitizeInput(t)} not found in ${x.sanitizeInput(e)} data.</div>`;return}const d=a.filter(p=>String(p.CompetitorSKU)===String(t)).sort((p,y)=>(p.Rank||99)-(y.Rank||99)),u={Verified:0,Manual:1,Rejected:2,"AI-Suggested":3},m=new Map;for(const p of d){const y=String(p.SeimaSKU),f=m.get(y);(!f||(u[p.Status]??9)<(u[f.Status]??9))&&m.set(y,p)}const h=[...m.values()].sort((p,y)=>(p.Rank||99)-(y.Rank||99));this._renderValidatorModal(l,h,e)}catch(a){console.error("Validator modal load failed:",a),i.querySelector(".gvm-body").innerHTML='<div class="gvm-no-matches">Failed to load data. Check console.</div>'}}_renderValidatorModal(e,t,o){var u;const s=(u=this._validatorModal)==null?void 0:u.modal;if(!s)return;const i=e.product_name||e.product_code,n=e.image_url||e.Image||"",r=m=>x.escapeHtml(m||"");s.querySelector(".gvm-title").textContent=`${i} — ${o}`;let a;t.length===0?a='<div class="gvm-no-matches">No Seima matches found. Use the search below to add one.</div>':a=t.map(m=>{const h=String(m.SeimaSKU||"").trim(),p=T.findProductByCode(h),y=(p==null?void 0:p.Description)||(p==null?void 0:p.ProductName)||h,f=(p==null?void 0:p.Image_URL)||(p==null?void 0:p.imageUrl)||"",b=(p==null?void 0:p.RRP_INCGST)||(p==null?void 0:p["RRP INC GST"])||"",w=b?`$${Number(b).toLocaleString("en-AU",{minimumFractionDigits:2})}`:"",v=Number(m.Confidence)||0,S=v>=70?"high":v>=40?"med":"low",k=(m.Status||"").toLowerCase().replace(/[\s-]+/g,"-");let P;return m.Status==="Verified"||m.Status==="Manual"?P=`<span class="gvm-status-label gvm-status-verified">✓ Verified</span>
    ...
    `;this.injectSaveDialogStyles(),document.body.insertAdjacentHTML("beforeend",i);const n=document.getElementById("save-dialog"),r=document.getElementById("save-doc-name"),a=document.getElementById("save-notes");r==null||r.focus(),r==null||r.select(),n.querySelectorAll("button[data-action]").forEach(l=>{l.addEventListener("click",async()=>{const d=l.dataset.action;if(d==="cancel"){n.remove();return}const u=(r==null?void 0:r.value.trim())||"Untitled Selection",m=(a==null?void 0:a.value.trim())||"";this.currentSelectionName=u;const h={...this.prepareSelectionData(),documentName:u,notes:m};n.querySelectorAll("button").forEach(p=>p.disabled=!0),l.textContent="Saving...";try{let p;d==="save-update"?p=await fe.updateSelection(this.currentSelectionId,h):(p=await fe.saveSelection(h),p.success&&p.id&&(this.currentSelectionId=p.id)),n.remove(),p.success?(this.hasUnsavedChanges=!1,this.lastSaveTime=new Date,this.updateContextHeader(),he.success(d==="save-update"?"Selection updated!":"Selection saved!")):he.error("Failed to save: "+(p.error||"Unknown error"))}catch(p){n.remove(),he.error("Failed to save: "+p.message)}})}),n.addEventListener("click",l=>{l.target===n&&n.remove()});const c=l=>{l.key==="Escape"&&(n.remove(),document.removeEventListener("keydown",c))};document.addEventListener("keydown",c)}injectSaveDialogStyles(){if(document.getElementById("save-dialog-styles"))return;document.head.insertAdjacentHTML("beforeend",`
      <style id="save-dialog-styles">
        .save-dialog-overlay {
          position: fixed;
          top: 0;
...
`).filter(d=>d.trim());if(s.length<2)return o;const i=d=>d.split("|").slice(1,-1).map(u=>u.trim()),n=d=>/^\|[\s:|-]+\|$/.test(d.trim());let r=i(s[0]),a=1;s.length>1&&n(s[1])&&(a=2);let c="<thead><tr>"+r.map(d=>`<th>${d}</th>`).join("")+"</tr></thead>",l="<tbody>"+s.slice(a).filter(d=>!n(d)).map(d=>"<tr>"+i(d).map(u=>`<td>${u}</td>`).join("")+"</tr>").join("")+"</tbody>";return`<table class="ai-comparison-table">${c}${l}</table>`}),t=t.replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>"),t=t.replace(/`([^`]+)`/g,"<code>$1</code>"),t=t.replace(/^### (.+)$/gm,"<h4>$1</h4>"),t=t.replace(/^## (.+)$/gm,"<h3>$1</h3>"),t=t.replace(/^- (.+)$/gm,"<li>$1</li>"),t=t.replace(/(<li>.*<\/li>\n?)+/g,o=>`<ul>${o}</ul>`),t=t.replace(/^\d+\. (.+)$/gm,"<li>$1</li>"),t=t.replace(/\n\n/g,"</p><p>"),t=`<p>${t}</p>`,t=t.replace(/<p><\/p>/g,""),t=t.replace(/<p>(<h[34]>)/g,"$1"),t=t.replace(/(<\/h[34]>)<\/p>/g,"$1"),t=t.replace(/<p>(<ul>)/g,"$1"),t=t.replace(/(<\/ul>)<\/p>/g,"$1"),t=t.replace(/<p>(<table)/g,"$1"),t=t.replace(/(<\/table>)<\/p>/g,"$1"),t=t.replace(/\b(\d{6})\b/g,'<button class="ai-add-product-btn" data-code="$1" title="Add $1 to selection">$1 <span class="ai-add-icon">+</span></button>'),t}_getBasePath(){var e;return(((e=document.querySelector("base"))==null?void 0:e.href)||window.location.origin+"/").replace(/\/$/,"")}_getProductImage(e){return e.Image_URL||e.imageUrl||e.Image||`${this._getBasePath()}/assets/no-image.png`}_getProductName(e){return e.Description||e.ProductName||e["Product Name"]||""}_getProductMeta(e){const t=e.Finish||e.Colour||"",o=e.DimX||e["X Dimension (mm)"]||"",s=e.DimY||e["Y Dimension (mm)"]||"",i=e.DimZ||e["Z Dimension (mm)"]||"",n=o&&o!=="0"?`${o} × ${s||0} × ${i||0}mm`:"";return[t,n].filter(Boolean).join("  ·  ")}_getProductPrice(e){const t=e["RRP INC GST"]||e.RRP_INCGST||e["RRP EX GST"]||e.RRP_EXGST||"";return t?`$${parseFloat(t).toLocaleString("en-AU",{minimumFractionDigits:2})}`:""}_enrichTableProducts(e){const t=this._getBasePath(),o=oe.lastCompetitorProducts;e.querySelectorAll(".ai-comparison-table").forEach(s=>{const i=s.querySelector("thead"),n=s.querySelector("tbody");if(!i||!n)return;const a=i.querySelectorAll("th").length;if(a<2)return;const c=new Array(a).fill(null);if(n.querySelectorAll("tr").forEach(d=>{d.querySelectorAll("td").forEach((m,h)=>{if(c[h])return;const p=m.querySelector("strong"),y=(p?p.textContent:m.textContent).trim();if(y){if(/^\d{6}$/.test(y)){const f=T.findProductByCode(y);f&&(c[h]={src:this._getProductImage(f),click:()=>this._showProductModal(y)})}else if(o)for(const[f,b]of o){const w=String(f);if(w===y||y.includes(w)||w.includes(y)){c[h]={src:b.imageUrl||"",click:()=>this._showCompetitorModal(b.brand,f)};break}}}})}),!c.some(Boolean))return;const l=document.createElement("tr");l.className="ai-table-image-row";for(let d=0;d<a;d++){const u=document.createElement("td"),m=c[d];if(m&&m.src){const h=document.createElement("img");h.className="ai-table-product-img",h.src=m.src,h.alt="",h.onerror=()=>{h.src=`${t}/assets/no-image.png`},u.appendChild(h),m.click&&(u.style.cursor="pointer",u.addEventListener("click",m.click))}l.appendChild(u)}n.insertBefore(l,n.firstChild)})}_injectProductCards(e){e.querySelectorAll("table .ai-add-product-btn").forEach(s=>{const i=document.createElement("strong");i.textContent=s.dataset.code,s.replaceWith(i)});const t=e.querySelectorAll(".ai-add-product-btn");if(!t.length)return;const o=this._getBasePath();t.forEach(s=>{const i=s.dataset.code,n=T.findProductByCode(i);if(!n)return;const r=s.closest("li");if(!(r||s.parentElement))return;const c=this._getProductImage(n),l=this._getProductName(n),d=this._getProductMeta(n),u=this._getProductPrice(n),m=document.createElement("div");if(m.className="ai-product-card",m.dataset.code=i,m.innerHTML=`
    ...
    `,s.querySelectorAll(".ai-feedback-btn").forEach(a=>{a.addEventListener("click",()=>{const c=a.dataset.rating;s.querySelectorAll(".ai-feedback-btn").forEach(l=>l.classList.remove("active")),a.classList.add("active"),this._saveFeedback(t,o,c)})});const r=e.querySelector(".ai-msg-bubble");r?e.insertBefore(s,r.nextSibling):e.appendChild(s)}async _saveFeedback(e,t,o){try{const s=await this._loadFeedback(),i=s.findIndex(a=>a.id===e),n={id:e,question:this._lastUserMessage||"",answer:(t||"").slice(0,500),rating:o,timestamp:Date.now(),synced:!1};i>=0?s[i]={...s[i],...n}:s.push(n);const{set:r}=await H(async()=>{const{set:a}=await import("./vendor-idb-DwnyWBFG.js");return{set:a}},[]);await r(ke,s)}catch{}}_getFeedbackEntry(e){return this._loadFeedback().then(t=>t.find(o=>o.id===e)||null)}async _loadFeedback(){try{const{get:e}=await H(async()=>{const{get:o}=await import("./vendor-idb-DwnyWBFG.js");return{get:o}},[]),t=await e(ke);return Array.isArray(t)?t:[]}catch{return[]}}_escapeHtml(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}_scrollToBottom(){requestAnimationFrame(()=>{this.messagesContainer.scrollTop=this.messagesContainer.scrollHeight})}_enrichResponseBubble(e){this._injectProductCards(e),R.isPowerUser()&&(this._enrichTableProducts(e),this._injectCompetitorCards(e)),this._cleanupCardOrphans(e),this._collapseProductCards(e),this._attachProductButtons(e)}_persistMessages(){clearTimeout(this._persistTimer),this._persistTimer=setTimeout(()=>this._doPersistMessages(),500)}async _doPersistMessages(){try{const e=[];this.messagesContainer.querySelectorAll(".ai-msg").forEach(o=>{var s,i;o.classList.contains("ai-msg-user")?e.push({role:"user",content:((s=o.querySelector(".ai-msg-bubble"))==null?void 0:s.textContent)||""}):o.classList.contains("ai-msg-assistant")&&!o.querySelector(".ai-msg-thinking")&&e.push({role:"assistant",content:((i=o.querySelector(".ai-msg-bubble"))==null?void 0:i.dataset.rawContent)||"",feedbackId:o.dataset.feedbackId||null})});const{set:t}=await H(async()=>{const{set:o}=await import("./vendor-idb-DwnyWBFG.js");return{set:o}},[]);await t(Ne,e)}catch{}}async _restoreMessages(){try{localStorage.removeItem(Ne);const{get:e}=await H(async()=>{const{get:i}=await import("./vendor-idb-DwnyWBFG.js");return{get:i}},[]),t=await e(Ne);if(!Array.isArray(t)||t.length===0)return;const o=this.messagesContainer.querySelector(".ai-chat-welcome");o&&o.remove();for(const i of t)i.role==="user"&&(this._lastUserMessage=i.content),this._addMessage(i.role,i.content,{skipPersist:!0,feedbackId:i.feedbackId||null});const s=document.createElement("div");s.className="ai-chat-restored",s.textContent="Previous conversation restored",this.messagesContainer.prepend(s)}catch{}}_generateId(){return Date.now().toString(36)+Math.random().toString(36).substr(2)}async _trackQuestion(e){try{const{get:t,set:o}=await H(async()=>{const{get:n,set:r}=await import("./vendor-idb-DwnyWBFG.js");return{get:n,set:r}},[]),s=await t(Ee)||{},i=e.trim();if(i.length<5)return;s[i]=(s[i]||0)+1,await o(Ee,s)}catch{}}async _syncFeedback(){try{const{get:e,set:t,del:o}=await H(async()=>{const{get:a,set:c,del:l}=await import("./vendor-idb-DwnyWBFG.js");return{get:a,set:c,del:l}},[]),s=await this._loadFeedback(),i=s.filter(a=>!a.synced),n=await e(Ee)||null;if(i.length===0&&!n)return;if((await fetch(`${V.PROXY_URL}/v1/feedback`,{method:"POST",headers:{"Content-Type":"application/json",...R.getAuthHeaders()},body:JSON.stringify({entries:i,questionLog:n})})).ok){for(const a of i)a.synced=!0;this._pruneFeedback(s),await t(ke,s),await o(Ee)}}catch{}}_pruneFeedback(e){const t=Date.now()-6048e5;for(let o=e.length-1;o>=0;o--)e[o].synced&&e[o].timestamp<t&&e.splice(o,1)}async _clearChat(){await oe.clearHistory();try{const{del:e}=await H(async()=>{const{del:t}=await import("./vendor-idb-DwnyWBFG.js");return{del:t}},[]);await e(ke),await e(Ee)}catch{}localStorage.removeItem(ke),localStorage.removeItem(Ee),this._showWelcome()}async _initUserEmail(){try{const e=R.getCurrentUser();this._userEmail=(e==null?void 0:e.email)||null}catch{}}async _saveConversation(){var s;if(!this._userEmail)return;const e=[];if(this.messagesContainer.querySelectorAll(".ai-msg").forEach(i=>{var n,r;i.classList.contains("ai-msg-user")?e.push({role:"user",content:((n=i.querySelector(".ai-msg-bubble"))==null?void 0:n.textContent)||""}):i.classList.contains("ai-msg-assistant")&&!i.querySelector(".ai-msg-thinking")&&e.push({role:"assistant",content:((r=i.querySelector(".ai-msg-bubble"))==null?void 0:r.dataset.rawContent)||""})}),e.length<2)return;this._conversationId||(this._conversationId=Date.now().toString(36)+Math.random().toString(36).slice(2,8));const t=((s=e.find(i=>i.role==="user"))==null?void 0:s.content)||"Untitled",o=t.length>50?t.slice(0,47)+"...":t;try{await fetch(`${V.PROXY_URL}/v1/conversations/${this._conversationId}`,{method:"PUT",headers:{"Content-Type":"application/json",...R.getAuthHeaders()},body:JSON.stringify({email:this._userEmail,title:o,messages:e})})}catch{}}_startNewConversation(){this._saveConversation(),this._conversationId=null,this._clearChat()}_toggleHistory(e){const t=this.panel.querySelector("#ai-chat-history-panel");this._historyOpen=e!==void 0?e:!this._historyOpen,t.classList.toggle("open",this._historyOpen),this._historyOpen&&this._loadConversationList()}async _loadConversationList(){if(!this._userEmail){this.panel.querySelector("#ai-chat-history-list").innerHTML='<div class="ai-chat-history-empty">Sign in to see conversation history.</div>';return}const e=this.panel.querySelector("#ai-chat-history-list");e.innerHTML='<div class="ai-chat-history-empty">Loading...</div>';try{const t=`${V.PROXY_URL}/v1/conversations?email=${encodeURIComponent(this._userEmail)}`,o=await fetch(t,{headers:R.getAuthHeaders()});if(!o.ok)throw new Error("Failed");const i=(await o.json()).conversations||[];if(i.length===0){e.innerHTML='<div class="ai-chat-history-empty">No previous conversations.</div>';return}e.innerHTML=i.map(n=>`
      ...
      `).join(""),e.querySelectorAll(".ai-chat-history-item").forEach(n=>{n.addEventListener("click",()=>this._loadConversation(n.dataset.id))})}catch{e.innerHTML='<div class="ai-chat-history-empty">Failed to load conversations.</div>'}}async _loadConversation(e){try{const t=`${V.PROXY_URL}/v1/conversations/${e}`,o=await fetch(t,{headers:R.getAuthHeaders()});if(!o.ok)throw new Error("Failed");const s=await o.json();this._conversationId=e,oe.clearHistory(),this.messagesContainer.innerHTML="";const i=this.messagesContainer.querySelector(".ai-chat-welcome");i&&i.remove();for(const r of s.messages||[])r.role==="user"&&(this._lastUserMessage=r.content),this._addMessage(r.role,r.content,{skipPersist:!0}),(r.role==="user"||r.role==="assistant")&&oe.conversationHistory.push(r);this._persistMessages(),this._toggleHistory(!1);const n=document.createElement("div");n.className="ai-chat-restored",n.textContent="Conversation restored",this.messagesContainer.prepend(n)}catch{console.error("Failed to load conversation")}}_formatHistoryTime(e){if(!e)return"";const t=new Date(e),s=new Date-t,i=Math.floor(s/864e5);return i===0?"Today":i===1?"Yesterday":i<7?`${i}d ago`:t.toLocaleDateString("en-AU",{day:"numeric",month:"short"})}open(){this.panel.style.right="",this.panel.classList.add("open"),this.isOpen=!0,setTimeout(()=>this.input.focus(),300),this._syncFeedback()}close(){const e=this.panel.offsetWidth||620;this.panel.style.right=-(e+20)+"px",this.panel.classList.remove("open"),this.isOpen=!1}toggle(){this.isOpen?this.close():this.open()}}const ht=new To;class Do{constructor(){this.navigationManager=null,this.fileImportManager=new bo,this.productGridManager=new Io,this.isInitialized=!1,K.log("SeimaScanner application starting",Z.INFO)}async init(){var e,t,o;try{K.log("Initializing application modules",Z.INFO),R.configure({googleSheetsUrl:(e=U.PRESENTATION_RECORDING)==null?void 0:e.GOOGLE_SHEETS_URL,email:U.EMAIL}),Q.configure({logoSrc:"assets/seima-logo.png",brandName:"Seima",appName:"Product Presenter"});const s=(t=U.PRESENTATION_RECORDING)==null?void 0:t.GOOGLE_SHEETS_URL;if(s&&zt(s).catch(r=>{console.warn("Synonyms preload failed:",(r==null?void 0:r.message)||r)}),(o=U.CROSSHAIR)!=null&&o.ENABLED){const r=R.getCurrentUser();_.configure(U.CROSSHAIR,(r==null?void 0:r.email)||""),_.preload().catch(a=>{console.warn("Crosshair preload failed (user may not be logged in):",a.message)})}this.navigationManager=new Jt;const i=xe.getCompatibilityReport();K.log(`Browser compatibility: ${i.score}% (${i.browserName})`,Z.INFO),xe.shouldShowCompatibilityWarning()&&this.showCompatibilityWarning(),await this.navigationManager.init(),this.fileImportManager.init(),this.setupGlobalEventListeners(),this.productGridManager.init(),ht.init();const n=document.getElementById("ai-chat-trigger");return n&&n.addEventListener("click",()=>ht.toggle()),window.navigationManager=this.navigationManager,window.productGridManager=this.productGridManager,window.browserCompatibility=xe,window.downloadWithFallback=Qe,window.showPdfFormScreen=Ke,this.isInitialized=!0,K.log("Seima Scanner initialized successfully",Z.INFO),this._dismissLoadingOverlay(),setTimeout(()=>{xt.show()},500),!0}catch(s){return K.handleError({message:"Failed to initialize application",error:s,category:_e.UI,level:Z.CRITICAL,context:"app-init"}),this._dismissLoadingOverlay(),!1}}_dismissLoadingOverlay(){const e=document.getElementById("app-loading-overlay");e&&(e.classList.add("fade-out"),e.addEventListener("transitionend",()=>e.remove(),{once:!0}),setTimeout(()=>e.remove(),400))}showCompatibilityWarning(){const e=xe.getCompatibilityReport(),t=e.recommendations;if(t.length===0)return;const o=t.filter(n=>n.type==="critical"),s=e.score<M.get("compatibility.minCompatibilityScore",70);if(o.length===0&&!s)return;const i=document.createElement("div");i.style.cssText=`
    ...
    `,document.body.insertBefore(i,document.body.firstChild)}setupGlobalEventListeners(){window.addEventListener("generatePdf",e=>{const{tipTailSettings:t,...o}=e.detail;Qt(),Ke(o,t||null)}),window.addEventListener("beforeunload",()=>{}),xe.features.memoryAPI&&setInterval(()=>{const e=xe.memoryInfo;e.memoryPressure==="high"&&console.warn("High memory usage detected:",e)},6e4)}getSelectedProducts(){return E.getSelectedProducts()}clearSelection(){return E.clearAllSelections()}addProduct(e,{notes:t="",room:o="",quantity:s=1}={}){return E.addProductToSelection(e,{notes:t,room:o,quantity:s})}updateSelectionCount(){this.navigationManager&&this.navigationManager.updateSelectionCount()}showError(e){alert(e)}}document.addEventListener("DOMContentLoaded",()=>{window.seimaScanner=new Do,window.seimaScanner.init(),window._appVersion=U.VERSION;const g=document.getElementById("menu-version-footer");g&&(g.textContent=`Ver: ${U.VERSION}`),$o(),Bo();const e=document.getElementById("changelog-close");e&&e.addEventListener("click",()=>{document.getElementById("changelog-modal").style.display="none"})});function $o(){const g=document.getElementById("help-btn");g&&g.addEventListener("click",()=>{Ao()});const e=document.getElementById("crosshair-btn");e&&e.addEventListener("click",()=>{window.location.href="screens/validator.html"});const t=document.getElementById("landscape-btn");t&&t.addEventListener("click",()=>{window.location.href="screens/landscape.html"});const o=document.getElementById("admin-btn");o&&o.addEventListener("click",()=>{window.location.href="screens/admin.html"});const s=document.getElementById("quick-start-btn");s&&s.addEventListener("click",()=>{xt.showForced()})}function Bo(){const g=document.getElementById("user-menu-container"),e=document.getElementById("user-menu-trigger"),t=document.getElementById("user-menu-dropdown"),o=document.getElementById("sign-in-btn"),s=document.getElementById("user-avatar"),i=document.getElementById("user-name-display");function n(c){var l,d,u,m,h,p,y,f,b,w;if(c){(l=U.CROSSHAIR)!=null&&l.ENABLED&&(_.configure(U.CROSSHAIR,c.email||""),_.preload().catch(X=>{console.warn("Crosshair preload after login failed:",X)})),g&&(g.style.display="block"),o&&(o.style.display="none");const v=document.getElementById("crosshair-btn");v&&(v.style.display=(d=U.CROSSHAIR)!=null&&d.ENABLED&&R.isStaffMode()?"":"none");const S=document.getElementById("landscape-btn");S&&(S.style.display=(u=U.CROSSHAIR)!=null&&u.ENABLED&&R.isAdmin()?"":"none");const k=document.getElementById("admin-btn");k&&(k.style.display=R.isAdmin()?"":"none");const P=document.getElementById("staff-divider"),C=(v==null?void 0:v.style.display)!=="none"||(S==null?void 0:S.style.display)!=="none"||(k==null?void 0:k.style.display)!=="none";P&&(P.style.display=C?"":"none");const D=R.isPowerUser();document.querySelectorAll("#import-file-btn, #entry-import").forEach(X=>{X&&(X.style.display=D?"":"none")});const F=r(c.name);s&&(s.textContent=F),i&&(i.textContent=((m=c.name)==null?void 0:m.split(" ")[0])||"User");const O=(c.email||"").toLowerCase().endsWith("@seima.com.au")&&c.emailVerified===!1;let L=document.getElementById("verify-email-banner");if(O?(L||(L=document.createElement("div"),L.id="verify-email-banner",L.className="verify-email-banner",L.innerHTML=`
            <span>Verify your email to access staff features.</span>
            <button id="verify-email-btn" class="verify-email-btn">Verify now</button>
          `,document.body.insertBefore(L,document.body.firstChild),L.querySelector("#verify-email-btn").addEventListener("click",()=>{Q.showVerifyEmail(c.email,()=>{n(R.getCurrentUser()),L==null||L.remove()})})),L.style.display=""):L&&(L.style.display="none"),t){const X=O?`
            ...
            </button>`:"",J=window._appVersion?`Ver: ${window._appVersion}`:"Loading...";t.innerHTML=`
          ...
          <div class="user-menu-footer" id="menu-version-footer" title="Click to view what's new">${J}</div>
        `,(h=document.getElementById("menu-verify-email"))==null||h.addEventListener("click",()=>{t.style.display="none",Q.showVerifyEmail(c.email,()=>{var z;n(R.getCurrentUser()),(z=document.getElementById("verify-email-banner"))==null||z.remove()})}),(p=document.getElementById("menu-refresh"))==null||p.addEventListener("click",async()=>{t.style.display="none";try{const{del:z,keys:et}=await H(async()=>{const{del:se,keys:Re}=await import("./vendor-idb-DwnyWBFG.js");return{del:se,keys:Re}},[]),tt=await et(),Me=["productCatalogCsv","customerLogo","fredChatHistory","fredChatMessages","fredFeedback","fredQuestionLog"];await Promise.all(tt.filter(se=>typeof se=="string"&&(Me.includes(se)||se.startsWith("crosshair_"))).map(se=>z(se)))}catch{}localStorage.removeItem("configPreferences"),localStorage.removeItem("pdfWizardSettings"),Object.keys(localStorage).filter(z=>z.startsWith("crosshair_")||z.startsWith("fred")).forEach(z=>localStorage.removeItem(z)),window.location.reload()}),(y=document.getElementById("menu-version-footer"))==null||y.addEventListener("click",()=>{t.style.display="none",No()}),(f=document.getElementById("menu-profile"))==null||f.addEventListener("click",()=>{t.style.display="none",Q.showEditProfile(z=>{E.clearUserSettings(),n(z)})}),(b=document.getElementById("menu-password"))==null||b.addEventListener("click",()=>{t.style.display="none",Q.showChangePassword()}),(w=document.getElementById("menu-logout"))==null||w.addEventListener("click",()=>{var z;t.style.display="none",E.clearUserSettings(),_.clearAllCaches(),(z=window.productGridManager)!=null&&z.searchCache&&window.productGridManager.searchCache.clear(),R.logout(),n(null)})}}else{g&&(g.style.display="none"),o&&(o.style.display="block"),document.querySelectorAll("#import-file-btn, #entry-import").forEach(C=>{C&&(C.style.display="none")});const v=document.getElementById("crosshair-btn");v&&(v.style.display="none");const S=document.getElementById("landscape-btn");S&&(S.style.display="none");const k=document.getElementById("admin-btn");k&&(k.style.display="none");const P=document.getElementById("staff-divider");P&&(P.style.display="none")}}function r(c){if(!c)return"?";const l=c.trim().split(" ");return l.length>=2?(l[0][0]+l[l.length-1][0]).toUpperCase():c.substring(0,2).toUpperCase()}function a(c){const l=document.createElement("div");return l.textContent=c||"",l.innerHTML}e&&t&&(e.addEventListener("click",c=>{c.stopPropagation();const l=t.style.display!=="none";t.style.display=l?"none":"block"}),document.addEventListener("click",c=>{g!=null&&g.contains(c.target)||(t.style.display="none")})),o&&o.addEventListener("click",()=>{Q.showLogin(c=>{n(c)})}),R.onAuthChange=n,n(R.getCurrentUser())}function Ao(){const g=document.getElementById("user-guide-modal"),e=document.getElementById("user-guide-content");if(!g||!e)return;e.innerHTML=Fo(),g.style.display="flex";const t=document.getElementById("user-guide-close");t&&(t.onclick=()=>{g.style.display="none"}),g.onclick=s=>{s.target===g&&(g.style.display="none")};const o=s=>{s.key==="Escape"&&(g.style.display="none",document.removeEventListener("keydown",o))};document.addEventListener("keydown",o)}function Fo(){return`
