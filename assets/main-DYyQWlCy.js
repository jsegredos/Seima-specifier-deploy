import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css                      */import{U as S,a as J,b as X,c as be}from"./auth-ui-CY54VKXI.js";import{g as lt,l as Et}from"./product-synonyms-iJFplttQ.js";import{C as M}from"./config-DMvT82bZ.js";import{g as et,p as ut,d as Ct,P as tt,c as Pt,h as It,a as Rt,b as kt,e as Lt,f as Dt,i as Tt,j as Bt,k as At,l as $t}from"./pdf-layouts-8nByhigc.js";import{c as k}from"./competitor-service-DxbWbt1L.js";const C={DEBUG:"debug",INFO:"info",WARN:"warn",ERROR:"error",CRITICAL:"critical"},$={NETWORK:"network",DATA:"data",UI:"ui",PDF:"pdf",STORAGE:"storage",COMPATIBILITY:"compatibility",IMPORT:"import",VALIDATION:"validation"};class Nt{constructor(){this.logs=[],this.maxLogs=1e3,this.enableConsoleLogging=!0,this.enableUserNotifications=!0,this.errorStats=new Map,this.setupGlobalErrorHandlers()}setupGlobalErrorHandlers(){window.addEventListener("error",e=>{var t;e.message&&e.message.includes("ResizeObserver")||this.handleError({message:e.message,filename:e.filename,lineNumber:e.lineno,columnNumber:e.colno,error:e.error,category:$.UI,context:"global",showUser:!((t=e.message)!=null&&t.includes("ResizeObserver"))})}),window.addEventListener("unhandledrejection",e=>{String(e.reason||"").includes("ResizeObserver")||this.handleError({message:`Unhandled promise rejection: ${e.reason}`,error:e.reason,category:$.DATA,context:"promise"})})}handleError(e){const{message:t,error:o,category:s=$.UI,context:n="unknown",level:i=C.ERROR,showUser:r=!0}=e,a={id:this.generateErrorId(),timestamp:new Date().toISOString(),message:t,category:s,context:n,level:i,stack:(o==null?void 0:o.stack)||new Error().stack,userAgent:navigator.userAgent,url:window.location.href,additionalInfo:this.gatherAdditionalInfo(o)};return this.log(a),this.updateErrorStats(s),r&&this.enableUserNotifications&&i!==C.DEBUG&&this.showUserNotification(a),i===C.CRITICAL&&this.attemptRecovery(a),a.id}log(e,t=C.INFO){const o=typeof e=="string"?{message:e,level:t,timestamp:new Date().toISOString()}:e;this.logs.push(o),this.logs.length>this.maxLogs&&this.logs.shift(),this.enableConsoleLogging&&this.consoleLog(o),(t===C.ERROR||t===C.CRITICAL)&&this.persistCriticalLog(o)}consoleLog(e){const{level:t,message:o,category:s,context:n}=e,i=`[${t.toUpperCase()}]${s?` [${s}]`:""}${n?` [${n}]`:""}`;switch(t){case C.DEBUG:console.debug(i,o,e);break;case C.INFO:console.info(i,o);break;case C.WARN:console.warn(i,o,e);break;case C.ERROR:case C.CRITICAL:console.error(i,o,e);break;default:console.log(i,o)}}showUserNotification(e){const{message:t,category:o,level:s}=e,n=this.generateUserFriendlyMessage(t,o);s!==C.CRITICAL?this.showToast(n,s):this.showErrorModal(n,e)}showToast(e,t){const o=document.createElement("div");o.className=`error-toast error-toast--${t}`,o.style.cssText=`
      position: fixed;
      top: 20px;
      right: 20px;
      z-index: 10000;
      ...
      background: ${t===C.ERROR?"#fee":t===C.WARN?"#fef3c7":"#e0f2fe"};
      border-left: 4px solid ${t===C.ERROR?"#dc2626":t===C.WARN?"#f59e0b":"#0ea5e9"};
      color: ${t===C.ERROR?"#7f1d1d":t===C.WARN?"#92400e":"#0c4a6e"};
    `,o.innerHTML=`
      <div style="display: flex; align-items: flex-start; gap: 8px;">
        <span style="font-size: 16px;">${t===C.ERROR?"❌":t===C.WARN?"⚠️":"ℹ️"}</span>
    ...
    `,document.body.appendChild(o),setTimeout(()=>o.style.transform="translateX(0)",100);const s=t===C.ERROR?8e3:5e3;setTimeout(()=>{o.parentElement&&(o.style.transform="translateX(100%)",setTimeout(()=>o.remove(),300))},s)}showErrorModal(e,t){const o=document.createElement("div");o.style.cssText=`
...
`).filter(r=>r.trim()!==""),n=s.length>0?s[s.length-1]:"Unknown",i=n.split(" - ")[0]||n;o.innerText=i,o.innerText.trim()||(o.innerText="v2.1.0")}}else throw new Error("Version file not found")}catch{const t=document.getElementById("version-number");if(t){const o=R.get("app.version")||"v2.1.0";t.innerText=o}else setTimeout(()=>{const o=document.getElementById("version-number");if(o&&!o.innerText.trim()){const s=R.get("app.version")||"v2.1.0";o.innerText=s}},1e3);console.info("Version loaded from config (GitHub Pages mode)")}}async showProductLookupScreen(){try{const t=await(await fetch("./screens/product-grid.html")).text();document.body.innerHTML=t,this.currentScreen="product-grid";const o=document.createElement("script");o.type="module",o.src="js/app.js",document.body.appendChild(o),setTimeout(()=>{document.querySelectorAll(".back-btn").forEach(s=>s.remove())},100),window.productGridManager&&window.productGridManager.init(),await this.loadVersion(),setTimeout(()=>this.loadVersion(),1e3)}catch(e){console.error("Failed to load product grid screen:",e)}}setupSplitInterface(){const e=document.getElementById("back-to-home");e&&(e.onclick=()=>location.reload());const t=document.getElementById("download-btn"),o=document.getElementById("clear-all-btn");t&&(t.onclick=()=>this.showDownloadFormModal()),o&&(o.onclick=()=>this.showClearConfirmModal()),this.setupSplitProductSearch(),this.setupReviewTable(),this.renderReviewTable(),this.loadInitialSearchResults()}setupSplitProductSearch(){const e=document.getElementById("product-search-input"),t=document.getElementById("search-results-list"),o=document.getElementById("search-loading"),s=document.getElementById("search-no-results");if(!e||!t)return;const n=[],i=S.debounce(r=>{this.performSplitProductSearch(r,t,n,o,s)},200);e.addEventListener("input",()=>{const r=e.value.trim();r?i(r):this.loadInitialSearchResults()}),t.addEventListener("click",r=>{const a=r.target.closest(".result-item");if(!a)return;const c=parseInt(a.getAttribute("data-idx"),10),d=n.length>0?n:this.currentSearchResults||[];!isNaN(c)&&d[c]&&this.showSplitProductDetails(d[c])})}performSplitProductSearch(e,t,o,s,n){if(!B.isLoaded){s.style.display="flex",n.style.display="none",t.innerHTML="";return}o.length=0,o.push(...B.searchProducts(e)),s.style.display="none",o.length===0?(n.style.display="flex",t.innerHTML=""):(n.style.display="none",t.innerHTML=o.map((i,r)=>`
        ...
        `).join(""))}async loadInitialSearchResults(){const e=document.getElementById("search-results-list"),t=document.getElementById("search-loading"),o=document.getElementById("search-no-results");if(!e)return;if(!B.isLoaded){t.style.display="flex",o.style.display="none",e.innerHTML="",setTimeout(()=>this.loadInitialSearchResults(),500);return}const s=B.getAllProducts().slice(0,50);t.style.display="none",o.style.display="none",e.innerHTML=s.map((n,i)=>`
    ...
    `,document.body.appendChild(o),Oe("./assets/seima-logo.png",(n,i,r)=>{const a=JSON.parse(localStorage.getItem("selection")||"[]"),c=JSON.parse(localStorage.getItem(M.STORAGE_KEYS.SELECTED_PRODUCTS)||"[]");let d=[];c.length>0?d=c.map(h=>({...h.product,Room:h.room,Notes:h.notes,Quantity:h.quantity,Timestamp:new Date(h.timestamp).toISOString()})):d=a;const l=document.getElementById("sort-by"),u=l?l.value:"room";switch(u){case"code":d.sort((h,w)=>{const E=h.OrderCode||h.Code||"",P=w.OrderCode||w.Code||"";return E.localeCompare(P)});break;case"product":d.sort((h,w)=>{const E=h.Description||h.ProductName||"",P=w.Description||w.ProductName||"";return E.localeCompare(P)});break;case"room":default:d.sort((h,w)=>{const E=h.Room||"Blank",P=w.Room||"Blank";return E.localeCompare(P)});break}if(!d.length){alert("No products selected."),t&&(t.style.display="none");return}if(et()>0)console.log(`📷 Using ${et()} pre-cached images (skipping duplicate preload)`);else{const h=document.getElementById("pdf-processing-notification");if(h){const w=document.createElement("span");w.id="preload-progress",w.style.cssText="display: block; font-size: 12px; margin-top: 8px; color: #1e40af;",w.textContent="Loading images: 0%",h.appendChild(w)}console.log("📷 Starting image preload for",d.length,"products"),ut(d).then(w=>{const E=document.getElementById("preload-progress");E&&(E.textContent=`✓ ${w} images ready`,E.style.color="#059669")}).catch(w=>{console.warn("Image preloading error:",w)})}const g={};u==="room"?d.forEach(h=>{const w=h.Room||"Blank";g[w]||(g[w]=[]),g[w].push(h)}):g.__all__=d;const{jsPDF:y}=window.jspdf,v=new y({orientation:"landscape",unit:"pt",format:"a4",compress:!0,putOnlyUsedFonts:!0,precision:16,userUnit:1,floatPrecision:16}),f=v.internal.pageSize.getWidth(),x=v.internal.pageSize.getHeight();Oe("./assets/seima-logo.png",(h,w,E)=>{const P=J.getCurrentUser(),U=b.getUserSettings(),z=P?{name:P.name,email:P.email,phone:P.phone,position:P.position}:U,N=localStorage.getItem("customerLogo");Ct(v,{pageWidth:f,pageHeight:x,seimaLogoDataUrl:h,seimaLogoNaturalW:w,seimaLogoNaturalH:E,customerLogoDataUrl:N,userDetails:p,staffContact:z,footerHeight:tt.footerHeight}),v.addPage(),Oe("./assets/seima-logo-white.png",(se,ue,pe)=>{const vt=p.showRrp&&!p.excludePrice,Je=!p.excludePrice,Xe=!p.excludeQty,wt=Pt(f,{leftMargin:32,rightMargin:32,showRrp:vt,showPrice:Je,showQty:Xe,showTotal:Je&&Xe}),{colX:me,colW:Se,headers:Ae}=wt,Pe=tt.footerHeight;nt();const Qe=(L,I,H,Q,F,j,A)=>{if(!I||typeof I!="string"||I.length<10||!I.startsWith("http://")&&!I.startsWith("https://")&&!I.startsWith("data:")){A&&A();return}if((D=>{if(!D||D.length<25||/\/images\/\d+$/.test(D)||D.endsWith("/0"))return!0;const T=/\.(jpg|jpeg|png|gif|webp|svg)(\?.*)?$/i.test(D),_=D.startsWith("data:");return!T&&!_})(I)){console.warn("Skipping malformed image URL:",(I==null?void 0:I.substring(0,50))+"..."),A&&A();return}if(Y.totalImages++,p.emailCompatible){Y.failedImages++,A&&A();return}const K=Dt(I);if(K&&K.dataUrl)try{const D=K.width/K.height;let T=F,_=F/D;_>j&&(_=j,T=j*D),L.addImage(K.dataUrl,K.format,H,Q,T,_,void 0,"FAST"),Y.optimizedImages++,A&&A();return}catch{console.warn("Failed to use cached image, falling back to direct load")}let ne=!1;const ge=["https://wsrv.nl/?url=","https://images.weserv.nl/?url=","https://api.codetabs.com/v1/proxy?quest="];let Z=0;function ee(){if(ne)return;const D=new Image;D.crossOrigin="Anonymous";let T=null;D.onload=function(){if(!ne){ne=!0,T&&clearTimeout(T);try{const ie=ht(0),Le=ie.imageMaxWidth,we=F,te=j;try{const G=document.createElement("canvas"),q=G.getContext("2d"),{width:V,height:Ze}=to(D.width,D.height,Le);G.width=V,G.height=Ze,q.imageSmoothingEnabled=!0,q.imageSmoothingQuality="high",q.drawImage(D,0,0,V,Ze);let _e,Fe="JPEG";const bt=eo(G,q),St=Zt(D);bt||St?(_e=G.toDataURL("image/png",ie.imageQuality),Fe="PNG"):(_e=G.toDataURL("image/jpeg",ie.imageQuality),Fe="JPEG");const xt=`img_${lo(I)}`;L.addImage(_e,Fe,H,Q,we,te,xt,"FAST"),Y.optimizedImages++,A&&A()}catch(G){console.warn(`Failed to optimize image: ${I}`,G),console.warn("Error details:",G.message,G.stack);try{L.addImage(D,"JPEG",H,Q,we,te),Y.optimizedImages++,A&&A()}catch(q){console.error(`Fallback also failed for: ${I}`,q),Y.failedImages++,A&&A()}}}catch(ie){console.warn("Failed to add image to PDF:",ie),Y.failedImages++,A&&A()}}},D.onerror=function(){ne||(T&&clearTimeout(T),console.warn(`Failed to load image with proxy ${Z}: ${I}`),console.warn(`Error details for: ${I} - Proxy: ${ge[Z]}`),Z++,Z<ge.length?setTimeout(()=>{ee()},200):(ne=!0,console.warn("All proxies failed, skipping image"),Y.failedImages++,A&&A()))},T=setTimeout(()=>{ne||(console.warn(`⏰ Timeout with proxy ${Z}: ${I}`),D.src="",D.onload=null,D.onerror=null,Z++,Z<ge.length?setTimeout(()=>{ee()},200):(ne=!0,console.warn("All proxies timed out, skipping image"),Y.failedImages++,A&&A()))},3e3);let _=I;Z<ge.length&&(_=ge[Z]+encodeURIComponent(I)),D.src=_}ee()},W=[];Object.keys(g).forEach((L,I)=>{const H=g[L];if(!H||!Array.isArray(H)){console.warn("⚠️ Skipping invalid room items:",L,H);return}H.forEach((Q,F)=>{if(!Q){console.warn("⚠️ Skipping null item in room:",L,"at index:",F);return}W.push({item:Q,room:L,rIdx:I,iIdx:F,isFirstInRoom:F===0,roomCount:H.length})})}),W.reduce((L,I)=>{if(!I||!I.item)return console.warn("⚠️ Skipping null row in data analysis:",I),L;const H=String(I.item.Description||""),Q=String(I.item.LongDescription||""),F=String(I.item.Notes||""),j=String(I.item.OrderCode||"");return L+H.length+Q.length+F.length+j.length},0);let xe=0,Ie=0;const Re=4,ke=8,$e=Math.floor((x-80)/Re);let Ke=Pe+8;function Ne(){if(!W||!Array.isArray(W)){console.error("❌ Critical error: rowsToDraw is not a valid array:",W),st(new Error("Invalid product data structure"),"generating PDF","unknown.pdf");return}if(xe>=W.length){const F=v.internal.getNumberOfPages()-1;for(let T=2;T<=F+1;T++){v.setPage(T);const ie=(T-2)*Re,Le=Math.min(ie+Re,W.length);let we=!1;for(let te=ie;te<Le;te++)if(W[te]&&W[te].item&&It(W[te].item)){we=!0;break}Rt(v,{pageWidth:f,colX:me,colW:Se,leftMargin:32,footerHeight:Pe,logoDataUrl:se,logoNaturalW:ue,logoNaturalH:pe,headers:Ae,userDetails:p,skipWelsHeader:!we}),kt(v,{pageWidth:f,pageHeight:x,leftMargin:32,footerHeight:Pe,pageNumber:T-1,totalPages:F})}const j=new Date,A=String(j.getDate()).padStart(2,"0"),he=String(j.getMonth()+1).padStart(2,"0"),K=String(j.getFullYear()).slice(-2),ne=String(j.getHours()).padStart(2,"0"),ge=String(j.getMinutes()).padStart(2,"0"),ee=`${p.project.replace(/[^a-zA-Z0-9\s]/g,"")}-${A}${he}${K}.${ne}${ge}.pdf`,D=document.getElementById("pdf-processing-notification");D&&D.remove(),uo(p.emailCompatible);try{const T=v.output("blob"),_=v.output("string"),ie=_?_.match(/\/Type\s*\/XObject/g):null,Le=_?_.match(/Tj\s/g):null,we=_?_.match(/\/A\s*<</g):null;p.pdfSize=T.size;const te=so(T,ee);if(p.sendEmail&&T.size>15*1024*1024){console.warn(`❌ PDF too large for email (${(T.size/1024/1024).toFixed(1)}MB), offering email-compatible version`),po(p,ee);return}const G=oo(T,te.settings);if(p.sendEmail&&p.email)if(p.exportCsv){const q=ee.replace(/\.pdf$/,".csv");ot(p,q).then(V=>{window.dispatchEvent(new CustomEvent("sendEmail",{detail:{userDetails:p,pdfBlob:G,csvBlob:V}}))}).catch(V=>{console.error("Async CSV generation for email failed:",V),window.dispatchEvent(new CustomEvent("sendEmail",{detail:{userDetails:p,pdfBlob:G,csvBlob:null}}))})}else window.dispatchEvent(new CustomEvent("sendEmail",{detail:{userDetails:p,pdfBlob:G,csvBlob:null}}));else if((async()=>{const q=await ho(G);qe(q,ee,"PDF")})(),p.exportCsv){const q=ee.replace(/\.pdf$/,".csv");setTimeout(()=>{ot(p,q).then(V=>{V&&qe(V,q,"CSV")}).catch(V=>{console.error("CSV generation failed:",V)})},1e3)}}catch(T){console.error("PDF generation failed:",T),st(T,"generating PDF",ee);const _=document.getElementById("pdf-processing-notification");_&&_.remove()}t&&(t.style.display="none");return}Ie>=Re&&(v.addPage(),Ke=Pe+8,Ie=0);const L=W[xe];if(!L||!L.item){console.warn(`⚠️  Skipping invalid row at index ${xe}:`,L),xe++,Ne();return}const I=Ke+$e*Ie;L.isFirstInRoom&&u==="room"&&L.room!=="__all__"&&Lt(v,L.room,L.roomCount,32,I);const H=me[0],Q=H+90+12;Qe(v,L.item.Image_URL||"",H,I+ke+16,90,$e-ke*2,()=>{Qe(v,L.item.Diagram_URL||"",Q,I+ke+16,90,$e-ke*2,()=>{const F=I+28,j=me[1]+Se[1]/2;v.setFontSize(10),v.setTextColor("#222"),v.text(String(L.item.OrderCode||""),j,F+10,{align:"center"}),Tt(v,L.item,j,F+35);const A=Se[2]-10;Bt(v,L.item,me[2],F+10,A,p.excludeLongDescription);const he=Ae.indexOf("WELS")+1;if(he>0&&me[he]){const K=me[he]+Se[he]/2;At(v,L.item,K,F+10)}$t(v,L.item,me,Se,Ae,F+10,{excludePrice:p.excludePrice,includeGst:p.includeGst}),xe++,Ie++,Ne()})})}Ne()})})})}function Oe(p,e){const t=new window.Image;t.crossOrigin="Anonymous",t.onload=function(){const o=document.createElement("canvas"),s=o.getContext("2d"),n=400,i=150;let r=t.width,a=t.height;if(r>n||a>i){const d=n/r,l=i/a,u=Math.min(d,l);r=Math.round(r*u),a=Math.round(a*u)}o.width=r,o.height=a,s.imageSmoothingEnabled=!0,s.imageSmoothingQuality="high",s.drawImage(t,0,0,r,a);const c=o.toDataURL("image/png",.9);e(c,r,a)},t.src=p}function Yt(){if(!document.getElementById("pdf-spinner")){const p=document.createElement("div");if(p.id="pdf-spinner",p.style.display="none",p.style.position="fixed",p.style.top="0",p.style.left="0",p.style.width="100vw",p.style.height="100vh",p.style.zIndex="9999",p.style.background="rgba(255,255,255,0.7)",p.style.alignItems="center",p.style.justifyContent="center",p.innerHTML='<div style="border:6px solid #e0e0e0;border-top:6px solid #2563eb;border-radius:50%;width:54px;height:54px;animation:spin 1s linear infinite;"></div>',document.body.appendChild(p),!document.getElementById("pdf-spinner-style")){const e=document.createElement("style");e.id="pdf-spinner-style",e.innerHTML="@keyframes spin { 0% { transform: rotate(0deg);} 100% { transform: rotate(360deg);} }",document.head.appendChild(e)}}}async function ot(p,e){return new Promise(async t=>{if(!window.Papa)try{await S.loadScript("https://cdn.jsdelivr.net/npm/papaparse@5.4.1/papaparse.min.js")}catch(i){console.error("Failed to load PapaParse:",i),t(null);return}const o=JSON.parse(localStorage.getItem("selection")||"[]"),s=JSON.parse(localStorage.getItem(M.STORAGE_KEYS.SELECTED_PRODUCTS)||"[]");let n=[];if(s.length>0?n=s.map(i=>({...i.product,Room:i.room,Notes:i.notes,Quantity:i.quantity,Timestamp:new Date(i.timestamp).toISOString()})):n=o,!n.length){t(null);return}setTimeout(()=>{const i=n.map(r=>{let a,c,d,l;const u=p.excludePrice;let m=0;if(r.UserEditedPrice!==void 0&&r.UserEditedPrice!==null&&r.UserEditedPrice!=="")m=parseFloat(r.UserEditedPrice.toString().replace(/,/g,""));else{const f=r.RRP_EX||r["RRP EX GST"]||r.RRP_EX||r.RRP_EXGST||"";m=parseFloat((f||"0").toString().replace(/,/g,""))}a=m,d="Price ea ex GST",l="Price Total ex GST",c=!isNaN(a)&&a>=0?(a*(r.Quantity||1)).toFixed(2):"";const g=r["WELS STAR"]||r.WELS_STAR||r.WELS_STAR||r.WelsStar||"",y=g&&g.toString().trim()?g.toString().replace(/[^\d.]/g,"").trim():"",v={Code:re(r.OrderCode||""),Description:re(r.Description||""),"WELS Star":re(y),Quantity:r.Quantity||1,Notes:re(r.Notes||""),Room:re(r.Room||""),"Image URL":re(r.Image_URL||""),"Diagram URL":re(r.Diagram_URL||""),"Datasheet URL":re(r.Datasheet_URL||""),"Website URL":re(r.Website_URL||"")};return v[d]=u?"0.00":a>=0?a.toFixed(2):"",v[l]=u?"0.00":c,v});setTimeout(()=>{const r=window.Papa.unparse(i,{quotes:!0,quoteChar:'"',delimiter:",",header:!0,newline:`\r
`,skipEmptyLines:!1,escapeChar:'"',transform:{value(a,c){return typeof a=="string"?a.replace(/\0/g,"").replace(/[\x00-\x08\x0B\x0C\x0E-\x1F]/g,""):a}}});p.sendEmail?setTimeout(()=>{try{const a=btoa(unescape(encodeURIComponent(r)));t({name:e,data:a,contentType:"text/csv",originalSize:r.length,base64Size:a.length})}catch(a){console.error("CSV base64 encoding failed:",a),t(new Blob([r],{type:"text/csv"}))}},0):t(new Blob([r],{type:"text/csv"}))},0)},0)})}function re(p){return typeof p!="string"&&(p=String(p)),p=p.replace(/\0/g,"").replace(/[\x00-\x08\x0B\x0C\x0E-\x1F]/g,"").replace(/\r?\n|\r/g," ").trim(),p}async function Jt(p,e,t="file"){try{if("showSaveFilePicker"in window){const s=await(await window.showSaveFilePicker({suggestedName:e,types:[{description:`${t} files`,accept:{[p.type]:[`.${e.split(".").pop()}`]}}]})).createWritable();return await s.write(p),await s.close(),!0}}catch(o){console.warn("File System Access API failed:",o)}return!1}function Xt(p,e,t="file"){try{if(p.size>2*1024*1024)return console.warn("File too large for data URI method"),!1;const o=new FileReader;return o.onload=function(s){try{const n=document.createElement("a");n.href=s.target.result,n.download=e,n.style.display="none",document.body.appendChild(n),n.click(),document.body.removeChild(n)}catch(n){console.error("Data URI download failed:",n)}},o.readAsDataURL(p),!0}catch(o){return console.warn("Data URI method failed:",o),!1}}function Qt(p,e,t="file"){const o=URL.createObjectURL(p),s=document.createElement("div");s.style.cssText=`
    position: fixed; top: 0; left: 0; width: 100%; height: 100%; 
    background: rgba(0,0,0,0.8); z-index: 10001; display: flex; 
    align-items: center; justify-content: center; padding: 20px;
  ...
  `,s.appendChild(n),document.body.appendChild(s),document.getElementById("manual-download-close").onclick=()=>{URL.revokeObjectURL(o),document.body.removeChild(s)},document.getElementById("manual-download-retry").onclick=()=>{URL.revokeObjectURL(o),document.body.removeChild(s),setTimeout(()=>{mt(p,e,t)},1e3)},document.getElementById("copy-url-btn").onclick=()=>{const i=document.getElementById("manual-download-url");i.select(),i.setSelectionRange(0,99999);try{navigator.clipboard.writeText(o).then(()=>{const r=document.getElementById("copy-url-btn");r.textContent="Copied!",r.style.background="#059669",setTimeout(()=>{r.textContent="Copy",r.style.background="#059669"},2e3)}).catch(()=>{document.execCommand("copy");const r=document.getElementById("copy-url-btn");r.textContent="Copied!",setTimeout(()=>r.textContent="Copy",2e3)})}catch{alert("Copy failed. Please select the URL manually and copy it.")}},s.onclick=i=>{i.target===s&&(URL.revokeObjectURL(o),document.body.removeChild(s))},setTimeout(()=>{s.parentElement&&(URL.revokeObjectURL(o),document.body.removeChild(s))},5*60*1e3)}async function mt(p,e,t="file"){try{if(await Kt(p,e))return}catch(o){console.warn("Standard download failed:",o)}await Jt(p,e,t)||Xt(p,e,t)||Qt(p,e,t)}function Kt(p,e){return new Promise(t=>{try{const o=URL.createObjectURL(p),s=document.createElement("a");s.href=o,s.download=e,s.style.display="none",document.body.appendChild(s);const n=setTimeout(()=>{i(),t(!1)},3e3),i=()=>{clearTimeout(n),s.parentElement&&document.body.removeChild(s),setTimeout(()=>URL.revokeObjectURL(o),1e3)};s.onclick=()=>{i(),t(!0)},s.click(),setTimeout(()=>{i(),t(!0)},500)}catch(o){console.error("Standard download error:",o),t(!1)}})}function Zt(p){const e=document.createElement("canvas"),t=e.getContext("2d");e.width=Math.min(100,p.width),e.height=Math.min(100,p.height),t.drawImage(p,0,0,e.width,e.height);const s=t.getImageData(0,0,e.width,e.height).data,n=new Set;for(let i=0;i<s.length;i+=4){const r=`${s[i]},${s[i+1]},${s[i+2]}`;n.add(r)}return n.size<1e3}function eo(p,e){const o=e.getImageData(0,0,p.width,p.height).data;for(let s=3;s<o.length;s+=4)if(o[s]<255)return!0;return!1}function to(p,e,t){if(p<=t)return{width:p,height:e};const o=e/p;return{width:t,height:Math.round(t*o)}}function ht(p){return p>25*1024*1024?{compressionLevel:"aggressive",imageQuality:.6,imageMaxWidth:300,removeImages:!1,usePNG:!0,message:"Aggressive compression - maintaining technical diagram clarity"}:p>20*1024*1024?{compressionLevel:"high",imageQuality:.65,imageMaxWidth:350,removeImages:!1,usePNG:!0,message:"High compression - preserving technical diagram details"}:p>15*1024*1024?{compressionLevel:"medium",imageQuality:.7,imageMaxWidth:400,removeImages:!1,usePNG:!0,message:"Medium compression - optimal for technical documentation"}:p>10*1024*1024?{compressionLevel:"light",imageQuality:.75,imageMaxWidth:450,removeImages:!1,usePNG:!0,message:"Light compression - excellent technical diagram quality"}:{compressionLevel:"minimal",imageQuality:.8,imageMaxWidth:500,removeImages:!1,usePNG:!0,message:"Minimal compression - maximum technical diagram quality"}}function oo(p,e){return p}function so(p,e){const t=(p.size/1048576).toFixed(2),o=ht(p.size);if(p.size>15*1024*1024){console.warn(`Large file detected (${t} MB) - exceeds typical email limit, may need email-compatible version`);const s=document.createElement("div");s.style.cssText=`
    ...
    `,s.innerHTML=`
      ...
      ">OK</button>
    `,document.body.appendChild(s),setTimeout(()=>{s.parentElement&&s.remove()},8e3)}else p.size>3*1024*1024;return{size:p.size,sizeInMB:parseFloat(t),settings:o}}function st(p,e="",t=""){console.error("Detailed error:",p);const o={type:no(p),message:p.message||"Unknown error",context:e,filename:t,timestamp:new Date().toISOString(),userAgent:navigator.userAgent},s=document.createElement("div");s.style.cssText=`
    position: fixed; top: 0; left: 0; width: 100%; height: 100%; 
  ...
  `,s.appendChild(n),document.body.appendChild(s),document.getElementById("error-close").onclick=()=>{document.body.removeChild(s)},document.getElementById("error-retry").onclick=()=>{document.body.removeChild(s),console.log("Retry requested for:",e)},document.getElementById("error-report").onclick=()=>{co(o),alert("Error details copied to clipboard. Please send this to support.")},s.onclick=i=>{i.target===s&&document.body.removeChild(s)},o}function no(p){var o,s;const e=((o=p.message)==null?void 0:o.toLowerCase())||"",t=((s=p.stack)==null?void 0:s.toLowerCase())||"";return e.includes("network")||e.includes("fetch")?"network":e.includes("permission")||e.includes("denied")?"permission":e.includes("memory")||e.includes("quota")?"memory":e.includes("blob")||e.includes("url")?"download":e.includes("canvas")||e.includes("image")?"rendering":t.includes("jspdf")||e.includes("pdf")?"pdf":"unknown"}function io(p){return{network:"Network Connection Error",permission:"Permission Required",memory:"Insufficient Memory",download:"Download Failed",rendering:"Display Error",pdf:"PDF Generation Error",unknown:"Unexpected Error"}[p]||"Error Occurred"}function ro(p,e,t){return{network:"Unable to load required resources. Please check your internet connection and try again.",permission:`Browser permission required to save ${t}. Please allow downloads and try again.`,memory:"Not enough memory to process this large file. Try closing other browser tabs or use fewer products.",download:`Failed to download ${t}. This may be due to browser security settings or storage limitations.`,rendering:"Unable to display product images properly. Some images may be missing from the final output.",pdf:`PDF generation failed while ${e}. The file may be too large or contain problematic data.`,unknown:`An unexpected error occurred while ${e}. Please try again or contact support.`}[p]||"An unknown error has occurred."}function ao(p){const e={network:`
      ...
      </div>`};return e[p]||e.unknown}function gt(){const p=navigator.userAgent;return p.includes("Chrome")?"Chrome":p.includes("Firefox")?"Firefox":p.includes("Safari")?"Safari":p.includes("Edge")?"Edge":p.includes("SamsungBrowser")?"Samsung Internet":"Unknown"}function co(p){const e=`
...
========================
  `.trim();try{navigator.clipboard.writeText(e)}catch(t){console.error("Failed to copy error report:",t)}}let Y={totalImages:0,optimizedImages:0,failedImages:0,totalSavings:0};function lo(p){let e=0;if(p.length===0)return e.toString();for(let t=0;t<p.length;t++){const o=p.charCodeAt(t);e=(e<<5)-e+o,e=e&e}return Math.abs(e).toString(36)}function nt(){Y={totalImages:0,optimizedImages:0,failedImages:0,totalSavings:0}}function uo(p=!1){Y.totalImages>0}function po(p,e){const t=document.createElement("div");t.style.cssText=`
    position: fixed; top: 0; left: 0; width: 100%; height: 100%; 
    background: rgba(0,0,0,0.8); z-index: 10001; display: flex; 
    align-items: center; justify-content: center; padding: 20px;
  ...
  `,document.body.appendChild(t),setTimeout(()=>{t.parentElement&&t.remove()},8e3)}const it="fredChatHistory",Ve="fredChatMessages",De="fredFeedback",Ce="fredQuestionLog",Ue=16,ce={PROXY_URL:"https://seima-ai-proxy.seima.workers.dev",APP_SECRET:"sk-proj-KRCnI_ABkeaV18bpU1dTOpXWxpKtucw",MODEL:"gpt-4o",MAX_TOKENS:2e3,TEMPERATURE:.2,MAX_CATALOG_RESULTS:60},go=`You are Fred, a product assistant for Seima — an Australian bathroom and kitchen products company.
...
Return format: [{"code":"...","name":"...","brand":"...","category":"...","quantity":1,"finish":"...","section":"...","specCode":"...","style":"..."}]`;class yo{constructor(){this.conversationHistory=this._loadHistory(),this.isProcessing=!1}async chat(e,t,o=null){var s,n,i;if(this.isProcessing)throw new Error("A request is already in progress");this.isProcessing=!0;try{const r=[{role:"system",content:go}],a=this._findRelevantProducts(e,t);if(a&&r.push({role:"system",content:`SEIMA PRODUCT DATA (${a.count} products):
...
This can be restored later.`))try{const t=await de.deleteSelections([e.id]);t.success?(this.showToast("Selection deleted"),this.fetchAndRenderSelections()):this.showError(t.error||"Failed to delete")}catch(t){this.showError(t.message)}}async restoreSelection(e){try{const t=await de.restoreSelections([e.id]);t.success?(this.showToast("Selection restored"),this.fetchAndRenderSelections()):this.showError(t.error||"Failed to restore")}catch(t){this.showError(t.message)}}showToast(e){const t=document.createElement("div");t.style.cssText=`
    ...
    `;const a=i.querySelector(".toast-close");if(a.onclick=()=>this.dismiss(n),s&&s.callback){const c=i.querySelector(".toast-action");c.onclick=()=>{s.callback(),this.dismiss(n)}}return this.container.appendChild(i),this.toasts.set(n,i),requestAnimationFrame(()=>{i.classList.add("toast-enter")}),o>0&&setTimeout(()=>this.dismiss(n),o),n}dismiss(e){const t=this.toasts.get(e);t&&(t.classList.add("toast-exit"),t.addEventListener("animationend",()=>{t.remove(),this.toasts.delete(e)}))}dismissAll(){this.toasts.forEach((e,t)=>this.dismiss(t))}success(e,t={}){return this.show({message:e,type:"success",...t})}error(e,t={}){return this.show({message:e,type:"error",duration:6e3,...t})}warning(e,t={}){return this.show({message:e,type:"warning",...t})}info(e,t={}){return this.show({message:e,type:"info",...t})}withUndo(e,t,o=5e3){return this.show({message:e,type:"info",duration:o,action:{label:"Undo",callback:t}})}}const ae=new Co;window.toast=ae;class Po{constructor(){this.activeDropdown=null,this.updatePositionHandler=null,document.addEventListener("click",e=>{e.target.closest(".global-search-dropdown")||this.hideDropdown()})}showDropdown(e,t,o,s=!1){this.hideDropdown();const n=document.createElement("ul");n.className="global-search-dropdown";const i=300,r=e.getBoundingClientRect(),a=window.innerWidth,c=window.innerHeight,d=r.width,l=c-r.bottom,u=r.top;let m=!1;l<i&&u>l&&(m=!0);let g;m?g=Math.max(8,r.top-i-8):g=Math.min(c-i-8,r.bottom+8);let y=r.left;y+d>a-8&&(y=a-d-8),y<8&&(y=8);const v={position:"fixed",top:`${g}px`,left:`${y}px`,width:`${d}px`,minWidth:`${d}px`,maxWidth:`${d}px`,background:"#fff",border:"1px solid #d1d5db",borderRadius:"8px",boxShadow:"0 10px 25px -5px rgba(0, 0, 0, 0.15), 0 8px 10px -6px rgba(0, 0, 0, 0.10)",maxHeight:`${i}px`,overflowY:"auto",overflowX:"hidden",zIndex:"10010",listStyle:"none",margin:"0",padding:"4px 0",whiteSpace:"normal",wordWrap:"break-word",display:"block",pointerEvents:"auto",transform:"none",contain:"none",isolation:"isolate"};Object.keys(v).forEach(f=>{n.style.setProperty(f,v[f],"important")}),n.dropdownHeight=i,t.length===0?n.innerHTML='<li style="padding: 12px 16px; color: #6b7280; font-style: italic; background: #fff;">No products found</li>':n.innerHTML=t.map(f=>{if(f._crosshairValidate){const N=f._crosshairValidate,se=N.imageUrl?`<img src="${S.sanitizeInput(N.imageUrl)}" alt="" style="width:32px; height:32px; object-fit:contain; border-radius:4px; margin-right:10px; vertical-align:middle; flex-shrink:0;">`:"";return`<li data-validate-competitor="${S.sanitizeInput(N.competitor)}" data-validate-code="${S.sanitizeInput(N.productCode)}"
            ...
            <div style="flex:1; min-width:0;">
              <div style="font-weight: 600; color: #92400e;">${S.sanitizeInput(N.productName)}</div>
              <div style="color: #78716c; font-size: 11px;">${S.sanitizeInput(N.competitor)} · #${S.sanitizeInput(N.productCode)}${N.finish?" · "+S.sanitizeInput(N.finish):""} · ${N.matchCount} suggested match${N.matchCount!==1?"es":""}</div>
            </div>
            <span style="color: #d97706; font-size: 11px; font-weight: 600; white-space: nowrap; margin-left: 8px;">Review →</span>
          </li>`}const x=f.OrderCode||f.Code||"",h=f.Description||f.ProductName||f["Product Name"]||"",w=f.Image_URL||f.image_url||"",E=f._crosshairMatch,P=E?`<span style="display: inline-block; background: ${E.status==="Verified"?"#e8f5e9":"#e3f2fd"}; color: ${E.status==="Verified"?"#2e7d32":"#1565c0"}; font-size: 10px; font-weight: 600; padding: 1px 6px; border-radius: 8px; margin-left: 8px;">↔ ${S.sanitizeInput(E.competitorLabel||E.competitor)}</span>`:"",U=w?`<img src="${S.sanitizeInput(w)}" alt="" style="width:36px; height:36px; object-fit:contain; border-radius:4px; margin-right:10px; flex-shrink:0;" onerror="this.style.display='none'">`:"",z=E?Object.fromEntries(Object.entries(f).filter(([N])=>N!=="_crosshairMatch")):f;return`<li data-product='${JSON.stringify(z).replace(/'/g,"&apos;")}'
    ...
    `,s.querySelectorAll(".ai-feedback-btn").forEach(a=>{a.addEventListener("click",()=>{const c=a.dataset.rating;s.querySelectorAll(".ai-feedback-btn").forEach(d=>d.classList.remove("active")),a.classList.add("active"),this._saveFeedback(t,o,c)})});const r=e.querySelector(".ai-msg-bubble");r?e.insertBefore(s,r.nextSibling):e.appendChild(s)}_saveFeedback(e,t,o){try{const s=this._loadFeedback(),n=s.findIndex(r=>r.id===e),i={id:e,question:this._lastUserMessage||"",answer:(t||"").slice(0,500),rating:o,timestamp:Date.now(),synced:!1};n>=0?s[n]={...s[n],...i}:s.push(i),localStorage.setItem(De,JSON.stringify(s))}catch{}}_getFeedbackEntry(e){return this._loadFeedback().find(t=>t.id===e)||null}_loadFeedback(){try{const e=localStorage.getItem(De);if(!e)return[];const t=JSON.parse(e);return Array.isArray(t)?t:[]}catch{return[]}}_escapeHtml(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}_scrollToBottom(){requestAnimationFrame(()=>{this.messagesContainer.scrollTop=this.messagesContainer.scrollHeight})}_persistMessages(){try{const e=[];this.messagesContainer.querySelectorAll(".ai-msg").forEach(t=>{var o,s;t.classList.contains("ai-msg-user")?e.push({role:"user",content:((o=t.querySelector(".ai-msg-bubble"))==null?void 0:o.textContent)||""}):t.classList.contains("ai-msg-assistant")&&!t.querySelector(".ai-msg-thinking")&&e.push({role:"assistant",content:((s=t.querySelector(".ai-msg-bubble"))==null?void 0:s.dataset.rawContent)||"",feedbackId:t.dataset.feedbackId||null})}),localStorage.setItem(Ve,JSON.stringify(e))}catch{}}_restoreMessages(){try{const e=localStorage.getItem(Ve);if(!e)return;const t=JSON.parse(e);if(!Array.isArray(t)||t.length===0)return;const o=this.messagesContainer.querySelector(".ai-chat-welcome");o&&o.remove();for(const n of t)n.role==="user"&&(this._lastUserMessage=n.content),this._addMessage(n.role,n.content,{skipPersist:!0,feedbackId:n.feedbackId||null});const s=document.createElement("div");s.className="ai-chat-restored",s.textContent="Previous conversation restored",this.messagesContainer.prepend(s)}catch{}}_generateId(){return Date.now().toString(36)+Math.random().toString(36).substr(2)}_trackQuestion(e){try{const t=localStorage.getItem(Ce),o=t?JSON.parse(t):{},s=e.trim();if(s.length<5)return;o[s]=(o[s]||0)+1,localStorage.setItem(Ce,JSON.stringify(o))}catch{}}async _syncFeedback(){try{const e=this._loadFeedback(),t=e.filter(i=>!i.synced),o=localStorage.getItem(Ce),s=o?JSON.parse(o):null;if(t.length===0&&!s)return;if((await fetch(`${ce.PROXY_URL}/v1/feedback`,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${ce.APP_SECRET}`},body:JSON.stringify({entries:t,questionLog:s})})).ok){for(const i of t)i.synced=!0;this._pruneFeedback(e),localStorage.setItem(De,JSON.stringify(e)),localStorage.removeItem(Ce)}}catch{}}_pruneFeedback(e){const t=Date.now()-6048e5;for(let o=e.length-1;o>=0;o--)e[o].synced&&e[o].timestamp<t&&e.splice(o,1)}_clearChat(){fe.clearHistory();try{localStorage.removeItem(De),localStorage.removeItem(Ce)}catch{}this._showWelcome()}open(){this.panel.classList.add("open"),this.isOpen=!0,setTimeout(()=>this.input.focus(),300),this._syncFeedback()}close(){this.panel.classList.remove("open"),this.isOpen=!1}toggle(){this.isOpen?this.close():this.open()}}const dt=new ko;class Lo{constructor(){this.navigationManager=null,this.fileImportManager=new vo,this.productGridManager=new Io,this.isInitialized=!1,O.log("SeimaScanner application starting",C.INFO)}async init(){var e,t,o;try{O.log("Initializing application modules",C.INFO),J.configure({googleSheetsUrl:(e=M.PRESENTATION_RECORDING)==null?void 0:e.GOOGLE_SHEETS_URL,email:M.EMAIL}),X.configure({logoSrc:"assets/seima-logo.png",brandName:"Seima",appName:"Product Presenter"});const s=(t=M.PRESENTATION_RECORDING)==null?void 0:t.GOOGLE_SHEETS_URL;if(s&&Et(s).catch(a=>{console.warn("Synonyms preload failed:",(a==null?void 0:a.message)||a)}),(o=M.CROSSHAIR)!=null&&o.ENABLED){const a=J.getCurrentUser();k.configure(M.CROSSHAIR,(a==null?void 0:a.email)||"");try{await k.preload()}catch(c){console.warn("Crosshair preload at init failed (user may not be logged in):",c.message)}}const n=be.getCompatibilityReport();O.log(`Browser compatibility: ${n.score}% (${n.browserName})`,C.INFO),be.shouldShowCompatibilityWarning()&&this.showCompatibilityWarning(),this.navigationManager=new Vt,await this.navigationManager.init(),this.fileImportManager.init(),this.setupGlobalEventListeners(),this.productGridManager.init(),dt.init();const i=document.getElementById("ai-chat-trigger");i&&i.addEventListener("click",()=>dt.toggle()),window.navigationManager=this.navigationManager,window.productGridManager=this.productGridManager,window.browserCompatibility=be,window.downloadWithFallback=qe,window.showPdfFormScreen=We,this.isInitialized=!0,O.log("Seima Scanner initialized successfully",C.INFO);const r=document.querySelector(".grid-container");return r&&r.classList.add("ready"),setTimeout(()=>{yt.show()},500),!0}catch(s){return O.handleError({message:"Failed to initialize application",error:s,category:$.UI,level:C.CRITICAL,context:"app-init"}),!1}}showCompatibilityWarning(){const e=be.getCompatibilityReport(),t=e.recommendations;if(t.length===0)return;const o=t.filter(i=>i.type==="critical"),s=e.score<R.get("compatibility.minCompatibilityScore",70);if(o.length===0&&!s)return;const n=document.createElement("div");n.style.cssText=`
    ...
    `,document.body.insertBefore(n,document.body.firstChild)}setupGlobalEventListeners(){window.addEventListener("generatePdf",e=>{const{tipTailSettings:t,...o}=e.detail;Yt(),We(o,t||null)}),window.addEventListener("beforeunload",()=>{}),be.features.memoryAPI&&setInterval(()=>{const e=be.memoryInfo;e.memoryPressure==="high"&&console.warn("High memory usage detected:",e)},6e4)}getSelectedProducts(){return b.getSelectedProducts()}clearSelection(){return b.clearAllSelections()}addProduct(e,t,o,s){return b.addProductToSelection(e,t,o,s)}updateSelectionCount(){this.navigationManager&&this.navigationManager.updateSelectionCount()}showError(e){alert(e)}}document.addEventListener("DOMContentLoaded",()=>{window.seimaScanner=new Lo,window.seimaScanner.init()});window.addEventListener("DOMContentLoaded",()=>{fetch("./version.txt").then(p=>p.text()).then(p=>{const e=p.trim().split(`
`);if(e.length>0){const o=e[0].split(" - ")[0].trim(),s=document.getElementById("app-version");s&&(s.textContent=`Ver: ${o}`,s.style.cursor="pointer",s.addEventListener("click",$o))}}),Do(),To()});function Do(){const p=document.getElementById("help-btn");p&&p.addEventListener("click",()=>{Bo()});const e=document.getElementById("crosshair-btn");e&&e.addEventListener("click",()=>{window.location.href="screens/validator.html"});const t=document.getElementById("admin-btn");t&&t.addEventListener("click",()=>{window.location.href="screens/admin.html"});const o=document.getElementById("quick-start-btn");o&&o.addEventListener("click",()=>{yt.showForced()})}function To(){const p=document.getElementById("user-menu-container"),e=document.getElementById("user-menu-trigger"),t=document.getElementById("user-menu-dropdown"),o=document.getElementById("sign-in-btn"),s=document.getElementById("user-avatar"),n=document.getElementById("user-name-display");function i(c){var d,l,u,m,g,y;if(c){(d=M.CROSSHAIR)!=null&&d.ENABLED&&(k.configure(M.CROSSHAIR,c.email||""),k.preload().catch(h=>{console.warn("Crosshair preload after login failed:",h)})),p&&(p.style.display="block"),o&&(o.style.display="none");const v=document.getElementById("crosshair-btn");v&&(v.style.display=(l=M.CROSSHAIR)!=null&&l.ENABLED&&J.isStaffMode()?"":"none");const f=document.getElementById("admin-btn");f&&(f.style.display=J.isAdmin()?"":"none");const x=r(c.name);s&&(s.textContent=x),n&&(n.textContent=((u=c.name)==null?void 0:u.split(" ")[0])||"User"),t&&(t.innerHTML=`
        ...
        `,(m=document.getElementById("menu-profile"))==null||m.addEventListener("click",()=>{t.style.display="none",X.showEditProfile(h=>{b.clearUserSettings(),i(h)})}),(g=document.getElementById("menu-password"))==null||g.addEventListener("click",()=>{t.style.display="none",X.showChangePassword()}),(y=document.getElementById("menu-logout"))==null||y.addEventListener("click",()=>{t.style.display="none",b.clearUserSettings(),J.logout(),i(null)}))}else p&&(p.style.display="none"),o&&(o.style.display="block")}function r(c){if(!c)return"?";const d=c.trim().split(" ");return d.length>=2?(d[0][0]+d[d.length-1][0]).toUpperCase():c.substring(0,2).toUpperCase()}function a(c){const d=document.createElement("div");return d.textContent=c||"",d.innerHTML}e&&t&&(e.addEventListener("click",c=>{c.stopPropagation();const d=t.style.display!=="none";t.style.display=d?"none":"block"}),document.addEventListener("click",c=>{p!=null&&p.contains(c.target)||(t.style.display="none")})),o&&o.addEventListener("click",()=>{X.showLogin(c=>{i(c)})}),J.onAuthChange=i,i(J.getCurrentUser())}function Bo(){const p=document.getElementById("user-guide-modal"),e=document.getElementById("user-guide-content");if(!p||!e)return;e.innerHTML=Ao(),p.style.display="flex";const t=document.getElementById("user-guide-close");t&&(t.onclick=()=>{p.style.display="none"}),p.onclick=s=>{s.target===p&&(p.style.display="none")};const o=s=>{s.key==="Escape"&&(p.style.display="none",document.removeEventListener("keydown",o))};document.addEventListener("keydown",o)}function Ao(){return`
  ...
  `}async function $o(){try{const p=document.getElementById("changelog-modal"),e=document.getElementById("changelog-content"),s=(await(await fetch("./version.txt")).text()).trim().split(`
