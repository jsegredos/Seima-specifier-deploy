...
`).filter(r=>r.trim()!==""),n=s.length>0?s[s.length-1]:"Unknown",i=n.split(" - ")[0]||n;o.innerText=i,o.innerText.trim()||(o.innerText="v2.1.0")}}else throw new Error("Version file not found")}catch{const t=document.getElementById("version-number");if(t){const o=N.get("app.version")||"v2.1.0";t.innerText=o}else setTimeout(()=>{const o=document.getElementById("version-number");if(o&&!o.innerText.trim()){const s=N.get("app.version")||"v2.1.0";o.innerText=s}},1e3);console.info("Version loaded from config (GitHub Pages mode)")}}async showProductLookupScreen(){try{const t=await(await fetch("./screens/product-grid.html")).text();document.body.innerHTML=t,this.currentScreen="product-grid";const o=document.createElement("script");o.type="module",o.src="js/app.js",document.body.appendChild(o),setTimeout(()=>{document.querySelectorAll(".back-btn").forEach(s=>s.remove())},100),window.productGridManager&&window.productGridManager.init(),await this.loadVersion(),setTimeout(()=>this.loadVersion(),1e3)}catch(e){console.error("Failed to load product grid screen:",e)}}setupSplitInterface(){const e=document.getElementById("back-to-home");e&&(e.onclick=()=>location.reload());const t=document.getElementById("download-btn"),o=document.getElementById("clear-all-btn");t&&(t.onclick=()=>this.showDownloadFormModal()),o&&(o.onclick=()=>this.showClearConfirmModal()),this.setupSplitProductSearch(),this.setupReviewTable(),this.renderReviewTable(),this.loadInitialSearchResults()}setupSplitProductSearch(){const e=document.getElementById("product-search-input"),t=document.getElementById("search-results-list"),o=document.getElementById("search-loading"),s=document.getElementById("search-no-results");if(!e||!t)return;const n=[],i=E.debounce(r=>{this.performSplitProductSearch(r,t,n,o,s)},200);e.addEventListener("input",()=>{const r=e.value.trim();r?i(r):this.loadInitialSearchResults()}),t.addEventListener("click",r=>{const a=r.target.closest(".result-item");if(!a)return;const c=parseInt(a.getAttribute("data-idx"),10),l=n.length>0?n:this.currentSearchResults||[];!isNaN(c)&&l[c]&&this.showSplitProductDetails(l[c])})}performSplitProductSearch(e,t,o,s,n){if(!D.isLoaded){s.style.display="flex",n.style.display="none",t.innerHTML="";return}o.length=0,o.push(...D.searchProducts(e)),s.style.display="none",o.length===0?(n.style.display="flex",t.innerHTML=""):(n.style.display="none",t.innerHTML=o.map((i,r)=>`
        ...
        <div class="table-row" data-index="${l}">
          ...
          <div class="col-product">
            <div class="product-info">
              ...
              ${c.notes?`<div class="product-notes">${E.sanitizeInput(c.notes)}</div>`:""}
            </div>
          </div>
          <div class="col-room">
      ...
      <div class="review-room-group">
        ...
        ${i.map((r,a)=>{const c=r.product,l=c.Description||c.description||c.productName||c["Product Name"]||"Product",d=c.OrderCode||c.orderCode||"",u=c.Image_URL||c.imageUrl||"assets/no-image.png",g=c.RRP_EX||c["RRP EX GST"]||c.RRP_EX||c.rrpExGst||c.RRP_EXGST||c["PL1 - RRP EX GST"]||c.RRP_INCGST||c["RRP INC GST"]||"0";return`
    ...
    `,document.body.appendChild(o);const n=wt();Be("./assets/seima-logo.png",async(i,r,a)=>{const c=JSON.parse(localStorage.getItem("selection")||"[]"),l=JSON.parse(localStorage.getItem(j.STORAGE_KEYS.SELECTED_PRODUCTS)||"[]");let d=[];l.length>0?d=l.map(b=>({...b.product,Room:b.room,Notes:b.notes,Quantity:b.quantity,Timestamp:new Date(b.timestamp).toISOString()})):d=c;const u=document.getElementById("sort-by"),g=u?u.value:"room";switch(g){case"code":d.sort((b,S)=>{const P=b.OrderCode||b.Code||"",C=S.OrderCode||S.Code||"";return P.localeCompare(C)});break;case"product":d.sort((b,S)=>{const P=b.Description||b.ProductName||"",C=S.Description||S.ProductName||"";return P.localeCompare(C)});break;case"room":default:{let b=[];try{const S=localStorage.getItem("customRoomOrder");b=S?JSON.parse(S):[]}catch{b=[]}d.sort((S,P)=>{const C=S.Room||"Blank",T=P.Room||"Blank";if(C===T)return 0;if(C==="Blank")return 1;if(T==="Blank")return-1;const k=b.indexOf(C),F=b.indexOf(T);return k!==-1&&F!==-1?k-F:k!==-1?-1:F!==-1?1:C.localeCompare(T)});break}}if(!d.length){alert("No products selected."),t&&(t.style.display="none");return}if(Qe()>0)console.log(`📷 Using ${Qe()} pre-cached images (skipping duplicate preload)`);else{const b=document.getElementById("pdf-processing-notification");if(b){const S=document.createElement("span");S.id="preload-progress",S.style.cssText="display: block; font-size: 12px; margin-top: 8px; color: #1e40af;",S.textContent="Loading images: 0%",b.appendChild(S)}console.log("📷 Starting image preload for",d.length,"products"),at(d).then(S=>{const P=document.getElementById("preload-progress");P&&(P.textContent=`✓ ${S} images ready`,P.style.color="#059669")}).catch(S=>{console.warn("Image preloading error:",S)})}const p={};g==="room"?d.forEach(b=>{const S=b.Room||"Blank";p[S]||(p[S]=[]),p[S].push(b)}):p.__all__=d,await n;const{jsPDF:y}=window.jspdf,f=new y({orientation:"landscape",unit:"pt",format:"a4",compress:!0,putOnlyUsedFonts:!0,precision:16,userUnit:1,floatPrecision:16}),w=f.internal.pageSize.getWidth(),v=f.internal.pageSize.getHeight();Be("./assets/seima-logo.png",(b,S,P)=>{const C=W.getCurrentUser(),T=x.getUserSettings(),k=C?{name:C.name,email:C.email,phone:C.phone,position:C.position}:T,F=localStorage.getItem("customerLogo");bt(f,{pageWidth:w,pageHeight:v,seimaLogoDataUrl:b,seimaLogoNaturalW:S,seimaLogoNaturalH:P,customerLogoDataUrl:F,userDetails:m,staffContact:k,footerHeight:Ke.footerHeight}),f.addPage(),Be("./assets/seima-logo-white.png",(R,H,se)=>{const ht=m.showRrp&&!m.excludePrice,Ve=!m.excludePrice,Xe=!m.excludeQty,gt=St(w,{leftMargin:32,rightMargin:32,showRrp:ht,showPrice:Ve,showQty:Xe,showTotal:Ve&&Xe}),{colX:he,colW:be,headers:Te}=gt,Ee=Ke.footerHeight;tt();const Ye=(_,I,V,Q,z,G,A)=>{if(!I||typeof I!="string"||I.length<10||!I.startsWith("http://")&&!I.startsWith("https://")&&!I.startsWith("data:")){A&&A();return}if(($=>{if(!$||$.length<25||/\/images\/\d+$/.test($)||$.endsWith("/0"))return!0;const B=/\.(jpg|jpeg|png|gif|webp|svg)(\?.*)?$/i.test($),O=$.startsWith("data:");return!B&&!O})(I)){console.warn("Skipping malformed image URL:",(I==null?void 0:I.substring(0,50))+"..."),A&&A();return}if(J.totalImages++,m.emailCompatible){J.failedImages++,A&&A();return}const K=kt(I);if(K&&K.dataUrl)try{const $=K.width/K.height;let B=z,O=z/$;O>G&&(O=G,B=G*$),_.addImage(K.dataUrl,K.format,V,Q,B,O,void 0,"FAST"),J.optimizedImages++,A&&A();return}catch{console.warn("Failed to use cached image, falling back to direct load")}let ne=!1;const fe=["https://wsrv.nl/?url=","https://images.weserv.nl/?url=","https://api.codetabs.com/v1/proxy?quest="];let Z=0;function ee(){if(ne)return;const $=new Image;$.crossOrigin="Anonymous";let B=null;$.onload=function(){if(!ne){ne=!0,B&&clearTimeout(B);try{const ie=dt(0),Ie=ie.imageMaxWidth,ve=z,te=G;try{const q=document.createElement("canvas"),oe=q.getContext("2d"),{width:re,height:ye}=Yt($.width,$.height,Ie);q.width=re,q.height=ye,oe.imageSmoothingEnabled=!0,oe.imageSmoothingQuality="high",oe.drawImage($,0,0,re,ye);let _e,$e="JPEG";const ft=Xt(q,oe),yt=Vt($);ft||yt?(_e=q.toDataURL("image/png",ie.imageQuality),$e="PNG"):(_e=q.toDataURL("image/jpeg",ie.imageQuality),$e="JPEG");const vt=`img_${so(I)}`;_.addImage(_e,$e,V,Q,ve,te,vt,"FAST"),J.optimizedImages++,A&&A()}catch(q){console.warn(`Failed to optimize image: ${I}`,q),console.warn("Error details:",q.message,q.stack);try{_.addImage($,"JPEG",V,Q,ve,te),J.optimizedImages++,A&&A()}catch(oe){console.error(`Fallback also failed for: ${I}`,oe),J.failedImages++,A&&A()}}}catch(ie){console.warn("Failed to add image to PDF:",ie),J.failedImages++,A&&A()}}},$.onerror=function(){ne||(B&&clearTimeout(B),console.warn(`Failed to load image with proxy ${Z}: ${I}`),console.warn(`Error details for: ${I} - Proxy: ${fe[Z]}`),Z++,Z<fe.length?setTimeout(()=>{ee()},200):(ne=!0,console.warn("All proxies failed, skipping image"),J.failedImages++,A&&A()))},B=setTimeout(()=>{ne||(console.warn(`⏰ Timeout with proxy ${Z}: ${I}`),$.src="",$.onload=null,$.onerror=null,Z++,Z<fe.length?setTimeout(()=>{ee()},200):(ne=!0,console.warn("All proxies timed out, skipping image"),J.failedImages++,A&&A()))},3e3);let O=I;Z<fe.length&&(O=fe[Z]+encodeURIComponent(I)),$.src=O}ee()},Y=[];Object.keys(p).forEach((_,I)=>{const V=p[_];if(!V||!Array.isArray(V)){console.warn("⚠️ Skipping invalid room items:",_,V);return}V.forEach((Q,z)=>{if(!Q){console.warn("⚠️ Skipping null item in room:",_,"at index:",z);return}Y.push({item:Q,room:_,rIdx:I,iIdx:z,isFirstInRoom:z===0,roomCount:V.length})})}),Y.reduce((_,I)=>{if(!I||!I.item)return console.warn("⚠️ Skipping null row in data analysis:",I),_;const V=String(I.item.Description||""),Q=String(I.item.LongDescription||""),z=String(I.item.Notes||""),G=String(I.item.OrderCode||"");return _+V.length+Q.length+z.length+G.length},0);let Se=0,Pe=0;const Ce=4,ke=8,Le=Math.floor((v-80)/Ce);let Je=Ee+8;function De(){if(!Y||!Array.isArray(Y)){console.error("❌ Critical error: rowsToDraw is not a valid array:",Y),et(new Error("Invalid product data structure"),"generating PDF","unknown.pdf");return}if(Se>=Y.length){const z=f.internal.getNumberOfPages()-1;for(let B=2;B<=z+1;B++){f.setPage(B);const ie=(B-2)*Ce,Ie=Math.min(ie+Ce,Y.length);let ve=!1;for(let te=ie;te<Ie;te++)if(Y[te]&&Y[te].item&&xt(Y[te].item)){ve=!0;break}Et(f,{pageWidth:w,colX:he,colW:be,leftMargin:32,footerHeight:Ee,logoDataUrl:R,logoNaturalW:H,logoNaturalH:se,headers:Te,userDetails:m,skipWelsHeader:!ve}),Pt(f,{pageWidth:w,pageHeight:v,leftMargin:32,footerHeight:Ee,pageNumber:B-1,totalPages:z})}const G=new Date,A=String(G.getDate()).padStart(2,"0"),ge=String(G.getMonth()+1).padStart(2,"0"),K=String(G.getFullYear()).slice(-2),ne=String(G.getHours()).padStart(2,"0"),fe=String(G.getMinutes()).padStart(2,"0"),ee=`${m.project.replace(/[^a-zA-Z0-9\s]/g,"")}-${A}${ge}${K}.${ne}${fe}.pdf`,$=document.getElementById("pdf-processing-notification");$&&$.remove(),no(m.emailCompatible);try{const B=f.output("blob"),O=f.output("string"),ie=O?O.match(/\/Type\s*\/XObject/g):null,Ie=O?O.match(/Tj\s/g):null,ve=O?O.match(/\/A\s*<</g):null;m.pdfSize=B.size;const te=Qt(B,ee);if(m.sendEmail&&B.size>15*1024*1024){console.warn(`❌ PDF too large for email (${(B.size/1024/1024).toFixed(1)}MB), offering email-compatible version`),io(m,ee);return}const q=Jt(B,te.settings);if(m.sendEmail&&m.email)if(m.exportCsv){const oe=ee.replace(/\.pdf$/,".csv");Ze(m,oe).then(re=>{window.dispatchEvent(new CustomEvent("sendEmail",{detail:{userDetails:m,pdfBlob:q,csvBlob:re}}))}).catch(re=>{console.error("Async CSV generation for email failed:",re),window.dispatchEvent(new CustomEvent("sendEmail",{detail:{userDetails:m,pdfBlob:q,csvBlob:null}}))})}else window.dispatchEvent(new CustomEvent("sendEmail",{detail:{userDetails:m,pdfBlob:q,csvBlob:null}}));else(async()=>{const oe=await ao(q);if(await je(oe,ee,"PDF"),m.exportCsv){const re=ee.replace(/\.pdf$/,".csv");try{const ye=await Ze(m,re);ye&&await je(ye,re,"CSV")}catch(ye){console.error("CSV generation failed:",ye)}}})()}catch(B){console.error("PDF generation failed:",B),et(B,"generating PDF",ee);const O=document.getElementById("pdf-processing-notification");O&&O.remove()}t&&(t.style.display="none");return}Pe>=Ce&&(f.addPage(),Je=Ee+8,Pe=0);const _=Y[Se];if(!_||!_.item){console.warn(`⚠️  Skipping invalid row at index ${Se}:`,_),Se++,De();return}const I=Je+Le*Pe;_.isFirstInRoom&&g==="room"&&_.room!=="__all__"&&Ct(f,_.room,_.roomCount,32,I);const V=he[0],Q=V+90+12;Ye(f,_.item.Image_URL||"",V,I+ke+16,90,Le-ke*2,()=>{Ye(f,_.item.Diagram_URL||"",Q,I+ke+16,90,Le-ke*2,()=>{const z=I+28,G=he[1]+be[1]/2;f.setFontSize(10),f.setTextColor("#222"),f.text(String(_.item.OrderCode||""),G,z+10,{align:"center"}),It(f,_.item,G,z+35);const A=be[2]-10;Rt(f,_.item,he[2],z+10,A,m.excludeLongDescription);const ge=Te.indexOf("WELS")+1;if(ge>0&&he[ge]){const K=he[ge]+be[ge]/2;Tt(f,_.item,K,z+10)}Lt(f,_.item,he,be,Te,z+10,{excludePrice:m.excludePrice,includeGst:m.includeGst}),Se++,Pe++,De()})})}De()})})})}function Be(m,e){const t=new window.Image;t.crossOrigin="Anonymous",t.onload=function(){const o=document.createElement("canvas"),s=o.getContext("2d"),n=400,i=150;let r=t.width,a=t.height;if(r>n||a>i){const l=n/r,d=i/a,u=Math.min(l,d);r=Math.round(r*u),a=Math.round(a*u)}o.width=r,o.height=a,s.imageSmoothingEnabled=!0,s.imageSmoothingQuality="high",s.drawImage(t,0,0,r,a);const c=o.toDataURL("image/png",.9);e(c,r,a)},t.src=m}function jt(){if(!document.getElementById("pdf-spinner")){const m=document.createElement("div");if(m.id="pdf-spinner",m.style.display="none",m.style.position="fixed",m.style.top="0",m.style.left="0",m.style.width="100vw",m.style.height="100vh",m.style.zIndex="9999",m.style.background="rgba(255,255,255,0.7)",m.style.alignItems="center",m.style.justifyContent="center",m.innerHTML='<div style="border:6px solid #e0e0e0;border-top:6px solid #2563eb;border-radius:50%;width:54px;height:54px;animation:spin 1s linear infinite;"></div>',document.body.appendChild(m),!document.getElementById("pdf-spinner-style")){const e=document.createElement("style");e.id="pdf-spinner-style",e.innerHTML="@keyframes spin { 0% { transform: rotate(0deg);} 100% { transform: rotate(360deg);} }",document.head.appendChild(e)}}}async function Ze(m,e){return new Promise(async t=>{if(!window.Papa)try{await E.loadScript("https://cdn.jsdelivr.net/npm/papaparse@5.4.1/papaparse.min.js")}catch(i){console.error("Failed to load PapaParse:",i),t(null);return}const o=JSON.parse(localStorage.getItem("selection")||"[]"),s=JSON.parse(localStorage.getItem(j.STORAGE_KEYS.SELECTED_PRODUCTS)||"[]");let n=[];if(s.length>0?n=s.map(i=>({...i.product,Room:i.room,Notes:i.notes,Quantity:i.quantity,Timestamp:new Date(i.timestamp).toISOString()})):n=o,!n.length){t(null);return}setTimeout(()=>{const i=n.map(r=>{let a,c,l,d;const u=m.excludePrice;let g=0;if(r.UserEditedPrice!==void 0&&r.UserEditedPrice!==null&&r.UserEditedPrice!=="")g=parseFloat(r.UserEditedPrice.toString().replace(/,/g,""));else{const f=r.RRP_EX||r["RRP EX GST"]||r.RRP_EX||r.RRP_EXGST||"";g=parseFloat((f||"0").toString().replace(/,/g,""))}a=g,l="Price ea ex GST",d="Price Total ex GST",c=!isNaN(a)&&a>=0?(a*(r.Quantity||1)).toFixed(2):"";const h=r["WELS STAR"]||r.WELS_STAR||r.WELS_STAR||r.WelsStar||"",p=h&&h.toString().trim()?h.toString().replace(/[^\d.]/g,"").trim():"",y={Code:ae(r.OrderCode||""),Description:ae(r.Description||""),"WELS Star":ae(p),Quantity:r.Quantity||1,Notes:ae(r.Notes||""),Room:ae(r.Room||""),"Image URL":ae(r.Image_URL||""),"Diagram URL":ae(r.Diagram_URL||""),"Datasheet URL":ae(r.Datasheet_URL||""),"Website URL":ae(r.Website_URL||"")};return y[l]=u?"0.00":a>=0?a.toFixed(2):"",y[d]=u?"0.00":c,y});setTimeout(()=>{const r=window.Papa.unparse(i,{quotes:!0,quoteChar:'"',delimiter:",",header:!0,newline:`\r
`,skipEmptyLines:!1,escapeChar:'"',transform:{value(a,c){return typeof a=="string"?a.replace(/\0/g,"").replace(/[\x00-\x08\x0B\x0C\x0E-\x1F]/g,""):a}}});m.sendEmail?setTimeout(()=>{try{const a=btoa(unescape(encodeURIComponent(r)));t({name:e,data:a,contentType:"text/csv",originalSize:r.length,base64Size:a.length})}catch(a){console.error("CSV base64 encoding failed:",a),t(new Blob([r],{type:"text/csv"}))}},0):t(new Blob([r],{type:"text/csv"}))},0)},0)})}function ae(m){return typeof m!="string"&&(m=String(m)),m=m.replace(/\0/g,"").replace(/[\x00-\x08\x0B\x0C\x0E-\x1F]/g,"").replace(/\r?\n|\r/g," ").trim(),m}async function Ht(m,e,t="file"){try{if("showSaveFilePicker"in window){const s=await(await window.showSaveFilePicker({suggestedName:e,types:[{description:`${t} files`,accept:{[m.type]:[`.${e.split(".").pop()}`]}}]})).createWritable();return await s.write(m),await s.close(),!0}}catch(o){console.warn("File System Access API failed:",o)}return!1}function Gt(m,e,t="file"){try{if(m.size>2*1024*1024)return console.warn("File too large for data URI method"),!1;const o=new FileReader;return o.onload=function(s){try{const n=document.createElement("a");n.href=s.target.result,n.download=e,n.style.display="none",document.body.appendChild(n),n.click(),document.body.removeChild(n)}catch(n){console.error("Data URI download failed:",n)}},o.readAsDataURL(m),!0}catch(o){return console.warn("Data URI method failed:",o),!1}}function qt(m,e,t="file"){const o=URL.createObjectURL(m),s=document.createElement("div");s.style.cssText=`
  ...
  `,s.appendChild(n),document.body.appendChild(s),document.getElementById("manual-download-close").onclick=()=>{URL.revokeObjectURL(o),document.body.removeChild(s)},document.getElementById("manual-download-retry").onclick=()=>{URL.revokeObjectURL(o),document.body.removeChild(s),setTimeout(()=>{lt(m,e,t)},1e3)},document.getElementById("copy-url-btn").onclick=()=>{const i=document.getElementById("manual-download-url");i.select(),i.setSelectionRange(0,99999);try{navigator.clipboard.writeText(o).then(()=>{const r=document.getElementById("copy-url-btn");r.textContent="Copied!",r.style.background="#059669",setTimeout(()=>{r.textContent="Copy",r.style.background="#059669"},2e3)}).catch(()=>{document.execCommand("copy");const r=document.getElementById("copy-url-btn");r.textContent="Copied!",setTimeout(()=>r.textContent="Copy",2e3)})}catch{alert("Copy failed. Please select the URL manually and copy it.")}},s.onclick=i=>{i.target===s&&(URL.revokeObjectURL(o),document.body.removeChild(s))},setTimeout(()=>{s.parentElement&&(URL.revokeObjectURL(o),document.body.removeChild(s))},5*60*1e3)}async function lt(m,e,t="file"){try{if(await Wt(m,e))return}catch(o){console.warn("Standard download failed:",o)}await Ht(m,e,t)||Gt(m,e,t)||qt(m,e,t)}function Wt(m,e){return new Promise(t=>{try{const o=URL.createObjectURL(m),s=document.createElement("a");s.href=o,s.download=e,s.style.display="none",document.body.appendChild(s);const n=setTimeout(()=>{i(),t(!1)},3e3),i=()=>{clearTimeout(n),s.parentElement&&document.body.removeChild(s),setTimeout(()=>URL.revokeObjectURL(o),1e3)};s.onclick=()=>{i(),t(!0)},s.click(),setTimeout(()=>{i(),t(!0)},500)}catch(o){console.error("Standard download error:",o),t(!1)}})}function Vt(m){const e=document.createElement("canvas"),t=e.getContext("2d");e.width=Math.min(100,m.width),e.height=Math.min(100,m.height),t.drawImage(m,0,0,e.width,e.height);const s=t.getImageData(0,0,e.width,e.height).data,n=new Set;for(let i=0;i<s.length;i+=4){const r=`${s[i]},${s[i+1]},${s[i+2]}`;n.add(r)}return n.size<1e3}function Xt(m,e){const o=e.getImageData(0,0,m.width,m.height).data;for(let s=3;s<o.length;s+=4)if(o[s]<255)return!0;return!1}function Yt(m,e,t){if(m<=t)return{width:m,height:e};const o=e/m;return{width:t,height:Math.round(t*o)}}function dt(m){return m>25*1024*1024?{compressionLevel:"aggressive",imageQuality:.6,imageMaxWidth:300,removeImages:!1,usePNG:!0,message:"Aggressive compression - maintaining technical diagram clarity"}:m>20*1024*1024?{compressionLevel:"high",imageQuality:.65,imageMaxWidth:350,removeImages:!1,usePNG:!0,message:"High compression - preserving technical diagram details"}:m>15*1024*1024?{compressionLevel:"medium",imageQuality:.7,imageMaxWidth:400,removeImages:!1,usePNG:!0,message:"Medium compression - optimal for technical documentation"}:m>10*1024*1024?{compressionLevel:"light",imageQuality:.75,imageMaxWidth:450,removeImages:!1,usePNG:!0,message:"Light compression - excellent technical diagram quality"}:{compressionLevel:"minimal",imageQuality:.8,imageMaxWidth:500,removeImages:!1,usePNG:!0,message:"Minimal compression - maximum technical diagram quality"}}function Jt(m,e){return m}function Qt(m,e){const t=(m.size/1048576).toFixed(2),o=dt(m.size);if(m.size>15*1024*1024){console.warn(`Large file detected (${t} MB) - exceeds typical email limit, may need email-compatible version`);const s=document.createElement("div");s.style.cssText=`
    ...
    `,s.innerHTML=`
      ...
      ">OK</button>
    `,document.body.appendChild(s),setTimeout(()=>{s.parentElement&&s.remove()},8e3)}else m.size>3*1024*1024;return{size:m.size,sizeInMB:parseFloat(t),settings:o}}function et(m,e="",t=""){console.error("Detailed error:",m);const o={type:Kt(m),message:m.message||"Unknown error",context:e,filename:t,timestamp:new Date().toISOString(),userAgent:navigator.userAgent},s=document.createElement("div");s.style.cssText=`
    position: fixed; top: 0; left: 0; width: 100%; height: 100%; 
  ...
  `,s.appendChild(n),document.body.appendChild(s),document.getElementById("error-close").onclick=()=>{document.body.removeChild(s)},document.getElementById("error-retry").onclick=()=>{document.body.removeChild(s),console.log("Retry requested for:",e)},document.getElementById("error-report").onclick=()=>{oo(o),alert("Error details copied to clipboard. Please send this to support.")},s.onclick=i=>{i.target===s&&document.body.removeChild(s)},o}function Kt(m){var o,s;const e=((o=m.message)==null?void 0:o.toLowerCase())||"",t=((s=m.stack)==null?void 0:s.toLowerCase())||"";return e.includes("network")||e.includes("fetch")?"network":e.includes("permission")||e.includes("denied")?"permission":e.includes("memory")||e.includes("quota")?"memory":e.includes("blob")||e.includes("url")?"download":e.includes("canvas")||e.includes("image")?"rendering":t.includes("jspdf")||e.includes("pdf")?"pdf":"unknown"}function Zt(m){return{network:"Network Connection Error",permission:"Permission Required",memory:"Insufficient Memory",download:"Download Failed",rendering:"Display Error",pdf:"PDF Generation Error",unknown:"Unexpected Error"}[m]||"Error Occurred"}function eo(m,e,t){return{network:"Unable to load required resources. Please check your internet connection and try again.",permission:`Browser permission required to save ${t}. Please allow downloads and try again.`,memory:"Not enough memory to process this large file. Try closing other browser tabs or use fewer products.",download:`Failed to download ${t}. This may be due to browser security settings or storage limitations.`,rendering:"Unable to display product images properly. Some images may be missing from the final output.",pdf:`PDF generation failed while ${e}. The file may be too large or contain problematic data.`,unknown:`An unexpected error occurred while ${e}. Please try again or contact support.`}[m]||"An unknown error has occurred."}function to(m){const e={network:`
      ...
      </div>`};return e[m]||e.unknown}function ut(){const m=navigator.userAgent;return m.includes("Chrome")?"Chrome":m.includes("Firefox")?"Firefox":m.includes("Safari")?"Safari":m.includes("Edge")?"Edge":m.includes("SamsungBrowser")?"Samsung Internet":"Unknown"}function oo(m){const e=`
...
========================
  `.trim();try{navigator.clipboard.writeText(e)}catch(t){console.error("Failed to copy error report:",t)}}let J={totalImages:0,optimizedImages:0,failedImages:0,totalSavings:0};function so(m){let e=0;if(m.length===0)return e.toString();for(let t=0;t<m.length;t++){const o=m.charCodeAt(t);e=(e<<5)-e+o,e=e&e}return Math.abs(e).toString(36)}function tt(){J={totalImages:0,optimizedImages:0,failedImages:0,totalSavings:0}}function no(m=!1){J.totalImages>0}function io(m,e){const t=document.createElement("div");t.style.cssText=`
    position: fixed; top: 0; left: 0; width: 100%; height: 100%; 
    background: rgba(0,0,0,0.8); z-index: 10001; display: flex; 
    align-items: center; justify-content: center; padding: 20px;
  ...
  `,document.body.appendChild(t),setTimeout(()=>{t.parentElement&&t.remove()},8e3)}const ot="fredChatHistory",Ge="fredChatMessages",Re="fredFeedback",xe="fredQuestionLog",Fe=16,U={PROXY_URL:"https://seima-ai-proxy.seima.workers.dev",APP_SECRET:"sk-proj-KRCnI_ABkeaV18bpU1dTOpXWxpKtucw",MODEL:"gpt-4o",MAX_TOKENS:2e3,TEMPERATURE:.2,MAX_CATALOG_RESULTS:60},co=`You are a product specification parser for building/construction projects. Extract ALL product references from the provided text.
...
Return format: [{"code":"...","name":"...","brand":"...","category":"...","quantity":1,"finish":"...","section":"...","specCode":"...","style":"..."}]`;class lo{constructor(){this.conversationHistory=this._loadHistory(),this.isProcessing=!1,this._catalogChecked=!1,this._syncing=!1}async chat(e,t,o=null,s=null){var n,i,r,a,c;if(this.isProcessing)throw new Error("A request is already in progress");this.isProcessing=!0,this._catalogChecked||(this._catalogChecked=!0,this._checkCatalogFreshness());try{const l=[],d=typeof e=="string"?e:((i=(n=e.find)==null?void 0:n.call(e,p=>p.type==="text"))==null?void 0:i.text)||"",u=await this._findRelevantProductsAI(d,t);if(u?l.push({role:"system",content:`SEIMA PRODUCT DATA (${u.count} products):
${u.text}
...
`);return console.log(`PDF text extraction: ${o.numPages} pages, ${s.length} with text, ${n.length} chars total`),n}catch(t){return console.warn("PDF text extraction failed, will use vision API:",t),null}}_fileToBase64(e){return new Promise((t,o)=>{const s=new FileReader;s.onload=()=>t(s.result.split(",")[1]),s.onerror=()=>o(new Error("Failed to read file")),s.readAsDataURL(e)})}_showSpecResults(e){const t=e.filter(u=>["verified","seima-own","alternative","catalog-suggestion"].includes(u.status)),o=e.filter(u=>u.status==="unmatched"||u.status==="ai-suggested"),s=[...new Set(e.map(u=>u.section).filter(Boolean))],n=document.getElementById("spec-results-content");if(!n)return;let i="";if(this._projectMeta){const u=this._projectMeta;[u.name,u.architect,u.builder,u.location].filter(Boolean).length>0&&(i=`<div class="spec-project-meta" style="margin-bottom:12px;padding:8px 12px;background:#f0f9ff;border-radius:6px;border:1px solid #bae6fd;">
    ...
    `}_updateImportCount(){const e=document.querySelectorAll(".spec-row-check:checked").length,t=document.getElementById("spec-add-all-btn");t&&(t.textContent=`Import Selected to Grid (${e})`,t.disabled=e===0)}_importSelectedToGrid(){var r,a;if(!this._specResults)return;const e=document.querySelectorAll(".spec-row-check:checked");let t=0;this.importMode==="override"&&(x.clearAllSelections(),console.log("Cleared all existing data for override mode (spec import)"));const o=new Set;e.forEach(c=>{const l=parseInt(c.dataset.index),d=this._specResults[l];d!=null&&d.section&&o.add(d.section)}),o.forEach(c=>x.addCustomRoom(c)),e.forEach(c=>{var p,y;const l=parseInt(c.dataset.index),d=this._specResults[l];if(!d)return;const u=this._buildSpecNote(d),g=d.section||"Imported";if((d.status==="seima-own"||d.status==="verified")&&d.seimaProduct){const f=d.seimaProduct.OrderCode||d.seimaProduct["Order Code"]||((y=(p=d.seimaMatches)==null?void 0:p[0])==null?void 0:y.SeimaSKU),w=D.findProductByCode(f);if(w){x.addProductToSelection(w,u,g,d.quantity||1),t++;return}}let h=u;if(d.seimaProduct&&d.status!=="seima-own"&&d.status!=="verified"){const f=d.seimaProduct.OrderCode||"",w=d.seimaProduct.ProductName||d.seimaProduct.Description||"";h+=` | SEIMA SUGGESTION: ${f} ${w}`}x.addProductToSelection({OrderCode:"",Description:u,_placeholder:!0},h,g,d.quantity||1),t++});const s=this._specResults.filter(c=>c.status==="seima-own"||c.status==="verified").length,n=this._specResults.length;try{sessionStorage.setItem("tenderImportBanner",JSON.stringify({fileName:((r=this.selectedFile)==null?void 0:r.name)||"Specification",total:n,matched:s,unmatched:n-s,project:((a=this._projectMeta)==null?void 0:a.name)||null,timestamp:Date.now()}))}catch{}const i=document.getElementById("spec-add-all-btn");i&&(i.textContent=`Imported ${t} item${t!==1?"s":""}`,i.disabled=!0),e.forEach(c=>{c.disabled=!0})}_buildSpecNote(e){const t=[];return e.specCode&&t.push(e.specCode),e.name&&t.push(e.name),e.brand&&t.push(e.brand),e.style&&t.push(e.style),e.code&&t.push(`Code: ${e.code}`),e.finish&&t.push(e.finish),t.join(" | ")}_showTenderImportBanner(){var e;try{const t=sessionStorage.getItem("tenderImportBanner");if(!t)return;sessionStorage.removeItem("tenderImportBanner");const o=JSON.parse(t);if(Date.now()-o.timestamp>3e4)return;const s=document.getElementById("tender-import-banner");if(!s)return;const n=o.project||o.fileName;s.innerHTML=`
...
This can be restored later.`))try{const t=await de.deleteSelections([e.id]);t.success?(this.showToast("Selection deleted"),this.fetchAndRenderSelections()):this.showError(t.error||"Failed to delete")}catch(t){this.showError(t.message)}}async restoreSelection(e){try{const t=await de.restoreSelections([e.id]);t.success?(this.showToast("Selection restored"),this.fetchAndRenderSelections()):this.showError(t.error||"Failed to restore")}catch(t){this.showError(t.message)}}showToast(e){const t=document.createElement("div");t.style.cssText=`
    ...
    `;const a=i.querySelector(".toast-close");if(a.onclick=()=>this.dismiss(n),s&&s.callback){const c=i.querySelector(".toast-action");c.onclick=()=>{s.callback(),this.dismiss(n)}}return this.container.appendChild(i),this.toasts.set(n,i),requestAnimationFrame(()=>{i.classList.add("toast-enter")}),o>0&&setTimeout(()=>this.dismiss(n),o),n}dismiss(e){const t=this.toasts.get(e);t&&(t.classList.add("toast-exit"),t.addEventListener("animationend",()=>{t.remove(),this.toasts.delete(e)}))}dismissAll(){this.toasts.forEach((e,t)=>this.dismiss(t))}success(e,t={}){return this.show({message:e,type:"success",...t})}error(e,t={}){return this.show({message:e,type:"error",duration:6e3,...t})}warning(e,t={}){return this.show({message:e,type:"warning",...t})}info(e,t={}){return this.show({message:e,type:"info",...t})}withUndo(e,t,o=5e3){return this.show({message:e,type:"info",duration:o,action:{label:"Undo",callback:t}})}}const ce=new yo;window.toast=ce;class vo{constructor(){this.activeDropdown=null,this.updatePositionHandler=null,document.addEventListener("click",e=>{e.target.closest(".global-search-dropdown")||this.hideDropdown()})}showDropdown(e,t,o,s=!1){this.hideDropdown();const n=document.createElement("ul");n.className="global-search-dropdown";const i=300,r=e.getBoundingClientRect(),a=window.innerWidth,c=window.innerHeight,l=r.width,d=c-r.bottom,u=r.top;let g=!1;d<i&&u>d&&(g=!0);let h;g?h=Math.max(8,r.top-i-8):h=Math.min(c-i-8,r.bottom+8);let p=r.left;p+l>a-8&&(p=a-l-8),p<8&&(p=8);const y={position:"fixed",top:`${h}px`,left:`${p}px`,width:`${l}px`,minWidth:`${l}px`,maxWidth:`${l}px`,background:"#fff",border:"1px solid #d1d5db",borderRadius:"8px",boxShadow:"0 10px 25px -5px rgba(0, 0, 0, 0.15), 0 8px 10px -6px rgba(0, 0, 0, 0.10)",maxHeight:`${i}px`,overflowY:"auto",overflowX:"hidden",zIndex:"10010",listStyle:"none",margin:"0",padding:"4px 0",whiteSpace:"normal",wordWrap:"break-word",display:"block",pointerEvents:"auto",transform:"none",contain:"none",isolation:"isolate"};Object.keys(y).forEach(f=>{n.style.setProperty(f,y[f],"important")}),n.dropdownHeight=i,t.length===0?n.innerHTML='<li style="padding: 12px 16px; color: #6b7280; font-style: italic; background: #fff;">No products found</li>':n.innerHTML=t.map(f=>{if(f._crosshairValidate){const k=f._crosshairValidate,F=k.imageUrl?`<img src="${E.sanitizeInput(k.imageUrl)}" alt="" style="width:32px; height:32px; object-fit:contain; border-radius:4px; margin-right:10px; vertical-align:middle; flex-shrink:0;">`:"";return`<li data-validate-competitor="${E.sanitizeInput(k.competitor)}" data-validate-code="${E.sanitizeInput(k.productCode)}"
      ...
      `;n.push(d),r.forEach(u=>{n.push(this.renderRowHtml(u))})}),e.innerHTML=n.join(""),this.attachSeimaMatchSuggestions()}extractCandidateCodes(e){if(!e||typeof e!="string")return[];const t=new Set,o=[],s=/(?:Code|Part\s*(?:No\.?|Number)|P\/N|Order\s*Code|SKU|Item\s*(?:No\.?|Number)?|#)\s*:?\s*([A-Za-z0-9]{4,14}(?:[.\-][A-Za-z0-9]{2,5})?)/gi;let n;for(;(n=s.exec(e))!==null;){const l=n[1].trim();l&&!t.has(l)&&(t.add(l),o.push(l))}const i=e.split(/\|/).map(l=>l.trim()),r=/^[A-Za-z0-9]{5,14}([.\-][A-Za-z0-9]{2,5})?$/,a=/\d/,c=new Set(["white","stainless","steel","black","grey","gray","chrome","brushed","matte","polished"]);for(const l of i){if(!r.test(l)||!a.test(l))continue;const d=l.toLowerCase();c.has(d)||t.has(l)||(t.add(l),o.push(l))}return o}escapeRegex(e){return String(e).replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}buildPlaceholderHintHtml(e,t){if(!e)return"";let o=E.sanitizeInput(e);if(t.length===0)return o;for(const{code:s,competitor:n,searchCode:i}of t){const r=this.escapeRegex(s),a="(?:(?:Code|Part\\s*(?:No\\.?|Number)|P\\/N|Order\\s*Code|SKU|Item\\s*(?:No\\.?|Number)?|#)\\s*:?\\s*)?",c=new RegExp("("+a+r+")","gi"),l=i??s,d=`<a href="#" class="grid-competitor-code-link" data-competitor="${E.sanitizeInput(n)}" data-code="${E.sanitizeInput(l)}" title="Review in Validator to link to Seima product">$1</a>`;o=o.replace(c,d)}return o}async attachSeimaMatchSuggestions(){var n,i,r,a;const e=document.querySelectorAll(".grid-seima-match-wrap"),t=[...e].filter(c=>{var d;const l=this.gridRows.find(u=>u.id===c.dataset.rowId);return(d=l==null?void 0:l.product)==null?void 0:d._placeholder});if(t.length===0)return;const o=document.getElementById("tender-import-banner");let s=0;if(o&&(o.innerHTML=`
      ...
      `,o.style.display="flex"),!L.isEnabled())try{await L.preload()}catch{}if(!L.isEnabled()){o&&(o.innerHTML=`
        ...
        `,setTimeout(()=>{o&&(o.style.display="none")},8e3));return}for(const c of e){const l=c.dataset.rowId,d=this.gridRows.find(P=>P.id===l);if(!((n=d==null?void 0:d.product)!=null&&n._placeholder))continue;const u=d.product.Description||"",g=this.extractCandidateCodes(u);if(g.length===0)continue;const h=c.closest(".grid-product-cell"),p=h==null?void 0:h.querySelector(".grid-placeholder-hint"),y=[];for(const P of g)try{const C=await L.findCompetitorEntryByCode(P);if(C){const T=C.matchedCode??((i=C.competitorProduct)==null?void 0:i.product_code)??P;y.push({code:P,competitor:C.competitor,searchCode:T})}else console.log(`Crosshair: no competitor match for code "${P}" (row ${l})`)}catch{}if(p&&y.length>0&&(p.innerHTML=this.buildPlaceholderHintHtml(u,y)),!D.isLoaded)continue;let f=null,w="";for(const P of g)try{const C=await L.findSeimaMatches(P);if(((r=C==null?void 0:C.matches)==null?void 0:r.length)>0){const T=String(C.matches[0].SeimaSKU).trim(),k=D.findProductByCode(T);if(k){f=k;const R=(C.competitorProduct||{}).product_name||k.Description||"";w=`${C.competitor}: ${P} → ${T}${R?" – "+R:""}`;break}}}catch{}if((a=d==null?void 0:d.product)!=null&&a._placeholder&&o){s++;const P=Math.round(s/t.length*100),C=o.querySelector("span");C&&(C.textContent=`Cross-referencing ${s}/${t.length} products (${P}%)...`)}if(!f)continue;const v=document.createElement("button");v.type="button",v.className="grid-seima-match-btn";const b=(f.Description||"").trim(),S=b.length>45?b.slice(0,45)+"…":b;v.textContent=`Use Seima match: ${f.OrderCode||""} – ${S}`,v.title=w,v.addEventListener("click",()=>{const P=c.closest(".grid-row"),C=P==null?void 0:P.querySelector(".grid-search-input");C&&this.selectProduct(C,f)}),c.appendChild(v)}if(o){const c=document.querySelectorAll(".grid-seima-match-btn").length;o.innerHTML=`
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="flex-shrink:0">
    ...
    `,document.body.appendChild(s),document.body.appendChild(n);const i=()=>this.closeValidatorModal(o);n.querySelector(".gvm-close").addEventListener("click",i),s.addEventListener("click",i);const r=a=>{a.key==="Escape"&&i()};document.addEventListener("keydown",r),this._validatorModal={overlay:s,modal:n,escHandler:r,competitor:e,productCode:t};try{await L._ensureIndex();const a=await L.getMatches(e),l=(await L.getProducts(e)).find(p=>String(p.product_code)===String(t));if(!l){n.querySelector(".gvm-body").innerHTML=`<div class="gvm-no-matches">Product ${E.sanitizeInput(t)} not found in ${E.sanitizeInput(e)} data.</div>`;return}const d=a.filter(p=>String(p.CompetitorSKU)===String(t)).sort((p,y)=>(p.Rank||99)-(y.Rank||99)),u={Verified:0,Manual:1,Rejected:2,"AI-Suggested":3},g=new Map;for(const p of d){const y=String(p.SeimaSKU),f=g.get(y);(!f||(u[p.Status]??9)<(u[f.Status]??9))&&g.set(y,p)}const h=[...g.values()].sort((p,y)=>(p.Rank||99)-(y.Rank||99));this._renderValidatorModal(l,h,e)}catch(a){console.error("Validator modal load failed:",a),n.querySelector(".gvm-body").innerHTML='<div class="gvm-no-matches">Failed to load data. Check console.</div>'}}_renderValidatorModal(e,t,o){var d;const s=(d=this._validatorModal)==null?void 0:d.modal;if(!s)return;const n=e.product_name||e.product_code,i=e.image_url||e.Image||"",r=u=>E.sanitizeInput(u||"");s.querySelector(".gvm-title").textContent=`${n} — ${o}`;let a;t.length===0?a='<div class="gvm-no-matches">No Seima matches found. Use the search below to add one.</div>':a=t.map(u=>{const g=String(u.SeimaSKU||"").trim(),h=D.findProductByCode(g),p=(h==null?void 0:h.Description)||(h==null?void 0:h.ProductName)||g,y=(h==null?void 0:h.Image_URL)||(h==null?void 0:h.imageUrl)||"",f=(h==null?void 0:h.RRP_INCGST)||(h==null?void 0:h["RRP INC GST"])||"",w=f?`$${Number(f).toLocaleString("en-AU",{minimumFractionDigits:2})}`:"",v=Number(u.Confidence)||0,b=v>=70?"high":v>=40?"med":"low",S=(u.Status||"").toLowerCase().replace(/[\s-]+/g,"-");let P;return u.Status==="Verified"||u.Status==="Manual"?P=`<span class="gvm-status-label gvm-status-verified">✓ Verified</span>
    ...
    `,this._wireValidatorModalActions(e,t,o)}_wireValidatorModalActions(e,t,o){var a;const s=(a=this._validatorModal)==null?void 0:a.modal;if(!s)return;s.querySelectorAll(".gvm-match-card").forEach(c=>{c.addEventListener("click",l=>{if(l.target.closest(".gvm-btn"))return;const d=c.dataset.seimaSku;d&&this._showSeimaDetailInModal(d)})}),s.querySelectorAll(".gvm-btn-verify, .gvm-btn-reject, .gvm-btn-undo").forEach(c=>{c.addEventListener("click",async l=>{l.stopPropagation();const d=c.dataset.sku,u=c.dataset.action,g=u==="verify"?"Verified":"Rejected";c.disabled=!0,c.textContent="…";try{await L.updateMatch(o,String(e.product_code),d,g);const h=t.find(p=>String(p.SeimaSKU)===d);h&&(h.Status=g),this._renderValidatorModal(e,t,o)}catch(h){console.error("Match update failed:",h),c.disabled=!1,c.textContent=u==="verify"?"✓ Verify":"✗ Reject"}})});const n=s.querySelector(".gvm-search-add-input"),i=s.querySelector(".gvm-search-results");if(!n||!i)return;let r;n.addEventListener("input",()=>{clearTimeout(r),r=setTimeout(()=>{this._renderValidatorSeimaSearch(n.value,i,e,t,o)},250)})}_renderValidatorSeimaSearch(e,t,o,s,n){if(!e||e.length<2){t.innerHTML="";return}const i=D.searchProducts(e,20),r=new Set(s.map(l=>String(l.SeimaSKU))),a=i.filter(l=>{const d=String(l.OrderCode||l.Code||"");return d&&!r.has(d)});if(a.length===0){t.innerHTML='<div class="gvm-no-matches">No Seima products found.</div>';return}const c=l=>E.sanitizeInput(l||"");t.innerHTML=a.slice(0,15).map(l=>{const d=l.OrderCode||l.Code||"",u=l.Description||l.ProductName||"",g=l.Image_URL||l.imageUrl||"",h=l.RRP_INCGST||l["RRP INC GST"]||"",p=h?`$${Number(h).toLocaleString("en-AU",{minimumFractionDigits:2})}`:"";return`<div class="gvm-search-result" data-seima-code="${c(d)}">
        ${g?`<img src="${c(g)}" alt="" class="gvm-match-img" onerror="this.outerHTML='<div class=\\'gvm-match-img-placeholder\\'>No img</div>'">`:'<div class="gvm-match-img-placeholder">No img</div>'}
        <div class="gvm-match-info">
    ...
    `,document.body.appendChild(c),document.body.appendChild(l);const d=()=>this._closeSeimaDetailPanel();l.querySelector(".gvm-close").addEventListener("click",d),c.addEventListener("click",d),this._seimaDetailPanel={overlay:c,panel:l}}_closeSeimaDetailPanel(){this._seimaDetailPanel&&(this._seimaDetailPanel.overlay.remove(),this._seimaDetailPanel.panel.remove(),this._seimaDetailPanel=null)}_showProductDetailModal(e){const t=document.querySelector(".grid-product-modal-overlay");t&&t.remove();const o=M=>E.sanitizeInput(M||""),s=e.OrderCode||e.Code||"",n=s?String(parseInt(s,10)):"",i=e.Description||e.ProductName||e["Product Name"]||"",r=e.Image_URL||e.imageUrl||e.Image||"assets/no-image.png",a=e["Long Description"]||e.LongDescription||"",c=e.Range||"",l=e.Group||"",d=e.SubGroup||e.Subgroup||e["Sub Group"]||"",u=e.Finish||"",g=e.Colour||"",h=e.DimX||e["X Dimension (mm)"]||"",p=e.DimY||e["Y Dimension (mm)"]||"",y=e.DimZ||e["Z Dimension (mm)"]||"",f=h&&h!=="0"?`${h} × ${p||0} × ${y||0}mm`:"",w=e.WELS_STAR||e["WELS Star"]||e["WELS STAR"]||"",v=e.RRP_EX||e["RRP EX GST"]||e.RRP_EXGST||"",b=e.RRP_INCGST||e["RRP INC GST"]||"",S=[];c&&S.push(["Range",c]),l&&S.push(["Group",l]),d&&S.push(["Type",d]),u&&S.push(["Finish",u]),g&&g!==u&&S.push(["Colour",g]),f&&S.push(["Dimensions",f]),w&&S.push(["WELS",`${w} star`]);const P=v?`$${parseFloat(v).toLocaleString("en-AU",{minimumFractionDigits:2})} ex GST`:b?`$${parseFloat(b).toLocaleString("en-AU",{minimumFractionDigits:2})} inc GST`:"",C=e.Diagram_URL||e["Diagram URL"]||"",T=e.Datasheet_URL||e["Datasheet URL"]||"",k=e.Website_URL||e["Website URL"]||"",F=[];C&&F.push(`<a href="${o(C)}" target="_blank" rel="noopener" class="grid-pdm-link">Diagram</a>`),T&&F.push(`<a href="${o(T)}" target="_blank" rel="noopener" class="grid-pdm-link">Datasheet</a>`),k&&F.push(`<a href="${o(k)}" target="_blank" rel="noopener" class="grid-pdm-link">View on Website</a>`);const R=document.createElement("div");R.className="grid-product-modal-overlay",R.innerHTML=`
    ...
    `;this.injectSaveDialogStyles(),document.body.insertAdjacentHTML("beforeend",n);const i=document.getElementById("save-dialog"),r=document.getElementById("save-doc-name"),a=document.getElementById("save-notes");r==null||r.focus(),r==null||r.select(),i.querySelectorAll("button[data-action]").forEach(l=>{l.addEventListener("click",async()=>{const d=l.dataset.action;if(d==="cancel"){i.remove();return}const u=(r==null?void 0:r.value.trim())||"Untitled Selection",g=(a==null?void 0:a.value.trim())||"";this.currentSelectionName=u;const h={...this.prepareSelectionData(),documentName:u,notes:g};i.querySelectorAll("button").forEach(p=>p.disabled=!0),l.textContent="Saving...";try{let p;d==="save-update"?p=await pe.updateSelection(this.currentSelectionId,h):(p=await pe.saveSelection(h),p.success&&p.id&&(this.currentSelectionId=p.id)),i.remove(),p.success?(this.hasUnsavedChanges=!1,this.lastSaveTime=new Date,this.updateContextHeader(),ce.success(d==="save-update"?"Selection updated!":"Selection saved!")):ce.error("Failed to save: "+(p.error||"Unknown error"))}catch(p){i.remove(),ce.error("Failed to save: "+p.message)}})}),i.addEventListener("click",l=>{l.target===i&&i.remove()});const c=l=>{l.key==="Escape"&&(i.remove(),document.removeEventListener("keydown",c))};document.addEventListener("keydown",c)}injectSaveDialogStyles(){if(document.getElementById("save-dialog-styles"))return;document.head.insertAdjacentHTML("beforeend",`
      <style id="save-dialog-styles">
        .save-dialog-overlay {
          position: fixed;
          top: 0;
    ...
    `,document.head.appendChild(e)}getSteps(){return[{icon:"logo",title:"Welcome to Product Presenter",text:"Create beautiful PDF presentations of Seima products for your clients in minutes.",features:[]},{icon:"📦",title:"Add Your Products",text:"There are three ways to get started:",features:[{icon:"📁",title:"Import a File",desc:"Upload CSV or Excel files with product codes"},{icon:"📂",title:"Load a Selection",desc:"Continue from a previous saved selection"},{icon:"🔍",title:"Search Products",desc:"Search and add products one by one"}]},{icon:"🏠",title:"Organise by Room",text:"Group products by room or area. Drag to reorder, and easily manage your selection.",features:[{icon:"🎨",title:"Colour-coded",desc:"Rooms are visually distinct for quick reference"},{icon:"📊",title:"Sort Options",desc:"Sort by Room/Group, Product Code, or Product Name"},{icon:"💾",title:"Auto-saves",desc:"Your work is automatically preserved"}]},{icon:"📄",title:"Create Your PDF",text:'Click "Create PDF" to customise and generate a professional presentation with your branding.',features:[{icon:"💰",title:"Pricing Options",desc:"Show RRP, add GST, or hide pricing entirely"},{icon:"📝",title:"Content Control",desc:"Include descriptions and custom notes"},{icon:"📑",title:"Cover Pages",desc:"Add branded cover and appendix pages"}]}]}renderStep(){const e=this.getSteps(),t=e[this.currentStep],o=document.getElementById("onboarding-content"),s=document.getElementById("onboarding-dots"),n=document.getElementById("onboarding-next");if(!o||!s)return;let i="";t.features.length>0&&(i=t.features.map(a=>`
      ...
      ${i}
    `,s.innerHTML=e.map((a,c)=>`<div class="onboarding-dot ${c===this.currentStep?"active":""}"></div>`).join(""),n&&(n.textContent=this.currentStep===e.length-1?"Get Started":"Next")}nextStep(){const e=this.getSteps();this.currentStep<e.length-1?(this.currentStep++,this.renderStep()):this.complete()}complete(){localStorage.setItem(Ue,JSON.stringify({version:it,completedAt:new Date().toISOString()})),this.overlay&&(this.overlay.style.animation="fadeIn 0.2s ease reverse",setTimeout(()=>{this.overlay.remove(),this.overlay=null},200))}reset(){localStorage.removeItem(Ue)}}const pt=new bo;class So{constructor(){this.panel=null,this.messagesContainer=null,this.input=null,this.sendBtn=null,this.isOpen=!1,this._lastUserMessage=null,this._conversationId=null,this._userEmail=null,this._historyOpen=!1}init(){this._createPanel(),this._bindEvents(),this._restoreMessages(),this._initUserEmail()}_createPanel(){const e=document.createElement("div");e.id="ai-chat-panel",e.className="ai-chat-panel",e.innerHTML=`
...
`).filter(d=>d.trim());if(s.length<2)return o;const n=d=>d.split("|").slice(1,-1).map(u=>u.trim()),i=d=>/^\|[\s:|-]+\|$/.test(d.trim());let r=n(s[0]),a=1;s.length>1&&i(s[1])&&(a=2);let c="<thead><tr>"+r.map(d=>`<th>${d}</th>`).join("")+"</tr></thead>",l="<tbody>"+s.slice(a).filter(d=>!i(d)).map(d=>"<tr>"+n(d).map(u=>`<td>${u}</td>`).join("")+"</tr>").join("")+"</tbody>";return`<table class="ai-comparison-table">${c}${l}</table>`}),t=t.replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>"),t=t.replace(/`([^`]+)`/g,"<code>$1</code>"),t=t.replace(/^### (.+)$/gm,"<h4>$1</h4>"),t=t.replace(/^## (.+)$/gm,"<h3>$1</h3>"),t=t.replace(/^- (.+)$/gm,"<li>$1</li>"),t=t.replace(/(<li>.*<\/li>\n?)+/g,o=>`<ul>${o}</ul>`),t=t.replace(/^\d+\. (.+)$/gm,"<li>$1</li>"),t=t.replace(/\n\n/g,"</p><p>"),t=`<p>${t}</p>`,t=t.replace(/<p><\/p>/g,""),t=t.replace(/<p>(<h[34]>)/g,"$1"),t=t.replace(/(<\/h[34]>)<\/p>/g,"$1"),t=t.replace(/<p>(<ul>)/g,"$1"),t=t.replace(/(<\/ul>)<\/p>/g,"$1"),t=t.replace(/<p>(<table)/g,"$1"),t=t.replace(/(<\/table>)<\/p>/g,"$1"),t=t.replace(/\b(\d{6})\b/g,'<button class="ai-add-product-btn" data-code="$1" title="Add $1 to selection">$1 <span class="ai-add-icon">+</span></button>'),t}_getBasePath(){var e;return(((e=document.querySelector("base"))==null?void 0:e.href)||window.location.origin+"/").replace(/\/$/,"")}_getProductImage(e){return e.Image_URL||e.imageUrl||e.Image||`${this._getBasePath()}/assets/no-image.png`}_getProductName(e){return e.Description||e.ProductName||e["Product Name"]||""}_getProductMeta(e){const t=e.Finish||e.Colour||"",o=e.DimX||e["X Dimension (mm)"]||"",s=e.DimY||e["Y Dimension (mm)"]||"",n=e.DimZ||e["Z Dimension (mm)"]||"",i=o&&o!=="0"?`${o} × ${s||0} × ${n||0}mm`:"";return[t,i].filter(Boolean).join("  ·  ")}_getProductPrice(e){const t=e["RRP INC GST"]||e.RRP_INCGST||e["RRP EX GST"]||e.RRP_EXGST||"";return t?`$${parseFloat(t).toLocaleString("en-AU",{minimumFractionDigits:2})}`:""}_injectProductCards(e){const t=e.querySelectorAll(".ai-add-product-btn");if(!t.length)return;const o=this._getBasePath();t.forEach(s=>{const n=s.dataset.code,i=D.findProductByCode(n);if(!i)return;const r=s.closest("li");if(!(r||s.parentElement))return;const c=this._getProductImage(i),l=this._getProductName(i),d=this._getProductMeta(i),u=this._getProductPrice(i),g=document.createElement("div");g.className="ai-product-card",g.dataset.code=n,g.innerHTML=`
    ...
    `,s.querySelectorAll(".ai-feedback-btn").forEach(a=>{a.addEventListener("click",()=>{const c=a.dataset.rating;s.querySelectorAll(".ai-feedback-btn").forEach(l=>l.classList.remove("active")),a.classList.add("active"),this._saveFeedback(t,o,c)})});const r=e.querySelector(".ai-msg-bubble");r?e.insertBefore(s,r.nextSibling):e.appendChild(s)}_saveFeedback(e,t,o){try{const s=this._loadFeedback(),n=s.findIndex(r=>r.id===e),i={id:e,question:this._lastUserMessage||"",answer:(t||"").slice(0,500),rating:o,timestamp:Date.now(),synced:!1};n>=0?s[n]={...s[n],...i}:s.push(i),localStorage.setItem(Re,JSON.stringify(s))}catch{}}_getFeedbackEntry(e){return this._loadFeedback().find(t=>t.id===e)||null}_loadFeedback(){try{const e=localStorage.getItem(Re);if(!e)return[];const t=JSON.parse(e);return Array.isArray(t)?t:[]}catch{return[]}}_escapeHtml(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}_scrollToBottom(){requestAnimationFrame(()=>{this.messagesContainer.scrollTop=this.messagesContainer.scrollHeight})}_persistMessages(){try{const e=[];this.messagesContainer.querySelectorAll(".ai-msg").forEach(t=>{var o,s;t.classList.contains("ai-msg-user")?e.push({role:"user",content:((o=t.querySelector(".ai-msg-bubble"))==null?void 0:o.textContent)||""}):t.classList.contains("ai-msg-assistant")&&!t.querySelector(".ai-msg-thinking")&&e.push({role:"assistant",content:((s=t.querySelector(".ai-msg-bubble"))==null?void 0:s.dataset.rawContent)||"",feedbackId:t.dataset.feedbackId||null})}),localStorage.setItem(Ge,JSON.stringify(e))}catch{}}_restoreMessages(){try{const e=localStorage.getItem(Ge);if(!e)return;const t=JSON.parse(e);if(!Array.isArray(t)||t.length===0)return;const o=this.messagesContainer.querySelector(".ai-chat-welcome");o&&o.remove();for(const n of t)n.role==="user"&&(this._lastUserMessage=n.content),this._addMessage(n.role,n.content,{skipPersist:!0,feedbackId:n.feedbackId||null});const s=document.createElement("div");s.className="ai-chat-restored",s.textContent="Previous conversation restored",this.messagesContainer.prepend(s)}catch{}}_generateId(){return Date.now().toString(36)+Math.random().toString(36).substr(2)}_trackQuestion(e){try{const t=localStorage.getItem(xe),o=t?JSON.parse(t):{},s=e.trim();if(s.length<5)return;o[s]=(o[s]||0)+1,localStorage.setItem(xe,JSON.stringify(o))}catch{}}async _syncFeedback(){try{const e=this._loadFeedback(),t=e.filter(i=>!i.synced),o=localStorage.getItem(xe),s=o?JSON.parse(o):null;if(t.length===0&&!s)return;if((await fetch(`${U.PROXY_URL}/v1/feedback`,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${U.APP_SECRET}`},body:JSON.stringify({entries:t,questionLog:s})})).ok){for(const i of t)i.synced=!0;this._pruneFeedback(e),localStorage.setItem(Re,JSON.stringify(e)),localStorage.removeItem(xe)}}catch{}}_pruneFeedback(e){const t=Date.now()-6048e5;for(let o=e.length-1;o>=0;o--)e[o].synced&&e[o].timestamp<t&&e.splice(o,1)}_clearChat(){le.clearHistory();try{localStorage.removeItem(Re),localStorage.removeItem(xe)}catch{}this._showWelcome()}async _initUserEmail(){var e;try{const{authService:t}=await Dt(async()=>{const{authService:s}=await import("./index-2vJeU4CA.js");return{authService:s}},__vite__mapDeps([0,1,2,3])),o=((e=t.getUser)==null?void 0:e.call(t))||{};this._userEmail=o.email||null}catch{}}async _saveConversation(){var s;if(!this._userEmail)return;const e=[];if(this.messagesContainer.querySelectorAll(".ai-msg").forEach(n=>{var i,r;n.classList.contains("ai-msg-user")?e.push({role:"user",content:((i=n.querySelector(".ai-msg-bubble"))==null?void 0:i.textContent)||""}):n.classList.contains("ai-msg-assistant")&&!n.querySelector(".ai-msg-thinking")&&e.push({role:"assistant",content:((r=n.querySelector(".ai-msg-bubble"))==null?void 0:r.dataset.rawContent)||""})}),e.length<2)return;this._conversationId||(this._conversationId=Date.now().toString(36)+Math.random().toString(36).slice(2,8));const t=((s=e.find(n=>n.role==="user"))==null?void 0:s.content)||"Untitled",o=t.length>50?t.slice(0,47)+"...":t;try{await fetch(`${U.PROXY_URL}/v1/conversations/${this._conversationId}`,{method:"PUT",headers:{"Content-Type":"application/json",Authorization:`Bearer ${U.APP_SECRET}`},body:JSON.stringify({email:this._userEmail,title:o,messages:e})})}catch{}}_startNewConversation(){this._saveConversation(),this._conversationId=null,this._clearChat()}_toggleHistory(e){const t=this.panel.querySelector("#ai-chat-history-panel");this._historyOpen=e!==void 0?e:!this._historyOpen,t.classList.toggle("open",this._historyOpen),this._historyOpen&&this._loadConversationList()}async _loadConversationList(){if(!this._userEmail){this.panel.querySelector("#ai-chat-history-list").innerHTML='<div class="ai-chat-history-empty">Sign in to see conversation history.</div>';return}const e=this.panel.querySelector("#ai-chat-history-list");e.innerHTML='<div class="ai-chat-history-empty">Loading...</div>';try{const t=`${U.PROXY_URL}/v1/conversations?token=${encodeURIComponent(U.APP_SECRET)}&email=${encodeURIComponent(this._userEmail)}`,o=await fetch(t);if(!o.ok)throw new Error("Failed");const n=(await o.json()).conversations||[];if(n.length===0){e.innerHTML='<div class="ai-chat-history-empty">No previous conversations.</div>';return}e.innerHTML=n.map(i=>`
      ...
      `).join(""),e.querySelectorAll(".ai-chat-history-item").forEach(i=>{i.addEventListener("click",()=>this._loadConversation(i.dataset.id))})}catch{e.innerHTML='<div class="ai-chat-history-empty">Failed to load conversations.</div>'}}async _loadConversation(e){try{const t=`${U.PROXY_URL}/v1/conversations/${e}?token=${encodeURIComponent(U.APP_SECRET)}`,o=await fetch(t);if(!o.ok)throw new Error("Failed");const s=await o.json();this._conversationId=e,le.clearHistory(),this.messagesContainer.innerHTML="";const n=this.messagesContainer.querySelector(".ai-chat-welcome");n&&n.remove();for(const r of s.messages||[])r.role==="user"&&(this._lastUserMessage=r.content),this._addMessage(r.role,r.content,{skipPersist:!0}),(r.role==="user"||r.role==="assistant")&&le.conversationHistory.push(r);this._persistMessages(),this._toggleHistory(!1);const i=document.createElement("div");i.className="ai-chat-restored",i.textContent="Conversation restored",this.messagesContainer.prepend(i)}catch{console.error("Failed to load conversation")}}_formatHistoryTime(e){if(!e)return"";const t=new Date(e),s=new Date-t,n=Math.floor(s/864e5);return n===0?"Today":n===1?"Yesterday":n<7?`${n}d ago`:t.toLocaleDateString("en-AU",{day:"numeric",month:"short"})}open(){this.panel.classList.add("open"),this.isOpen=!0,setTimeout(()=>this.input.focus(),300),this._syncFeedback()}close(){this.panel.classList.remove("open"),this.isOpen=!1}toggle(){this.isOpen?this.close():this.open()}}const rt=new So;class xo{constructor(){this.navigationManager=null,this.fileImportManager=new uo,this.productGridManager=new wo,this.isInitialized=!1,ue.log("SeimaScanner application starting",me.INFO)}async init(){var e,t,o;try{ue.log("Initializing application modules",me.INFO),W.configure({googleSheetsUrl:(e=j.PRESENTATION_RECORDING)==null?void 0:e.GOOGLE_SHEETS_URL,email:j.EMAIL}),X.configure({logoSrc:"assets/seima-logo.png",brandName:"Seima",appName:"Product Presenter"});const s=(t=j.PRESENTATION_RECORDING)==null?void 0:t.GOOGLE_SHEETS_URL;if(s&&_t(s).catch(r=>{console.warn("Synonyms preload failed:",(r==null?void 0:r.message)||r)}),(o=j.CROSSHAIR)!=null&&o.ENABLED){const r=W.getCurrentUser();L.configure(j.CROSSHAIR,(r==null?void 0:r.email)||""),L.preload().catch(a=>{console.warn("Crosshair preload failed (user may not be logged in):",a.message)})}this.navigationManager=new zt;const n=we.getCompatibilityReport();ue.log(`Browser compatibility: ${n.score}% (${n.browserName})`,me.INFO),we.shouldShowCompatibilityWarning()&&this.showCompatibilityWarning(),await this.navigationManager.init(),this.fileImportManager.init(),this.setupGlobalEventListeners(),this.productGridManager.init(),rt.init();const i=document.getElementById("ai-chat-trigger");return i&&i.addEventListener("click",()=>rt.toggle()),window.navigationManager=this.navigationManager,window.productGridManager=this.productGridManager,window.browserCompatibility=we,window.downloadWithFallback=je,window.showPdfFormScreen=He,this.isInitialized=!0,ue.log("Seima Scanner initialized successfully",me.INFO),this._dismissLoadingOverlay(),setTimeout(()=>{pt.show()},500),!0}catch(s){return ue.handleError({message:"Failed to initialize application",error:s,category:ze.UI,level:me.CRITICAL,context:"app-init"}),this._dismissLoadingOverlay(),!1}}_dismissLoadingOverlay(){const e=document.getElementById("app-loading-overlay");e&&(e.classList.add("fade-out"),e.addEventListener("transitionend",()=>e.remove(),{once:!0}),setTimeout(()=>e.remove(),400))}showCompatibilityWarning(){const e=we.getCompatibilityReport(),t=e.recommendations;if(t.length===0)return;const o=t.filter(i=>i.type==="critical"),s=e.score<N.get("compatibility.minCompatibilityScore",70);if(o.length===0&&!s)return;const n=document.createElement("div");n.style.cssText=`
    ...
    `,document.body.insertBefore(n,document.body.firstChild)}setupGlobalEventListeners(){window.addEventListener("generatePdf",e=>{const{tipTailSettings:t,...o}=e.detail;jt(),He(o,t||null)}),window.addEventListener("beforeunload",()=>{}),we.features.memoryAPI&&setInterval(()=>{const e=we.memoryInfo;e.memoryPressure==="high"&&console.warn("High memory usage detected:",e)},6e4)}getSelectedProducts(){return x.getSelectedProducts()}clearSelection(){return x.clearAllSelections()}addProduct(e,t,o,s){return x.addProductToSelection(e,t,o,s)}updateSelectionCount(){this.navigationManager&&this.navigationManager.updateSelectionCount()}showError(e){alert(e)}}document.addEventListener("DOMContentLoaded",()=>{window.seimaScanner=new xo,window.seimaScanner.init()});window.addEventListener("DOMContentLoaded",()=>{fetch("./version.txt").then(m=>m.text()).then(m=>{const e=m.trim().split(`
`);if(e.length>0){const o=e[0].split(" - ")[0].trim();window._appVersion=o;const s=document.getElementById("menu-version-footer");s&&(s.textContent=`Ver: ${o}`)}}),Eo(),Po()});function Eo(){const m=document.getElementById("help-btn");m&&m.addEventListener("click",()=>{Co()});const e=document.getElementById("crosshair-btn");e&&e.addEventListener("click",()=>{window.location.href="screens/validator.html"});const t=document.getElementById("landscape-btn");t&&t.addEventListener("click",()=>{window.location.href="screens/landscape.html"});const o=document.getElementById("admin-btn");o&&o.addEventListener("click",()=>{window.location.href="screens/admin.html"});const s=document.getElementById("quick-start-btn");s&&s.addEventListener("click",()=>{pt.showForced()})}function Po(){const m=document.getElementById("user-menu-container"),e=document.getElementById("user-menu-trigger"),t=document.getElementById("user-menu-dropdown"),o=document.getElementById("sign-in-btn"),s=document.getElementById("user-avatar"),n=document.getElementById("user-name-display");function i(c){var l,d,u,g,h,p,y,f,w,v;if(c){(l=j.CROSSHAIR)!=null&&l.ENABLED&&(L.configure(j.CROSSHAIR,c.email||""),L.preload().catch(H=>{console.warn("Crosshair preload after login failed:",H)})),m&&(m.style.display="block"),o&&(o.style.display="none");const b=document.getElementById("crosshair-btn");b&&(b.style.display=(d=j.CROSSHAIR)!=null&&d.ENABLED&&W.isStaffMode()?"":"none");const S=document.getElementById("landscape-btn");S&&(S.style.display=(u=j.CROSSHAIR)!=null&&u.ENABLED&&W.isAdmin()?"":"none");const P=document.getElementById("admin-btn");P&&(P.style.display=W.isAdmin()?"":"none");const C=document.getElementById("staff-divider"),T=(b==null?void 0:b.style.display)!=="none"||(S==null?void 0:S.style.display)!=="none"||(P==null?void 0:P.style.display)!=="none";C&&(C.style.display=T?"":"none");const k=r(c.name);s&&(s.textContent=k),n&&(n.textContent=((g=c.name)==null?void 0:g.split(" ")[0])||"User");const F=(c.email||"").toLowerCase().endsWith("@seima.com.au")&&c.emailVerified===!1;let R=document.getElementById("verify-email-banner");if(F?(R||(R=document.createElement("div"),R.id="verify-email-banner",R.className="verify-email-banner",R.innerHTML=`
            <span>Verify your email to access staff features.</span>
            <button id="verify-email-btn" class="verify-email-btn">Verify now</button>
          `,document.body.insertBefore(R,document.body.firstChild),R.querySelector("#verify-email-btn").addEventListener("click",()=>{X.showVerifyEmail(c.email,()=>{i(W.getCurrentUser()),R==null||R.remove()})})),R.style.display=""):R&&(R.style.display="none"),t){const H=F?`
            ...
            </button>`:"",se=window._appVersion?`Ver: ${window._appVersion}`:"Loading...";t.innerHTML=`
          ...
          <div class="user-menu-footer" id="menu-version-footer" title="Click to view what's new">${se}</div>
        `,(h=document.getElementById("menu-verify-email"))==null||h.addEventListener("click",()=>{t.style.display="none",X.showVerifyEmail(c.email,()=>{var M;i(W.getCurrentUser()),(M=document.getElementById("verify-email-banner"))==null||M.remove()})}),(p=document.getElementById("menu-refresh"))==null||p.addEventListener("click",()=>{t.style.display="none",localStorage.removeItem("productCatalogCsv"),localStorage.removeItem("configPreferences"),localStorage.removeItem("pdfWizardSettings"),Object.keys(localStorage).filter(M=>M.startsWith("crosshair_")).forEach(M=>localStorage.removeItem(M)),window.location.reload()}),(y=document.getElementById("menu-version-footer"))==null||y.addEventListener("click",()=>{t.style.display="none",Io()}),(f=document.getElementById("menu-profile"))==null||f.addEventListener("click",()=>{t.style.display="none",X.showEditProfile(M=>{x.clearUserSettings(),i(M)})}),(w=document.getElementById("menu-password"))==null||w.addEventListener("click",()=>{t.style.display="none",X.showChangePassword()}),(v=document.getElementById("menu-logout"))==null||v.addEventListener("click",()=>{t.style.display="none",x.clearUserSettings(),W.logout(),i(null)})}}else m&&(m.style.display="none"),o&&(o.style.display="block")}function r(c){if(!c)return"?";const l=c.trim().split(" ");return l.length>=2?(l[0][0]+l[l.length-1][0]).toUpperCase():c.substring(0,2).toUpperCase()}function a(c){const l=document.createElement("div");return l.textContent=c||"",l.innerHTML}e&&t&&(e.addEventListener("click",c=>{c.stopPropagation();const l=t.style.display!=="none";t.style.display=l?"none":"block"}),document.addEventListener("click",c=>{m!=null&&m.contains(c.target)||(t.style.display="none")})),o&&o.addEventListener("click",()=>{X.showLogin(c=>{i(c)})}),W.onAuthChange=i,i(W.getCurrentUser())}function Co(){const m=document.getElementById("user-guide-modal"),e=document.getElementById("user-guide-content");if(!m||!e)return;e.innerHTML=ko(),m.style.display="flex";const t=document.getElementById("user-guide-close");t&&(t.onclick=()=>{m.style.display="none"}),m.onclick=s=>{s.target===m&&(m.style.display="none")};const o=s=>{s.key==="Escape"&&(m.style.display="none",document.removeEventListener("keydown",o))};document.addEventListener("keydown",o)}function ko(){return`
  ...
  `}async function Io(){try{const m=document.getElementById("changelog-modal"),e=document.getElementById("changelog-content"),s=(await(await fetch("./version.txt")).text()).trim().split(`
