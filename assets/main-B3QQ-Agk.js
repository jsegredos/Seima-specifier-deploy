import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css                      */import{U as S,g as et,p as dt,a as J,d as xt,P as tt,c as Et,h as Pt,b as Ct,e as It,f as kt,i as Rt,j as Lt,k as Dt,l as Tt,m as Bt,n as X,o as be}from"./pdf-layouts-BRMIE_wk.js";import{C as G,c as j}from"./competitor-service-DrZwBF0n.js";const E={DEBUG:"debug",INFO:"info",WARN:"warn",ERROR:"error",CRITICAL:"critical"},B={NETWORK:"network",DATA:"data",UI:"ui",PDF:"pdf",STORAGE:"storage",COMPATIBILITY:"compatibility",IMPORT:"import",VALIDATION:"validation"};class At{constructor(){this.logs=[],this.maxLogs=1e3,this.enableConsoleLogging=!0,this.enableUserNotifications=!0,this.errorStats=new Map,this.setupGlobalErrorHandlers()}setupGlobalErrorHandlers(){window.addEventListener("error",e=>{var t;e.message&&e.message.includes("ResizeObserver")||this.handleError({message:e.message,filename:e.filename,lineNumber:e.lineno,columnNumber:e.colno,error:e.error,category:B.UI,context:"global",showUser:!((t=e.message)!=null&&t.includes("ResizeObserver"))})}),window.addEventListener("unhandledrejection",e=>{String(e.reason||"").includes("ResizeObserver")||this.handleError({message:`Unhandled promise rejection: ${e.reason}`,error:e.reason,category:B.DATA,context:"promise"})})}handleError(e){const{message:t,error:o,category:s=B.UI,context:n="unknown",level:r=E.ERROR,showUser:i=!0}=e,a={id:this.generateErrorId(),timestamp:new Date().toISOString(),message:t,category:s,context:n,level:r,stack:(o==null?void 0:o.stack)||new Error().stack,userAgent:navigator.userAgent,url:window.location.href,additionalInfo:this.gatherAdditionalInfo(o)};return this.log(a),this.updateErrorStats(s),i&&this.enableUserNotifications&&r!==E.DEBUG&&this.showUserNotification(a),r===E.CRITICAL&&this.attemptRecovery(a),a.id}log(e,t=E.INFO){const o=typeof e=="string"?{message:e,level:t,timestamp:new Date().toISOString()}:e;this.logs.push(o),this.logs.length>this.maxLogs&&this.logs.shift(),this.enableConsoleLogging&&this.consoleLog(o),(t===E.ERROR||t===E.CRITICAL)&&this.persistCriticalLog(o)}consoleLog(e){const{level:t,message:o,category:s,context:n}=e,r=`[${t.toUpperCase()}]${s?` [${s}]`:""}${n?` [${n}]`:""}`;switch(t){case E.DEBUG:console.debug(r,o,e);break;case E.INFO:console.info(r,o);break;case E.WARN:console.warn(r,o,e);break;case E.ERROR:case E.CRITICAL:console.error(r,o,e);break;default:console.log(r,o)}}showUserNotification(e){const{message:t,category:o,level:s}=e,n=this.generateUserFriendlyMessage(t,o);s!==E.CRITICAL?this.showToast(n,s):this.showErrorModal(n,e)}showToast(e,t){const o=document.createElement("div");o.className=`error-toast error-toast--${t}`,o.style.cssText=`
      position: fixed;
      top: 20px;
      right: 20px;
      z-index: 10000;
      ...
      background: ${t===E.ERROR?"#fee":t===E.WARN?"#fef3c7":"#e0f2fe"};
      border-left: 4px solid ${t===E.ERROR?"#dc2626":t===E.WARN?"#f59e0b":"#0ea5e9"};
      color: ${t===E.ERROR?"#7f1d1d":t===E.WARN?"#92400e":"#0c4a6e"};
    `,o.innerHTML=`
      <div style="display: flex; align-items: flex-start; gap: 8px;">
        <span style="font-size: 16px;">${t===E.ERROR?"❌":t===E.WARN?"⚠️":"ℹ️"}</span>
    ...
    `,document.body.appendChild(o),setTimeout(()=>o.style.transform="translateX(0)",100);const s=t===E.ERROR?8e3:5e3;setTimeout(()=>{o.parentElement&&(o.style.transform="translateX(100%)",setTimeout(()=>o.remove(),300))},s)}showErrorModal(e,t){const o=document.createElement("div");o.style.cssText=`
...
`).filter(i=>i.trim()!==""),n=s.length>0?s[s.length-1]:"Unknown",r=n.split(" - ")[0]||n;o.innerText=r,o.innerText.trim()||(o.innerText="v2.1.0")}}else throw new Error("Version file not found")}catch{const t=document.getElementById("version-number");if(t){const o=k.get("app.version")||"v2.1.0";t.innerText=o}else setTimeout(()=>{const o=document.getElementById("version-number");if(o&&!o.innerText.trim()){const s=k.get("app.version")||"v2.1.0";o.innerText=s}},1e3);console.info("Version loaded from config (GitHub Pages mode)")}}async showProductLookupScreen(){try{const t=await(await fetch("./screens/product-grid.html")).text();document.body.innerHTML=t,this.currentScreen="product-grid";const o=document.createElement("script");o.type="module",o.src="js/app.js",document.body.appendChild(o),setTimeout(()=>{document.querySelectorAll(".back-btn").forEach(s=>s.remove())},100),window.productGridManager&&window.productGridManager.init(),await this.loadVersion(),setTimeout(()=>this.loadVersion(),1e3)}catch(e){console.error("Failed to load product grid screen:",e)}}setupSplitInterface(){const e=document.getElementById("back-to-home");e&&(e.onclick=()=>location.reload());const t=document.getElementById("download-btn"),o=document.getElementById("clear-all-btn");t&&(t.onclick=()=>this.showDownloadFormModal()),o&&(o.onclick=()=>this.showClearConfirmModal()),this.setupSplitProductSearch(),this.setupReviewTable(),this.renderReviewTable(),this.loadInitialSearchResults()}setupSplitProductSearch(){const e=document.getElementById("product-search-input"),t=document.getElementById("search-results-list"),o=document.getElementById("search-loading"),s=document.getElementById("search-no-results");if(!e||!t)return;const n=[],r=S.debounce(i=>{this.performSplitProductSearch(i,t,n,o,s)},200);e.addEventListener("input",()=>{const i=e.value.trim();i?r(i):this.loadInitialSearchResults()}),t.addEventListener("click",i=>{const a=i.target.closest(".result-item");if(!a)return;const c=parseInt(a.getAttribute("data-idx"),10),l=n.length>0?n:this.currentSearchResults||[];!isNaN(c)&&l[c]&&this.showSplitProductDetails(l[c])})}performSplitProductSearch(e,t,o,s,n){if(!$.isLoaded){s.style.display="flex",n.style.display="none",t.innerHTML="";return}o.length=0,o.push(...$.searchProducts(e)),s.style.display="none",o.length===0?(n.style.display="flex",t.innerHTML=""):(n.style.display="none",t.innerHTML=o.map((r,i)=>`
        ...
        `).join(""))}async loadInitialSearchResults(){const e=document.getElementById("search-results-list"),t=document.getElementById("search-loading"),o=document.getElementById("search-no-results");if(!e)return;if(!$.isLoaded){t.style.display="flex",o.style.display="none",e.innerHTML="",setTimeout(()=>this.loadInitialSearchResults(),500);return}const s=$.getAllProducts().slice(0,50);t.style.display="none",o.style.display="none",e.innerHTML=s.map((n,r)=>`
    ...
    `,document.body.appendChild(o),_e("./assets/seima-logo.png",(n,r,i)=>{const a=JSON.parse(localStorage.getItem("selection")||"[]"),c=JSON.parse(localStorage.getItem(G.STORAGE_KEYS.SELECTED_PRODUCTS)||"[]");let l=[];c.length>0?l=c.map(m=>({...m.product,Room:m.room,Notes:m.notes,Quantity:m.quantity,Timestamp:new Date(m.timestamp).toISOString()})):l=a;const d=document.getElementById("sort-by"),p=d?d.value:"room";switch(p){case"code":l.sort((m,v)=>{const P=m.OrderCode||m.Code||"",I=v.OrderCode||v.Code||"";return P.localeCompare(I)});break;case"product":l.sort((m,v)=>{const P=m.Description||m.ProductName||"",I=v.Description||v.ProductName||"";return P.localeCompare(I)});break;case"room":default:l.sort((m,v)=>{const P=m.Room||"Blank",I=v.Room||"Blank";return P.localeCompare(I)});break}if(!l.length){alert("No products selected."),t&&(t.style.display="none");return}if(et()>0)console.log(`📷 Using ${et()} pre-cached images (skipping duplicate preload)`);else{const m=document.getElementById("pdf-processing-notification");if(m){const v=document.createElement("span");v.id="preload-progress",v.style.cssText="display: block; font-size: 12px; margin-top: 8px; color: #1e40af;",v.textContent="Loading images: 0%",m.appendChild(v)}console.log("📷 Starting image preload for",l.length,"products"),dt(l).then(v=>{const P=document.getElementById("preload-progress");P&&(P.textContent=`✓ ${v} images ready`,P.style.color="#059669")}).catch(v=>{console.warn("Image preloading error:",v)})}const f={};p==="room"?l.forEach(m=>{const v=m.Room||"Blank";f[v]||(f[v]=[]),f[v].push(m)}):f.__all__=l;const{jsPDF:y}=window.jspdf,w=new y({orientation:"landscape",unit:"pt",format:"a4",compress:!0,putOnlyUsedFonts:!0,precision:16,userUnit:1,floatPrecision:16}),g=w.internal.pageSize.getWidth(),x=w.internal.pageSize.getHeight();_e("./assets/seima-logo.png",(m,v,P)=>{const I=J.getCurrentUser(),H=b.getUserSettings(),_=I?{name:I.name,email:I.email,phone:I.phone,position:I.position}:H,A=localStorage.getItem("customerLogo");xt(w,{pageWidth:g,pageHeight:x,seimaLogoDataUrl:m,seimaLogoNaturalW:v,seimaLogoNaturalH:P,customerLogoDataUrl:A,userDetails:u,staffContact:_,footerHeight:tt.footerHeight}),w.addPage(),_e("./assets/seima-logo-white.png",(se,ue,pe)=>{const yt=u.showRrp&&!u.excludePrice,Je=!u.excludePrice,Xe=!u.excludeQty,wt=Et(g,{leftMargin:32,rightMargin:32,showRrp:yt,showPrice:Je,showQty:Xe,showTotal:Je&&Xe}),{colX:me,colW:Se,headers:Ae}=wt,Ce=tt.footerHeight;nt();const Qe=(R,C,z,Q,F,U,T)=>{if(!C||typeof C!="string"||C.length<10||!C.startsWith("http://")&&!C.startsWith("https://")&&!C.startsWith("data:")){T&&T();return}if((L=>{if(!L||L.length<25||/\/images\/\d+$/.test(L)||L.endsWith("/0"))return!0;const D=/\.(jpg|jpeg|png|gif|webp|svg)(\?.*)?$/i.test(L),N=L.startsWith("data:");return!D&&!N})(C)){console.warn("Skipping malformed image URL:",(C==null?void 0:C.substring(0,50))+"..."),T&&T();return}if(Y.totalImages++,u.emailCompatible){Y.failedImages++,T&&T();return}const K=Rt(C);if(K&&K.dataUrl)try{const L=K.width/K.height;let D=F,N=F/L;N>U&&(N=U,D=U*L),R.addImage(K.dataUrl,K.format,z,Q,D,N,void 0,"FAST"),Y.optimizedImages++,T&&T();return}catch{console.warn("Failed to use cached image, falling back to direct load")}let ne=!1;const ge=["https://wsrv.nl/?url=","https://images.weserv.nl/?url=","https://api.codetabs.com/v1/proxy?quest="];let Z=0;function ee(){if(ne)return;const L=new Image;L.crossOrigin="Anonymous";let D=null;L.onload=function(){if(!ne){ne=!0,D&&clearTimeout(D);try{const re=mt(0),Le=re.imageMaxWidth,ve=F,te=U;try{const M=document.createElement("canvas"),q=M.getContext("2d"),{width:V,height:Ze}=Zt(L.width,L.height,Le);M.width=V,M.height=Ze,q.imageSmoothingEnabled=!0,q.imageSmoothingQuality="high",q.drawImage(L,0,0,V,Ze);let Fe,Oe="JPEG";const vt=Kt(M,q),bt=Qt(L);vt||bt?(Fe=M.toDataURL("image/png",re.imageQuality),Oe="PNG"):(Fe=M.toDataURL("image/jpeg",re.imageQuality),Oe="JPEG");const St=`img_${ao(C)}`;R.addImage(Fe,Oe,z,Q,ve,te,St,"FAST"),Y.optimizedImages++,T&&T()}catch(M){console.warn(`Failed to optimize image: ${C}`,M),console.warn("Error details:",M.message,M.stack);try{R.addImage(L,"JPEG",z,Q,ve,te),Y.optimizedImages++,T&&T()}catch(q){console.error(`Fallback also failed for: ${C}`,q),Y.failedImages++,T&&T()}}}catch(re){console.warn("Failed to add image to PDF:",re),Y.failedImages++,T&&T()}}},L.onerror=function(){ne||(D&&clearTimeout(D),console.warn(`Failed to load image with proxy ${Z}: ${C}`),console.warn(`Error details for: ${C} - Proxy: ${ge[Z]}`),Z++,Z<ge.length?setTimeout(()=>{ee()},200):(ne=!0,console.warn("All proxies failed, skipping image"),Y.failedImages++,T&&T()))},D=setTimeout(()=>{ne||(console.warn(`⏰ Timeout with proxy ${Z}: ${C}`),L.src="",L.onload=null,L.onerror=null,Z++,Z<ge.length?setTimeout(()=>{ee()},200):(ne=!0,console.warn("All proxies timed out, skipping image"),Y.failedImages++,T&&T()))},3e3);let N=C;Z<ge.length&&(N=ge[Z]+encodeURIComponent(C)),L.src=N}ee()},W=[];Object.keys(f).forEach((R,C)=>{const z=f[R];if(!z||!Array.isArray(z)){console.warn("⚠️ Skipping invalid room items:",R,z);return}z.forEach((Q,F)=>{if(!Q){console.warn("⚠️ Skipping null item in room:",R,"at index:",F);return}W.push({item:Q,room:R,rIdx:C,iIdx:F,isFirstInRoom:F===0,roomCount:z.length})})}),W.reduce((R,C)=>{if(!C||!C.item)return console.warn("⚠️ Skipping null row in data analysis:",C),R;const z=String(C.item.Description||""),Q=String(C.item.LongDescription||""),F=String(C.item.Notes||""),U=String(C.item.OrderCode||"");return R+z.length+Q.length+F.length+U.length},0);let xe=0,Ie=0;const ke=4,Re=8,Ne=Math.floor((x-80)/ke);let Ke=Ce+8;function $e(){if(!W||!Array.isArray(W)){console.error("❌ Critical error: rowsToDraw is not a valid array:",W),st(new Error("Invalid product data structure"),"generating PDF","unknown.pdf");return}if(xe>=W.length){const F=w.internal.getNumberOfPages()-1;for(let D=2;D<=F+1;D++){w.setPage(D);const re=(D-2)*ke,Le=Math.min(re+ke,W.length);let ve=!1;for(let te=re;te<Le;te++)if(W[te]&&W[te].item&&Pt(W[te].item)){ve=!0;break}Ct(w,{pageWidth:g,colX:me,colW:Se,leftMargin:32,footerHeight:Ce,logoDataUrl:se,logoNaturalW:ue,logoNaturalH:pe,headers:Ae,userDetails:u,skipWelsHeader:!ve}),It(w,{pageWidth:g,pageHeight:x,leftMargin:32,footerHeight:Ce,pageNumber:D-1,totalPages:F})}const U=new Date,T=String(U.getDate()).padStart(2,"0"),he=String(U.getMonth()+1).padStart(2,"0"),K=String(U.getFullYear()).slice(-2),ne=String(U.getHours()).padStart(2,"0"),ge=String(U.getMinutes()).padStart(2,"0"),ee=`${u.project.replace(/[^a-zA-Z0-9\s]/g,"")}-${T}${he}${K}.${ne}${ge}.pdf`,L=document.getElementById("pdf-processing-notification");L&&L.remove(),co(u.emailCompatible);try{const D=w.output("blob"),N=w.output("string"),re=N?N.match(/\/Type\s*\/XObject/g):null,Le=N?N.match(/Tj\s/g):null,ve=N?N.match(/\/A\s*<</g):null;u.pdfSize=D.size;const te=to(D,ee);if(u.sendEmail&&D.size>15*1024*1024){console.warn(`❌ PDF too large for email (${(D.size/1024/1024).toFixed(1)}MB), offering email-compatible version`),lo(u,ee);return}const M=eo(D,te.settings);if(u.sendEmail&&u.email)if(u.exportCsv){const q=ee.replace(/\.pdf$/,".csv");ot(u,q).then(V=>{window.dispatchEvent(new CustomEvent("sendEmail",{detail:{userDetails:u,pdfBlob:M,csvBlob:V}}))}).catch(V=>{console.error("Async CSV generation for email failed:",V),window.dispatchEvent(new CustomEvent("sendEmail",{detail:{userDetails:u,pdfBlob:M,csvBlob:null}}))})}else window.dispatchEvent(new CustomEvent("sendEmail",{detail:{userDetails:u,pdfBlob:M,csvBlob:null}}));else if((async()=>{const q=await po(M);qe(q,ee,"PDF")})(),u.exportCsv){const q=ee.replace(/\.pdf$/,".csv");setTimeout(()=>{ot(u,q).then(V=>{V&&qe(V,q,"CSV")}).catch(V=>{console.error("CSV generation failed:",V)})},1e3)}}catch(D){console.error("PDF generation failed:",D),st(D,"generating PDF",ee);const N=document.getElementById("pdf-processing-notification");N&&N.remove()}t&&(t.style.display="none");return}Ie>=ke&&(w.addPage(),Ke=Ce+8,Ie=0);const R=W[xe];if(!R||!R.item){console.warn(`⚠️  Skipping invalid row at index ${xe}:`,R),xe++,$e();return}const C=Ke+Ne*Ie;R.isFirstInRoom&&p==="room"&&R.room!=="__all__"&&kt(w,R.room,R.roomCount,32,C);const z=me[0],Q=z+90+12;Qe(w,R.item.Image_URL||"",z,C+Re+16,90,Ne-Re*2,()=>{Qe(w,R.item.Diagram_URL||"",Q,C+Re+16,90,Ne-Re*2,()=>{const F=C+28,U=me[1]+Se[1]/2;w.setFontSize(10),w.setTextColor("#222"),w.text(String(R.item.OrderCode||""),U,F+10,{align:"center"}),Lt(w,R.item,U,F+35);const T=Se[2]-10;Dt(w,R.item,me[2],F+10,T,u.excludeLongDescription);const he=Ae.indexOf("WELS")+1;if(he>0&&me[he]){const K=me[he]+Se[he]/2;Tt(w,R.item,K,F+10)}Bt(w,R.item,me,Se,Ae,F+10,{excludePrice:u.excludePrice,includeGst:u.includeGst}),xe++,Ie++,$e()})})}$e()})})})}function _e(u,e){const t=new window.Image;t.crossOrigin="Anonymous",t.onload=function(){const o=document.createElement("canvas"),s=o.getContext("2d"),n=400,r=150;let i=t.width,a=t.height;if(i>n||a>r){const l=n/i,d=r/a,p=Math.min(l,d);i=Math.round(i*p),a=Math.round(a*p)}o.width=i,o.height=a,s.imageSmoothingEnabled=!0,s.imageSmoothingQuality="high",s.drawImage(t,0,0,i,a);const c=o.toDataURL("image/png",.9);e(c,i,a)},t.src=u}function Wt(){if(!document.getElementById("pdf-spinner")){const u=document.createElement("div");if(u.id="pdf-spinner",u.style.display="none",u.style.position="fixed",u.style.top="0",u.style.left="0",u.style.width="100vw",u.style.height="100vh",u.style.zIndex="9999",u.style.background="rgba(255,255,255,0.7)",u.style.alignItems="center",u.style.justifyContent="center",u.innerHTML='<div style="border:6px solid #e0e0e0;border-top:6px solid #2563eb;border-radius:50%;width:54px;height:54px;animation:spin 1s linear infinite;"></div>',document.body.appendChild(u),!document.getElementById("pdf-spinner-style")){const e=document.createElement("style");e.id="pdf-spinner-style",e.innerHTML="@keyframes spin { 0% { transform: rotate(0deg);} 100% { transform: rotate(360deg);} }",document.head.appendChild(e)}}}async function ot(u,e){return new Promise(async t=>{if(!window.Papa)try{await S.loadScript("https://cdn.jsdelivr.net/npm/papaparse@5.4.1/papaparse.min.js")}catch(r){console.error("Failed to load PapaParse:",r),t(null);return}const o=JSON.parse(localStorage.getItem("selection")||"[]"),s=JSON.parse(localStorage.getItem(G.STORAGE_KEYS.SELECTED_PRODUCTS)||"[]");let n=[];if(s.length>0?n=s.map(r=>({...r.product,Room:r.room,Notes:r.notes,Quantity:r.quantity,Timestamp:new Date(r.timestamp).toISOString()})):n=o,!n.length){t(null);return}setTimeout(()=>{const r=n.map(i=>{let a,c,l,d;const p=u.excludePrice;let h=0;if(i.UserEditedPrice!==void 0&&i.UserEditedPrice!==null&&i.UserEditedPrice!=="")h=parseFloat(i.UserEditedPrice.toString().replace(/,/g,""));else{const g=i.RRP_EX||i["RRP EX GST"]||i.RRP_EX||i.RRP_EXGST||"";h=parseFloat((g||"0").toString().replace(/,/g,""))}a=h,l="Price ea ex GST",d="Price Total ex GST",c=!isNaN(a)&&a>=0?(a*(i.Quantity||1)).toFixed(2):"";const f=i["WELS STAR"]||i.WELS_STAR||i.WELS_STAR||i.WelsStar||"",y=f&&f.toString().trim()?f.toString().replace(/[^\d.]/g,"").trim():"",w={Code:ie(i.OrderCode||""),Description:ie(i.Description||""),"WELS Star":ie(y),Quantity:i.Quantity||1,Notes:ie(i.Notes||""),Room:ie(i.Room||""),"Image URL":ie(i.Image_URL||""),"Diagram URL":ie(i.Diagram_URL||""),"Datasheet URL":ie(i.Datasheet_URL||""),"Website URL":ie(i.Website_URL||"")};return w[l]=p?"0.00":a>=0?a.toFixed(2):"",w[d]=p?"0.00":c,w});setTimeout(()=>{const i=window.Papa.unparse(r,{quotes:!0,quoteChar:'"',delimiter:",",header:!0,newline:`\r
`,skipEmptyLines:!1,escapeChar:'"',transform:{value(a,c){return typeof a=="string"?a.replace(/\0/g,"").replace(/[\x00-\x08\x0B\x0C\x0E-\x1F]/g,""):a}}});u.sendEmail?setTimeout(()=>{try{const a=btoa(unescape(encodeURIComponent(i)));t({name:e,data:a,contentType:"text/csv",originalSize:i.length,base64Size:a.length})}catch(a){console.error("CSV base64 encoding failed:",a),t(new Blob([i],{type:"text/csv"}))}},0):t(new Blob([i],{type:"text/csv"}))},0)},0)})}function ie(u){return typeof u!="string"&&(u=String(u)),u=u.replace(/\0/g,"").replace(/[\x00-\x08\x0B\x0C\x0E-\x1F]/g,"").replace(/\r?\n|\r/g," ").trim(),u}async function Vt(u,e,t="file"){try{if("showSaveFilePicker"in window){const s=await(await window.showSaveFilePicker({suggestedName:e,types:[{description:`${t} files`,accept:{[u.type]:[`.${e.split(".").pop()}`]}}]})).createWritable();return await s.write(u),await s.close(),!0}}catch(o){console.warn("File System Access API failed:",o)}return!1}function Yt(u,e,t="file"){try{if(u.size>2*1024*1024)return console.warn("File too large for data URI method"),!1;const o=new FileReader;return o.onload=function(s){try{const n=document.createElement("a");n.href=s.target.result,n.download=e,n.style.display="none",document.body.appendChild(n),n.click(),document.body.removeChild(n)}catch(n){console.error("Data URI download failed:",n)}},o.readAsDataURL(u),!0}catch(o){return console.warn("Data URI method failed:",o),!1}}function Jt(u,e,t="file"){const o=URL.createObjectURL(u),s=document.createElement("div");s.style.cssText=`
    position: fixed; top: 0; left: 0; width: 100%; height: 100%; 
    background: rgba(0,0,0,0.8); z-index: 10001; display: flex; 
    align-items: center; justify-content: center; padding: 20px;
  ...
  `,s.appendChild(n),document.body.appendChild(s),document.getElementById("manual-download-close").onclick=()=>{URL.revokeObjectURL(o),document.body.removeChild(s)},document.getElementById("manual-download-retry").onclick=()=>{URL.revokeObjectURL(o),document.body.removeChild(s),setTimeout(()=>{pt(u,e,t)},1e3)},document.getElementById("copy-url-btn").onclick=()=>{const r=document.getElementById("manual-download-url");r.select(),r.setSelectionRange(0,99999);try{navigator.clipboard.writeText(o).then(()=>{const i=document.getElementById("copy-url-btn");i.textContent="Copied!",i.style.background="#059669",setTimeout(()=>{i.textContent="Copy",i.style.background="#059669"},2e3)}).catch(()=>{document.execCommand("copy");const i=document.getElementById("copy-url-btn");i.textContent="Copied!",setTimeout(()=>i.textContent="Copy",2e3)})}catch{alert("Copy failed. Please select the URL manually and copy it.")}},s.onclick=r=>{r.target===s&&(URL.revokeObjectURL(o),document.body.removeChild(s))},setTimeout(()=>{s.parentElement&&(URL.revokeObjectURL(o),document.body.removeChild(s))},5*60*1e3)}async function pt(u,e,t="file"){try{if(await Xt(u,e))return}catch(o){console.warn("Standard download failed:",o)}await Vt(u,e,t)||Yt(u,e,t)||Jt(u,e,t)}function Xt(u,e){return new Promise(t=>{try{const o=URL.createObjectURL(u),s=document.createElement("a");s.href=o,s.download=e,s.style.display="none",document.body.appendChild(s);const n=setTimeout(()=>{r(),t(!1)},3e3),r=()=>{clearTimeout(n),s.parentElement&&document.body.removeChild(s),setTimeout(()=>URL.revokeObjectURL(o),1e3)};s.onclick=()=>{r(),t(!0)},s.click(),setTimeout(()=>{r(),t(!0)},500)}catch(o){console.error("Standard download error:",o),t(!1)}})}function Qt(u){const e=document.createElement("canvas"),t=e.getContext("2d");e.width=Math.min(100,u.width),e.height=Math.min(100,u.height),t.drawImage(u,0,0,e.width,e.height);const s=t.getImageData(0,0,e.width,e.height).data,n=new Set;for(let r=0;r<s.length;r+=4){const i=`${s[r]},${s[r+1]},${s[r+2]}`;n.add(i)}return n.size<1e3}function Kt(u,e){const o=e.getImageData(0,0,u.width,u.height).data;for(let s=3;s<o.length;s+=4)if(o[s]<255)return!0;return!1}function Zt(u,e,t){if(u<=t)return{width:u,height:e};const o=e/u;return{width:t,height:Math.round(t*o)}}function mt(u){return u>25*1024*1024?{compressionLevel:"aggressive",imageQuality:.6,imageMaxWidth:300,removeImages:!1,usePNG:!0,message:"Aggressive compression - maintaining technical diagram clarity"}:u>20*1024*1024?{compressionLevel:"high",imageQuality:.65,imageMaxWidth:350,removeImages:!1,usePNG:!0,message:"High compression - preserving technical diagram details"}:u>15*1024*1024?{compressionLevel:"medium",imageQuality:.7,imageMaxWidth:400,removeImages:!1,usePNG:!0,message:"Medium compression - optimal for technical documentation"}:u>10*1024*1024?{compressionLevel:"light",imageQuality:.75,imageMaxWidth:450,removeImages:!1,usePNG:!0,message:"Light compression - excellent technical diagram quality"}:{compressionLevel:"minimal",imageQuality:.8,imageMaxWidth:500,removeImages:!1,usePNG:!0,message:"Minimal compression - maximum technical diagram quality"}}function eo(u,e){return u}function to(u,e){const t=(u.size/1048576).toFixed(2),o=mt(u.size);if(u.size>15*1024*1024){console.warn(`Large file detected (${t} MB) - exceeds typical email limit, may need email-compatible version`);const s=document.createElement("div");s.style.cssText=`
    ...
    `,s.innerHTML=`
      ...
      ">OK</button>
    `,document.body.appendChild(s),setTimeout(()=>{s.parentElement&&s.remove()},8e3)}else u.size>3*1024*1024;return{size:u.size,sizeInMB:parseFloat(t),settings:o}}function st(u,e="",t=""){console.error("Detailed error:",u);const o={type:oo(u),message:u.message||"Unknown error",context:e,filename:t,timestamp:new Date().toISOString(),userAgent:navigator.userAgent},s=document.createElement("div");s.style.cssText=`
    position: fixed; top: 0; left: 0; width: 100%; height: 100%; 
  ...
  `,s.appendChild(n),document.body.appendChild(s),document.getElementById("error-close").onclick=()=>{document.body.removeChild(s)},document.getElementById("error-retry").onclick=()=>{document.body.removeChild(s),console.log("Retry requested for:",e)},document.getElementById("error-report").onclick=()=>{io(o),alert("Error details copied to clipboard. Please send this to support.")},s.onclick=r=>{r.target===s&&document.body.removeChild(s)},o}function oo(u){var o,s;const e=((o=u.message)==null?void 0:o.toLowerCase())||"",t=((s=u.stack)==null?void 0:s.toLowerCase())||"";return e.includes("network")||e.includes("fetch")?"network":e.includes("permission")||e.includes("denied")?"permission":e.includes("memory")||e.includes("quota")?"memory":e.includes("blob")||e.includes("url")?"download":e.includes("canvas")||e.includes("image")?"rendering":t.includes("jspdf")||e.includes("pdf")?"pdf":"unknown"}function so(u){return{network:"Network Connection Error",permission:"Permission Required",memory:"Insufficient Memory",download:"Download Failed",rendering:"Display Error",pdf:"PDF Generation Error",unknown:"Unexpected Error"}[u]||"Error Occurred"}function no(u,e,t){return{network:"Unable to load required resources. Please check your internet connection and try again.",permission:`Browser permission required to save ${t}. Please allow downloads and try again.`,memory:"Not enough memory to process this large file. Try closing other browser tabs or use fewer products.",download:`Failed to download ${t}. This may be due to browser security settings or storage limitations.`,rendering:"Unable to display product images properly. Some images may be missing from the final output.",pdf:`PDF generation failed while ${e}. The file may be too large or contain problematic data.`,unknown:`An unexpected error occurred while ${e}. Please try again or contact support.`}[u]||"An unknown error has occurred."}function ro(u){const e={network:`
      ...
      </div>`};return e[u]||e.unknown}function ht(){const u=navigator.userAgent;return u.includes("Chrome")?"Chrome":u.includes("Firefox")?"Firefox":u.includes("Safari")?"Safari":u.includes("Edge")?"Edge":u.includes("SamsungBrowser")?"Samsung Internet":"Unknown"}function io(u){const e=`
...
Return format: [{"code":"...","name":"...","brand":"...","category":"...","quantity":1,"finish":"...","section":"...","specCode":"...","style":"..."}]`;class go{constructor(){this.conversationHistory=this._loadHistory(),this.isProcessing=!1}async chat(e,t,o=null){var s,n,r;if(this.isProcessing)throw new Error("A request is already in progress");this.isProcessing=!0;try{const i=[{role:"system",content:mo}],a=this._findRelevantProducts(e,t);if(a&&i.push({role:"system",content:`SEIMA PRODUCT DATA (${a.count} products):
...
`);return console.log(`PDF text extraction: ${o.numPages} pages, ${n.length} chars`),n}catch(t){return console.warn("PDF text extraction failed, will use vision API:",t),null}}_fileToBase64(e){return new Promise((t,o)=>{const s=new FileReader;s.onload=()=>t(s.result.split(",")[1]),s.onerror=()=>o(new Error("Failed to read file")),s.readAsDataURL(e)})}_showSpecResults(e){const t=e.filter(c=>["verified","seima-own","alternative","catalog-suggestion"].includes(c.status)),o=e.filter(c=>c.status==="unmatched"||c.status==="ai-suggested"),s=[...new Set(e.map(c=>c.section).filter(Boolean))],n=document.getElementById("spec-results-content");if(!n)return;n.innerHTML=`
    ...
    `;document.body.insertAdjacentHTML("beforeend",s);const n=document.getElementById("picker-confirm-dialog");n.querySelectorAll("button[data-action]").forEach(r=>{r.addEventListener("click",()=>{const i=r.dataset.action;n.remove(),i==="replace"?this.loadSelection(e,"replace"):i==="merge"&&this.loadSelection(e,"merge")})}),n.addEventListener("click",r=>{r.target===n&&n.remove()})}async loadSelection(e,t){try{this.setLoadingState(!0);const o=await le.loadSelection(e,t);o.success?(this.hide(),this.showToast(`Loaded ${o.productCount} products (${t})`),this.onLoadCallback&&this.onLoadCallback(o)):this.showError(o.error||"Failed to load selection")}catch(o){this.showError(o.message)}finally{this.setLoadingState(!1)}}async confirmDelete(e){if(confirm(`Delete selection for "${e.customerName||"Unknown"}"?
...
This can be restored later.`))try{const t=await le.deleteSelections([e.id]);t.success?(this.showToast("Selection deleted"),this.fetchAndRenderSelections()):this.showError(t.error||"Failed to delete")}catch(t){this.showError(t.message)}}async restoreSelection(e){try{const t=await le.restoreSelections([e.id]);t.success?(this.showToast("Selection restored"),this.fetchAndRenderSelections()):this.showError(t.error||"Failed to restore")}catch(t){this.showError(t.message)}}showToast(e){const t=document.createElement("div");t.style.cssText=`
    ...
    `;const a=r.querySelector(".toast-close");if(a.onclick=()=>this.dismiss(n),s&&s.callback){const c=r.querySelector(".toast-action");c.onclick=()=>{s.callback(),this.dismiss(n)}}return this.container.appendChild(r),this.toasts.set(n,r),requestAnimationFrame(()=>{r.classList.add("toast-enter")}),o>0&&setTimeout(()=>this.dismiss(n),o),n}dismiss(e){const t=this.toasts.get(e);t&&(t.classList.add("toast-exit"),t.addEventListener("animationend",()=>{t.remove(),this.toasts.delete(e)}))}dismissAll(){this.toasts.forEach((e,t)=>this.dismiss(t))}success(e,t={}){return this.show({message:e,type:"success",...t})}error(e,t={}){return this.show({message:e,type:"error",duration:6e3,...t})}warning(e,t={}){return this.show({message:e,type:"warning",...t})}info(e,t={}){return this.show({message:e,type:"info",...t})}withUndo(e,t,o=5e3){return this.show({message:e,type:"info",duration:o,action:{label:"Undo",callback:t}})}}const ae=new xo;window.toast=ae;class Eo{constructor(){this.activeDropdown=null,this.updatePositionHandler=null,document.addEventListener("click",e=>{e.target.closest(".global-search-dropdown")||this.hideDropdown()})}showDropdown(e,t,o,s=!1){this.hideDropdown();const n=document.createElement("ul");n.className="global-search-dropdown";const r=300,i=e.getBoundingClientRect(),a=window.innerWidth,c=window.innerHeight,l=i.width,d=c-i.bottom,p=i.top;let h=!1;d<r&&p>d&&(h=!0);let f;h?f=Math.max(8,i.top-r-8):f=Math.min(c-r-8,i.bottom+8);let y=i.left;y+l>a-8&&(y=a-l-8),y<8&&(y=8);const w={position:"fixed",top:`${f}px`,left:`${y}px`,width:`${l}px`,minWidth:`${l}px`,maxWidth:`${l}px`,background:"#fff",border:"1px solid #d1d5db",borderRadius:"8px",boxShadow:"0 10px 25px -5px rgba(0, 0, 0, 0.15), 0 8px 10px -6px rgba(0, 0, 0, 0.10)",maxHeight:`${r}px`,overflowY:"auto",overflowX:"hidden",zIndex:"10010",listStyle:"none",margin:"0",padding:"4px 0",whiteSpace:"normal",wordWrap:"break-word",display:"block",pointerEvents:"auto",transform:"none",contain:"none",isolation:"isolate"};Object.keys(w).forEach(g=>{n.style.setProperty(g,w[g],"important")}),n.dropdownHeight=r,t.length===0?n.innerHTML='<li style="padding: 12px 16px; color: #6b7280; font-style: italic; background: #fff;">No products found</li>':n.innerHTML=t.map(g=>{if(g._crosshairValidate){const A=g._crosshairValidate,se=A.imageUrl?`<img src="${S.sanitizeInput(A.imageUrl)}" alt="" style="width:32px; height:32px; object-fit:contain; border-radius:4px; margin-right:10px; vertical-align:middle; flex-shrink:0;">`:"";return`<li data-validate-competitor="${S.sanitizeInput(A.competitor)}" data-validate-code="${S.sanitizeInput(A.productCode)}"
          ...
          </li>`}const x=g.OrderCode||g.Code||"",m=g.Description||g.ProductName||g["Product Name"]||"",v=g.Image_URL||g.image_url||"",P=g._crosshairMatch,I=P?`<span style="display: inline-block; background: ${P.status==="Verified"?"#e8f5e9":"#e3f2fd"}; color: ${P.status==="Verified"?"#2e7d32":"#1565c0"}; font-size: 10px; font-weight: 600; padding: 1px 6px; border-radius: 8px; margin-left: 8px;">↔ ${S.sanitizeInput(P.competitorLabel||P.competitor)}</span>`:"",H=v?`<img src="${S.sanitizeInput(v)}" alt="" style="width:36px; height:36px; object-fit:contain; border-radius:4px; margin-right:10px; flex-shrink:0;" onerror="this.style.display='none'">`:"",_=P?Object.fromEntries(Object.entries(g).filter(([A])=>A!=="_crosshairMatch")):g;return`<li data-product='${JSON.stringify(_).replace(/'/g,"&apos;")}'
    ...
    `;this.injectSaveDialogStyles(),document.body.insertAdjacentHTML("beforeend",n);const r=document.getElementById("save-dialog"),i=document.getElementById("save-doc-name"),a=document.getElementById("save-notes");i==null||i.focus(),i==null||i.select(),r.querySelectorAll("button[data-action]").forEach(l=>{l.addEventListener("click",async()=>{const d=l.dataset.action;if(d==="cancel"){r.remove();return}const p=(i==null?void 0:i.value.trim())||"Untitled Selection",h=(a==null?void 0:a.value.trim())||"";this.currentSelectionName=p;const f={...this.prepareSelectionData(),documentName:p,notes:h};r.querySelectorAll("button").forEach(y=>y.disabled=!0),l.textContent="Saving...";try{let y;d==="save-update"?y=await de.updateSelection(this.currentSelectionId,f):(y=await de.saveSelection(f),y.success&&y.id&&(this.currentSelectionId=y.id)),r.remove(),y.success?(this.hasUnsavedChanges=!1,this.lastSaveTime=new Date,this.updateContextHeader(),ae.success(d==="save-update"?"Selection updated!":"Selection saved!")):ae.error("Failed to save: "+(y.error||"Unknown error"))}catch(y){r.remove(),ae.error("Failed to save: "+y.message)}})}),r.addEventListener("click",l=>{l.target===r&&r.remove()});const c=l=>{l.key==="Escape"&&(r.remove(),document.removeEventListener("keydown",c))};document.addEventListener("keydown",c)}injectSaveDialogStyles(){if(document.getElementById("save-dialog-styles"))return;document.head.insertAdjacentHTML("beforeend",`
      <style id="save-dialog-styles">
        .save-dialog-overlay {
          position: fixed;
          top: 0;
    ...
    `,this.messagesContainer.appendChild(e),this._scrollToBottom(),e}_formatMarkdown(e){let t=this._escapeHtml(e);return t=t.replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>"),t=t.replace(/`([^`]+)`/g,"<code>$1</code>"),t=t.replace(/^### (.+)$/gm,"<h4>$1</h4>"),t=t.replace(/^## (.+)$/gm,"<h3>$1</h3>"),t=t.replace(/^- (.+)$/gm,"<li>$1</li>"),t=t.replace(/(<li>.*<\/li>\n?)+/g,o=>`<ul>${o}</ul>`),t=t.replace(/^\d+\. (.+)$/gm,"<li>$1</li>"),t=t.replace(/\n\n/g,"</p><p>"),t=`<p>${t}</p>`,t=t.replace(/<p><\/p>/g,""),t=t.replace(/<p>(<h[34]>)/g,"$1"),t=t.replace(/(<\/h[34]>)<\/p>/g,"$1"),t=t.replace(/<p>(<ul>)/g,"$1"),t=t.replace(/(<\/ul>)<\/p>/g,"$1"),t=t.replace(/\b(\d{6})\b/g,'<button class="ai-add-product-btn" data-code="$1" title="Add $1 to selection">$1 <span class="ai-add-icon">+</span></button>'),t}_getBasePath(){var e;return(((e=document.querySelector("base"))==null?void 0:e.href)||window.location.origin+"/").replace(/\/$/,"")}_getProductImage(e){return e.Image_URL||e.imageUrl||e.Image||`${this._getBasePath()}/assets/no-image.png`}_getProductName(e){return e.Description||e.ProductName||e["Product Name"]||""}_getProductMeta(e){const t=e.Finish||e.Colour||"",o=e.DimX||e["X Dimension (mm)"]||"",s=e.DimY||e["Y Dimension (mm)"]||"",n=e.DimZ||e["Z Dimension (mm)"]||"",r=o&&o!=="0"?`${o} × ${s||0} × ${n||0}mm`:"";return[t,r].filter(Boolean).join("  ·  ")}_getProductPrice(e){const t=e["RRP INC GST"]||e.RRP_INCGST||e["RRP EX GST"]||e.RRP_EXGST||"";return t?`$${parseFloat(t).toLocaleString("en-AU",{minimumFractionDigits:2})}`:""}_injectProductCards(e){const t=e.querySelectorAll(".ai-add-product-btn");if(!t.length)return;const o=this._getBasePath();t.forEach(s=>{const n=s.dataset.code,r=$.findProductByCode(n);if(!r)return;const i=s.closest("li");if(!(i||s.parentElement))return;const c=this._getProductImage(r),l=this._getProductName(r),d=this._getProductMeta(r),p=this._getProductPrice(r),h=document.createElement("div");h.className="ai-product-card",h.dataset.code=n,h.innerHTML=`
      ...
      <div class="ai-product-modal">
        ...
        <div class="ai-product-modal-body">
          ...
          ${m.length?`<dl class="ai-product-modal-specs">${m.map(([P,I])=>`<dt>${this._escapeHtml(P)}</dt><dd>${this._escapeHtml(I)}</dd>`).join("")}</dl>`:""}
    ...
    `,v.addEventListener("click",P=>{P.target===v&&v.remove()}),v.querySelector(".ai-product-modal-close").addEventListener("click",()=>v.remove()),v.querySelector(".ai-product-modal-add").addEventListener("click",P=>{this._addProductToGrid(e,null);const I=P.currentTarget;I.classList.add("added"),I.disabled=!0,I.textContent="Added to Selection ✓"}),document.addEventListener("keydown",function P(I){I.key==="Escape"&&(v.remove(),document.removeEventListener("keydown",P))}),document.body.appendChild(v)}_appendFeedbackRow(e,t,o){const s=document.createElement("div");s.className="ai-feedback-row";const n=this._getFeedbackEntry(t),r=(n==null?void 0:n.rating)||null;s.innerHTML=`
    ...
    `,document.body.insertBefore(n,document.body.firstChild)}setupGlobalEventListeners(){window.addEventListener("generatePdf",e=>{const{tipTailSettings:t,...o}=e.detail;Wt(),We(o,t||null)}),window.addEventListener("beforeunload",()=>{}),be.features.memoryAPI&&setInterval(()=>{const e=be.memoryInfo;e.memoryPressure==="high"&&console.warn("High memory usage detected:",e)},6e4)}getSelectedProducts(){return b.getSelectedProducts()}clearSelection(){return b.clearAllSelections()}addProduct(e,t,o,s){return b.addProductToSelection(e,t,o,s)}updateSelectionCount(){this.navigationManager&&this.navigationManager.updateSelectionCount()}showError(e){alert(e)}}document.addEventListener("DOMContentLoaded",()=>{window.seimaScanner=new ko,window.seimaScanner.init()});window.addEventListener("DOMContentLoaded",()=>{fetch("./version.txt").then(u=>u.text()).then(u=>{const e=u.trim().split(`
`);if(e.length>0){const o=e[0].split(" - ")[0].trim(),s=document.getElementById("app-version");s&&(s.textContent=`Ver: ${o}`,s.style.cursor="pointer",s.addEventListener("click",Bo))}}),Ro(),Lo()});function Ro(){const u=document.getElementById("help-btn");u&&u.addEventListener("click",()=>{Do()});const e=document.getElementById("crosshair-btn");e&&e.addEventListener("click",()=>{window.location.href="screens/validator.html"});const t=document.getElementById("fred-review-btn");t&&t.addEventListener("click",()=>{window.location.href="screens/fred-review.html"});const o=document.getElementById("quick-start-btn");o&&o.addEventListener("click",()=>{ft.showForced()})}function Lo(){const u=document.getElementById("user-menu-container"),e=document.getElementById("user-menu-trigger"),t=document.getElementById("user-menu-dropdown"),o=document.getElementById("sign-in-btn"),s=document.getElementById("user-avatar"),n=document.getElementById("user-name-display");function r(c){var l,d,p,h,f;if(c){u&&(u.style.display="block"),o&&(o.style.display="none");const y=document.getElementById("crosshair-btn");y&&(y.style.display=(l=G.CROSSHAIR)!=null&&l.ENABLED&&J.isStaffMode()?"":"none");const w=document.getElementById("fred-review-btn");w&&(w.style.display=J.isAdmin()?"":"none");const g=i(c.name);s&&(s.textContent=g),n&&(n.textContent=((d=c.name)==null?void 0:d.split(" ")[0])||"User"),t&&(t.innerHTML=`
        ...
        `,(p=document.getElementById("menu-profile"))==null||p.addEventListener("click",()=>{t.style.display="none",X.showEditProfile(x=>{b.clearUserSettings(),r(x)})}),(h=document.getElementById("menu-password"))==null||h.addEventListener("click",()=>{t.style.display="none",X.showChangePassword()}),(f=document.getElementById("menu-logout"))==null||f.addEventListener("click",()=>{t.style.display="none",b.clearUserSettings(),J.logout(),r(null)}))}else u&&(u.style.display="none"),o&&(o.style.display="block")}function i(c){if(!c)return"?";const l=c.trim().split(" ");return l.length>=2?(l[0][0]+l[l.length-1][0]).toUpperCase():c.substring(0,2).toUpperCase()}function a(c){const l=document.createElement("div");return l.textContent=c||"",l.innerHTML}e&&t&&(e.addEventListener("click",c=>{c.stopPropagation();const l=t.style.display!=="none";t.style.display=l?"none":"block"}),document.addEventListener("click",c=>{u!=null&&u.contains(c.target)||(t.style.display="none")})),o&&o.addEventListener("click",()=>{X.showLogin(c=>{r(c)})}),J.onAuthChange=r,r(J.getCurrentUser())}function Do(){const u=document.getElementById("user-guide-modal"),e=document.getElementById("user-guide-content");if(!u||!e)return;e.innerHTML=To(),u.style.display="flex";const t=document.getElementById("user-guide-close");t&&(t.onclick=()=>{u.style.display="none"}),u.onclick=s=>{s.target===u&&(u.style.display="none")};const o=s=>{s.key==="Escape"&&(u.style.display="none",document.removeEventListener("keydown",o))};document.addEventListener("keydown",o)}function To(){return`
  ...
  `}async function Bo(){try{const u=document.getElementById("changelog-modal"),e=document.getElementById("changelog-content"),s=(await(await fetch("./version.txt")).text()).trim().split(`
